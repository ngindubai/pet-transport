...
seo:
  title: "South Africa Pet Import Guide | Pet Transport Global"
  description: "Bringing a pet to South Africa requires a DALRRD import permit and a vet-certified health certificate. Here is the full process for dogs and cats."
tags:
  - "south-africa"
  - "africa"
  - "planning"
faqs:
  - question: "Do I need an import permit to bring my dog to South Africa?"
    answer: "Yes. Dogs and cats entering South Africa require an import permit issued by DALRRD (Department of Agriculture, Land Reform and Rural Development). Apply well in advance -- processing can take several weeks. The permit must accompany your pet on arrival."
  - question: "Is there quarantine for pets entering South Africa?"
    answer: "South Africa does not operate routine quarantine for dogs and cats from most approved countries, provided all documentation is in order. Pets may be held at the port of entry while documentation is checked. If documents are incomplete, pets face detention at the owner's cost."
  - question: "What vaccinations does South Africa require for dogs?"
    answer: "Dogs must be vaccinated against distemper, hepatitis, leptospirosis, parvovirus, and rabies. Vaccinations must be current (within the validity window on the certificate). The rabies vaccination must have been given at least 30 days before travel."
---
