...
seo:
  title: "Travelling Internationally with a Maine | Pet Transport Global"
  description: "Guide to international travel with a Maine Coon cat in 2026: IATA crate sizing for large cats, airline cabin limits, microchip and vaccination requirements, and country rules."
tags:
  - "Maine Coon"
  - "cat"
  - "breed guide"
faqs:
  - question: "Can a Maine Coon travel in the cabin on a plane?"
    answer: "It depends on the size of your Maine Coon and the airline's weight limit. Maine Coons typically weigh 5 to 9kg as adults. Most cabin cat limits are 6 to 8kg (including carrier). A large Maine Coon may exceed the limit and need to travel as cargo. Many airlines accept cats in-cabin -- check the specific carrier's policy and weigh your cat before booking."
  - question: "What size crate does a Maine Coon need for cargo travel?"
    answer: "Maine Coons are large cats and often need a bigger crate than most breeds. Use the IATA guideline: the crate must allow the cat to stand at full height, turn around completely, and lie stretched out. For a large Maine Coon, an IATA 400 or 500 may be needed. Have your vet measure your cat before buying the crate."
  - question: "Do Maine Coons have any breed-specific travel restrictions?"
    answer: "No. Maine Coons are not on any airline breed ban list or country import restriction list. They are a natural (non-brachycephalic) breed and are generally considered low-risk for air travel."
  - question: "Are Maine Coons good travellers?"
    answer: "Maine Coons are known for being relatively calm and adaptable, which makes them better candidates for travel than some breeds. Individual temperament varies, so crate training well before travel is important. Some Maine Coons travel in the cabin with their owners on long-haul routes with no issues."
---
