...
seo:
  title: "Bringing a Pet to China: Import Permits | Pet Transport Global"
  description: "Guide to bringing your dog or cat to China in 2026: GACC import permits, quarantine requirements, approved airports, and the advance documentation process."
tags:
  - "China"
  - "pet import"
  - "quarantine"
faqs:
  - question: "Does China quarantine imported pets?"
    answer: "Yes. All dogs and cats arriving in China are subject to quarantine. The standard quarantine period is 7 days for pets from approved countries with complete documentation, but can be extended to 30 days or more depending on origin country and documentation status."
  - question: "What is the GACC and how does it affect pet imports to China?"
    answer: "The General Administration of Customs of China (GACC) oversees live animal imports. All pets entering China require a GACC-approved health certificate from the origin country, issued in a specific format. China's customs authorities inspect arriving pets and documentation at the border."
  - question: "Can I only bring one pet to China per person?"
    answer: "China generally limits one pet per traveller on a personal import basis. Commercial pet imports require a separate approval process. Confirm current limits with GACC or through a China-specialist IPATA agent."
  - question: "What are the requirements for bringing a dog from the UK to China?"
    answer: "UK dogs need a health certificate endorsed by APHA, current rabies vaccination (and in some cases a rabies titre test), microchip, and a Chinese customs-format health certificate countersigned by the relevant authority. A quarantine booking at an approved facility in China is typically required in advance."
---
