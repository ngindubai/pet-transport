...
seo:
  title: "Canada to UK Pet Transport | Pet Transport Global"
  description: "Moving from Canada to the UK with pets? Here is what APHA requires for dogs and cats arriving from Canada, including the titre test timeline and health certificate."
tags:
  - "canada"
  - "uk"
  - "routes"
faqs:
  - question: "Does my Canadian dog need a titre test to enter the UK?"
    answer: "Yes. Canada is not on the EU-listed countries list for UK pet travel. Dogs and cats from Canada need a rabies titre test showing 0.5 IU/mL or above, with the blood draw at least 30 days post-vaccination and UK entry at least 3 months after the satisfactory result date."
  - question: "What is the health certificate required for pets entering the UK from Canada?"
    answer: "Dogs and cats need an Animal Health Certificate (AHC) issued by a Canadian Official Veterinarian within 10 days of UK arrival. The certificate must be in the APHA-approved format for Canada."
  - question: "Are there direct flights from Canada to the UK that accept pets as cargo?"
    answer: "Several airlines offer direct Canada-UK routes with cargo pet transport, including Air Canada, British Airways, and others. Not all routes accept pets year-round, and some brachycephalic breeds are restricted. Check with your airline well in advance."
---
