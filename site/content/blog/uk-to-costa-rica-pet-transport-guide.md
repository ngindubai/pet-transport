...
seo:
  title: "Pet Transport from UK to Costa Rica | Pet Transport Global"
  description: "Guide to shipping a dog or cat from the UK to Costa Rica. SENASA requirements, microchip, vaccines, health certificate and which airlines fly pets on this route."
tags:
  - "UK"
  - "Costa Rica"
  ...
  - "cat"
faqs:
  - question: "Is there a direct flight from the UK to Costa Rica with pets?"
    answer: "There are no direct non-stop flights from the UK to Costa Rica. Common routing options include via Madrid with Iberia (practical for pets as it avoids US transit complications) or via US hubs with British Airways or American Airlines. If routing via the USA, be aware that live animal cargo transit through US airports involves USDA requirements."
  - question: "Does Costa Rica require a rabies titre test for UK pets?"
    answer: "A rabies titre test is not a standard SENASA requirement for dogs and cats imported from the UK. A current rabies vaccination and APHA-endorsed health certificate are the primary requirements. Always confirm the current position with SENASA at senasa.go.cr before travel as requirements can change."
  - question: "Who endorses the UK health certificate for Costa Rica?"
    answer: "The health certificate must be signed by your vet and then endorsed by APHA (Animal and Plant Health Agency). Use a vet who is familiar with the APHA endorsement process and the specific Costa Rica certificate format. Allow several days for the APHA endorsement on top of the vet appointment."
---
