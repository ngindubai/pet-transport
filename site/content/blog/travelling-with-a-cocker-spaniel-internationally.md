...
seo:
  title: "Travelling Internationally with a Cocker | Pet Transport Global"
  description: "Guide to international travel with a Cocker Spaniel or English Springer Spaniel in 2026: airline cargo options, cabin eligibility, ear care, and country import rules."
tags:
  - "Cocker Spaniel"
  - "Spaniel"
  - "breed guide"
faqs:
  - question: "Can a Cocker Spaniel travel in the cabin on an aeroplane?"
    answer: "A Cocker Spaniel may travel in the cabin if the combined weight of dog and carrier is within the airline's cabin pet limit (usually 6 to 10kg depending on the carrier). Most adult Cocker Spaniels (around 9 to 13kg) exceed the limit without carrier, so cabin travel is often only possible for puppies or very small Cockers."
  - question: "Is a Cocker Spaniel allowed in cargo on international flights?"
    answer: "Yes. Cocker Spaniels are not brachycephalic and are not on standard airline breed ban lists. Most international carriers accept Cocker Spaniels as manifest cargo in an IATA-compliant crate, subject to booking and size requirements."
  - question: "Do Cocker Spaniels have any breed-specific travel restrictions?"
    answer: "Cocker Spaniels are not subject to breed-specific bans in most countries. They are not considered a dangerous breed and are not on any standard prohibited import lists. Check the specific destination country's rules."
  - question: "What special care does a Cocker Spaniel need for air travel?"
    answer: "Cocker Spaniels' long floppy ears make them prone to ear infections, which can worsen with changes in humidity during travel. Have a vet check the ears before travel and treat any existing infections. Keep ears clean and dry before departure."
---
