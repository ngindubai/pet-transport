...
seo:
  title: "Bringing a Pet to Sweden: EU Import Rules | Pet Transport Global"
  description: "Complete guide to bringing your dog or cat to Sweden in 2026: EU pet passport, titre test, tapeworm treatment, and Swedish Board of Agriculture requirements."
tags:
  - "Sweden"
  - "pet import"
  - "EU"
faqs:
  - question: "What does my pet need to enter Sweden?"
    answer: "Pets from EU countries need an EU pet passport, ISO microchip, and rabies vaccination. Pets from outside the EU, including the UK, need these plus a rabies antibody titre test showing at least 0.5 IU/ml and a three-month wait after the blood draw."
  - question: "Do dogs need tapeworm treatment to enter Sweden?"
    answer: "Yes. Dogs entering Sweden from any country outside the Nordic area must be treated against Echinococcus tapeworm within 1 to 5 days before entry. The treatment (praziquantel) must be administered by a vet and documented in the health certificate or pet passport."
  - question: "Does Sweden have breed-specific legislation?"
    answer: "No. Sweden does not have national breed-specific legislation and does not maintain a banned breeds list, which makes it more permissive than some EU neighbours for certain dog types."
  - question: "What authority oversees pet imports to Sweden?"
    answer: "The Swedish Board of Agriculture (Jordbruksverket) manages pet import rules. Current requirements are at jordbruksverket.se."
---
