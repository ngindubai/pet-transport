...
seo:
  title: "Moving Pets to Ethiopia | Pet Transport Global"
  description: "Pet import guide for Ethiopia. The Ministry of Agriculture permit process, vaccination requirements, and what expats and NGO workers need to know before flying to Addis Ababa."
tags:
  - "ethiopia"
  - "africa"
  - "planning"
faqs:
  - question: "Do I need an import permit for a pet entering Ethiopia?"
    answer: "Yes. An import permit from Ethiopia's Ministry of Agriculture (MoA) is required before the animal travels. Apply well in advance through the MoA or the nearest Ethiopian Embassy."
  - question: "Is there quarantine in Ethiopia?"
    answer: "No fixed quarantine period exists for pets arriving with complete documentation. Ministry of Agriculture vets at Bole International Airport inspect animals on arrival."
  - question: "What vaccinations are required for dogs entering Ethiopia?"
    answer: "Rabies vaccination (current), distemper, hepatitis, parvovirus, and leptospirosis. All must be recorded in the government-endorsed health certificate."
---
