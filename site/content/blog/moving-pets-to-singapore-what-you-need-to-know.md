---
title: "Moving Pets to Singapore: AVS Categories, Approved Countries, and What to Prepare"
...
seo:
  title: "Moving Pets to Singapore: AVS Categories | Pet Transport Global"
  description: "Singapore uses a strict category system for pet imports. Here's which category your pet falls into, what documents you need, and how to book the required stay at an AVS facility."
tags:
  - "singapore"
  - "planning"
  - "asia"
faqs:
  - question: "Does my pet need quarantine to enter Singapore?"
    answer: "Not traditional quarantine, but a mandatory 30-day stay at an AVS-approved animal boarding facility is required for all imported cats and dogs, even from low-risk Category 1 countries. You can visit your pet during this period. Costs are paid by the owner."
  - question: "How do I know which AVS category my country is in?"
    answer: "Check the current AVS approved countries list on the Singapore National Parks Board website. Categories change periodically. If your country is not listed as Category 1 or 2, direct import is not permitted and your pet must first reside in an approved country."
---
