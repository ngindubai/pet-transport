...
seo:
  title: "Moving to Uruguay with Pets | Pet Transport Global"
  description: "Uruguay is one of South America's most liveable countries for expats. Here is what dogs and cats need to enter Uruguay: MGAP health certificate, vaccinations, and what happens at Carrasco Airport."
tags:
  - "Uruguay"
  - "pet import"
  - "South America"
faqs:
  - question: "What authority manages pet imports to Uruguay?"
    answer: "MGAP (Ministerio de Ganaderia, Agricultura y Pesca -- Ministry of Agriculture) manages pet imports to Uruguay. MGAP veterinary inspectors at Montevideo Carrasco International Airport (MVD) check arriving animals."
  - question: "Does Uruguay require quarantine for imported pets?"
    answer: "Uruguay does not impose mandatory quarantine for household pets from most countries, provided documentation is complete. MGAP inspects the animal on arrival and releases it if documentation is in order."
  - question: "Do I need a rabies titre test to bring my pet to Uruguay?"
    answer: "Uruguay does not require a rabies titre test for pets from most countries. A current rabies vaccination and health certificate are the primary requirements. Verify current MGAP requirements for your specific country of origin before travel."
---
