---
title: "India to UK Pet Transport: Titre Tests, DEFRA Requirements, and Finding Approved Labs"
...
seo:
  title: "India to UK Pet Transport: Titre Tests | Pet Transport Global"
  description: "Moving a pet from India to the UK requires a titre test, specific timing, and documentation from APHA. Here's the complete guide."
tags:
  - "india"
  - "uk"
...
faqs:
  - question: "How long does it take to move a pet from India to the UK?"
    answer: "A minimum of 4-5 months. You need at least 30 days between vaccination and the titre test blood draw, then up to 14 days for lab results, then 90 days of waiting from the satisfactory result. Add time for the health certificate and travel arrangements."
  - question: "Is a rabies titre test required to bring my dog from India to the UK?"
    answer: "Yes. India is a non-listed country for UK pet imports. All pets from non-listed countries require a titre test with a result of at least 0.5 IU/mL, performed at a UK-approved laboratory, followed by a 90-day waiting period before UK entry is permitted."
---
