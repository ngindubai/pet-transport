---
title: "Pet Microchipping for International Travel: ISO Standards, Timing, and Common Problems"
...
seo:
  title: "Pet Microchipping for International Travel | Pet Transport Global"
  description: "The microchip must go in before the rabies vaccination. That single rule catches out thousands of pet owners every year. Here's everything you need to know."
tags:
  - "microchip"
  - "planning"
  - "documentation"
faqs:
  - question: "What happens if my pet's microchip was implanted after the rabies vaccination?"
    answer: "The vaccination is not valid for international travel documentation purposes. You will need to re-vaccinate your pet after microchipping and restart any waiting periods that depend on vaccination date - including titre test timing and the 180-day countdown for Australia."
  - question: "My pet has a non-ISO microchip from the US. What should I do?"
    answer: "Check whether your destination country accepts non-ISO chips - some do, provided you bring a compatible scanner. The safest option is to implant a new ISO 15-digit chip alongside the existing one. Your vet can do this, and both numbers can be noted on documentation. Discuss with your agent or destination country authority before travel."
---

A pet microchip is a grain-of-rice-sized transponder implanted under the skin, usually between the shoulder blades. It carries a unique 15-digit number that identifies your animal for life. For international travel, the microchip is the key part of the entire documentation chain.
