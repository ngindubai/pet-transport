...
tags:
  ...
  - "practical guide"
faqs:
  - question: "Can two pets travel in the same crate on an international flight?"
    answer: "IATA standards generally require one adult animal per crate for most species. Some exceptions apply for young siblings of the same litter travelling together, and for small compatible animals. Check the specific airline's policy - most carriers follow IATA standards and require individual crates for adult dogs and cats."
  - question: "Is there a limit on how many pets I can import into a country?"
  ...
  - question: "Do all my pets need separate health certificates?"
    answer: "Yes. Each individual animal needs its own health certificate, regardless of how many pets you're moving. The certificate is specific to the individual animal (microchip, vaccination records, etc.)."
  - question: "Can I fly multiple pets on the same booking?"
    answer: "Airlines have limits on the number of live animals per booking and per aircraft. Some airlines limit one pet per passenger in cabin, and have total live animal limits per flight for cargo. If you're moving multiple pets, book early and confirm the number of live animals accepted per flight with the airline."
---
