...
faqs:
  - question: "Can a Dachshund travel in the cabin on a flight?"
    answer: "Miniature Dachshunds may qualify for cabin travel if the pet plus carrier combined weight is under the airline's in-cabin limit (typically 6-8kg). Standard Dachshunds are usually too heavy for cabin limits and travel as cargo."
  - question: "Are Dachshunds banned from any countries?"
    answer: "Dachshunds are not subject to breed-specific legislation in any major international destination. They are widely accepted globally."
  - question: "Are there any health concerns for Dachshunds in cargo?"
    answer: "Dachshunds are not brachycephalic, so they do not face the respiratory concerns of flat-faced breeds. However, Dachshunds are prone to intervertebral disc disease (IVDD). Consult your vet about whether your specific dog's spinal health makes cargo travel appropriate."
  - question: "What size crate does a Miniature Dachshund need?"
    answer: "Most Miniature Dachshunds fit an IATA 200 or 300 crate. The crate must allow the dog to stand, sit, turn, and lie down without touching the walls. Measure your dog before ordering."
---
