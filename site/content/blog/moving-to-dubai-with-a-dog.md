...
seo:
  title: "Moving to Dubai with a Dog: MOCCAE Permits | Pet Transport Global"
  description: "Dubai has hundreds of thousands of expats, many with dogs. Here is the complete guide: MOCCAE import permit, breed restrictions, registration, and practical dog life in Dubai."
tags:
  - "Dubai"
  - "UAE"
...
faqs:
  - question: "Which dog breeds are banned in Dubai?"
    answer: "The UAE restricts several breeds. Prohibited or restricted breeds include Pit Bull Terriers, American Staffordshire Terriers, Staffordshire Bull Terriers, Rottweilers, Dobermans, German Shepherds (in some contexts), Chow Chows, Presa Canarios, Tosa Inus, Fila Brasileiros, and Dogo Argentinos. Verify the current list with MOCCAE before attempting to import a restricted breed."
  - question: "Do I need an import permit to bring my dog to Dubai?"
    answer: "Yes. An import permit from the UAE Ministry of Climate Change and Environment (MOCCAE) is required before your dog travels to Dubai. Apply via the MOCCAE My Services portal at moccae.gov.ae at least 4 to 6 weeks before travel."
  - question: "Is there quarantine for dogs arriving in Dubai?"
    answer: "Dubai does not impose mandatory quarantine for dogs from most approved countries when documentation is complete. MOCCAE vets inspect the dog on arrival at Dubai International Airport (DXB). With complete documentation, the dog is typically released the same day."
---
