...
seo:
  title: "Which Vaccinations Does Your Pet Need for | Pet Transport Global"
  description: "A country-by-country guide to pet vaccination requirements for international travel. Rabies, core vaccines, titre tests and which countries require what."
tags:
  - "vaccinations"
  - "rabies"
  ...
  - "health certificate"
faqs:
  - question: "Which countries require a rabies titre test for pet import?"
    answer: "Countries that require a rabies titre test for pet import include Australia, New Zealand, Japan, Mauritius, Oman, Bahrain, Kuwait, and several others. These countries have rabies-free or low-risk status and require the titre test as proof that the vaccination has produced sufficient antibody levels. The test must be done at an approved laboratory and is followed by a mandatory waiting period before travel."
  - question: "Does my cat need a rabies vaccination for international travel?"
    answer: "Yes, in most countries that require rabies vaccination for dogs, the same requirement applies to cats. Australia, New Zealand, Japan, and Gulf states all require rabies vaccination and titre testing for cats as well as dogs. The process and timeline are the same as for dogs."
  - question: "How long before travel should my pet be vaccinated?"
    answer: "Core vaccines should be given well before any international move. The minimum timing depends on your destination: a current booster is sufficient for most countries (rabies vaccination valid within the past one to three years). For titre test countries (Australia, Japan, etc.), allow a minimum of seven to eight months from starting the process to arrival. Always consult your vet and the destination country's official requirements."
---
