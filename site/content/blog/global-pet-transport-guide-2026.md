---
title: "Global Pet Transport Guide 2026: Country Rules, Costs & Airlines"
...
seo:
  title: "Global Pet Transport Guide 2026 | Pet Transport Global"
  description: "Quarantine durations, titre test rules, airline pet policies and cost ranges for 25 countries. The definitive free reference for moving your pet abroad in 2026."
tags:
  - "guide"
  - "quarantine"
  - "airlines"
  ...
  - "costs"
faqs:
  - question: "Which country has the strictest pet import rules in 2026?"
    answer: "Australia requires mandatory quarantine for all imported dogs and cats, a rabies titre test for pets from most countries, an import permit from DAFF, and uses a strict country grouping system. Japan is a close second, requiring a minimum 14-day quarantine and very specific rabies titre test timing. Both are considered the world's most complex destinations for pet transport."
  - question: "Do I need a rabies titre test to move my pet abroad?"
    answer: "It depends on your destination. Australia and Japan require titre tests for pets from most countries. The UK, Singapore, UAE, South Africa, and Hong Kong require titre tests for pets from countries not on their approved list. EU countries, Canada, USA, Mexico and most others do not require titre tests if your pet has an up-to-date rabies vaccination and microchip."
  - question: "Which airlines allow pets in the cabin?"
    answer: "Airlines that allow small pets in the cabin include Air Canada, Air France, Delta, KLM, Lufthansa, Swiss, Korean Air, Turkish Airlines, South African Airways, Philippine Airlines, and Garuda Indonesia. Most have a weight limit of 8kg including the carrier. British Airways, Emirates, Qantas, Singapore Airlines, and Virgin Atlantic do not allow pets in the cabin."
  - question: "How much does international pet transport cost?"
    answer: "Costs vary widely. A straightforward European route (e.g. UK to France) can cost £150-400 for documentation and airline fees. A complex long-haul route like UK to Australia can cost £3,000-8,000+ when you factor in microchipping, vaccinations, titre testing, vet fees, import permits, quarantine fees (mandatory in Australia), crate, airline cargo fees, and a professional agent. Japan routes are similarly expensive."
  - question: "What is a rabies titre test and when do I need it?"
    answer: "A rabies titre test (also called a RNATT or FAVN test) measures the level of rabies antibodies in your pet's blood. Most countries that require it need a result of at least 0.5 IU/ml. The test must be done at an approved laboratory, after your pet has been vaccinated, and the result must reach a certain minimum age before travel: typically 3 months for Australia and Japan. Start planning at least 6 months before travel if a titre test is required."
  - question: "Can I transport a flat-faced (brachycephalic) dog internationally?"
    answer: "Many airlines restrict or ban flat-faced breeds due to breathing risks during flight. Common restricted breeds include Bulldogs, Pugs, French Bulldogs, Boxers, Boston Terriers, Shih Tzus, and Persian cats. Some airlines apply a complete ban; others allow cargo travel but not cabin travel. Always check your specific airline's brachycephalic policy before booking. Some destinations (e.g. USA) also have import restrictions on certain breeds."
  - question: "How far in advance should I start planning international pet transport?"
    answer: "For straightforward routes (e.g. UK to Europe or Canada to USA), 4-8 weeks is usually sufficient. For complex routes requiring a rabies titre test (Australia, Japan, UK from non-approved countries), start 6-12 months in advance: the titre test alone takes 3-4 months to complete from first vaccination. Adding import permits and quarantine bookings, Australia from most countries requires 6-12 months of planning minimum."
---
...
**For routes requiring a titre test, add:**
5. Titre test blood draw (after completing vaccination protocol)
6. Result of 0.5 IU/ml or higher at an approved lab
7. Waiting period after passing titre (varies: 90 days for EU; 180 days for Australia and Japan)

**For routes requiring an import permit, add:**
8. Import permit application (allow 2-30 days depending on destination)
9. Import permit number confirmed before departure
...
For a personalised quote or help planning your specific route, [get in touch with our team](/contact/).
