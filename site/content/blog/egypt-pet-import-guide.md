...
seo:
  title: "Bringing a Pet to Egypt | Pet Transport Global"
  description: "Guide to bringing your dog or cat to Egypt in 2026: GOVS health certificate, microchip, rabies vaccination, advance notification, and arrival process at Cairo Airport."
tags:
  - "Egypt"
  - "pet import"
  - "Africa"
faqs:
  - question: "What does my pet need to enter Egypt?"
    answer: "Dogs and cats entering Egypt need a microchip, current rabies vaccination, a health certificate issued by the origin country's government veterinary authority (e.g., APHA in the UK, USDA in the USA), and advance notification to the importing airport's veterinary authority."
  - question: "Is there quarantine for pets entering Egypt?"
    answer: "Egypt does not operate a standard mandatory quarantine for pets with complete documentation from most countries. However, documentation is inspected carefully at the border and animals may be held briefly if paperwork is incomplete."
  - question: "Does Egypt require a rabies titre test?"
    answer: "Egypt does not currently require a rabies titre test from most origin countries. A valid rabies vaccination on the health certificate is sufficient for most arrivals. Confirm current requirements for your specific origin country with the General Organization for Veterinary Services (GOVS)."
  - question: "Which authority handles pet imports to Egypt?"
    answer: "The General Organization for Veterinary Services (GOVS), under the Ministry of Agriculture and Land Reclamation, oversees live animal imports to Egypt."
---
