...
seo:
  title: "Moving Pets to Nepal | Pet Transport Global"
  description: "Nepal pet import guide. Department of Livestock Services permit, vaccination requirements, and practical advice for expats and aid workers relocating to Kathmandu with dogs or cats."
tags:
  - "nepal"
  - "asia"
  - "planning"
faqs:
  - question: "Do I need a permit to bring a pet to Nepal?"
    answer: "Yes. An import permit from Nepal's Department of Livestock Services (DLS) is required before the animal travels. Apply through the DLS or Nepal Embassy in your home country."
  - question: "Is there quarantine for pets entering Nepal?"
    answer: "No mandatory quarantine period. DLS vets inspect animals at Tribhuvan International Airport in Kathmandu. Animals with complete documentation are typically cleared on the same day."
  - question: "What vaccinations does Nepal require?"
    answer: "Rabies vaccination (current), distemper, parvovirus, and hepatitis for dogs; rabies, panleukopenia, and respiratory viruses for cats. All vaccinations must be recorded in the health certificate."
---

Nepal attracts NGO workers, trekking guides, diplomats, and long-term volunteers - many of whom relocate with pets. The country's pet import system is managed by the **Department of Livestock Services (DLS)** and requires advance planning but no quarantine.
