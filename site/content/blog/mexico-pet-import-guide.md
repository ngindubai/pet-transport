...
seo:
  title: "Mexico Pet Import Guide | Pet Transport Global"
  description: "Bringing a dog or cat to Mexico is relatively simple. Here is what SENASICA requires, including the health certificate format, vaccination rules, and what to expect at the border."
tags:
  - "mexico"
  - "north-america"
  - "planning"
faqs:
  - question: "Does my dog need a health certificate to enter Mexico?"
    answer: "Yes. Mexico requires a veterinary health certificate for dogs and cats issued within 10 days of travel. The certificate must confirm microchip, current vaccinations, and that the animal is free from signs of disease. It should be issued by an accredited veterinarian."
  - question: "Is there quarantine for pets entering Mexico?"
    answer: "There is no routine quarantine for dogs and cats entering Mexico from most countries, provided documentation is in order. Pets are inspected at the port of entry by SENASICA officials."
  - question: "Can I drive into Mexico with my pet?"
    answer: "Yes. Land border crossings into Mexico handle pets regularly. You need the same documentation as for air travel: health certificate, vaccination records, and microchip information. The process is usually quick when paperwork is complete."
---
