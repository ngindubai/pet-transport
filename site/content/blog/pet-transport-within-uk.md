---
title: "Pet Transport Within the UK: A Plain-English Guide to Couriers, Regulations and Moving Your Pet Safely"
...
seo:
  title: "Pet Transport Within the UK: Couriers, Rules and Costs | PetTransportGlobal"
  description: "Moving a dog or cat within the UK in 2026. DEFRA Type 1 authorisation explained, what to check before hiring a courier, domestic air cargo, and what the welfare rules require."
tags:
  - "uk"
  - "domestic"
  - "couriers"
  ...
  - "planning"
faqs:
  - question: "Do I need a licensed transporter to move my pet within the UK?"
    answer: "Not if you are moving your own pet yourself. The Animal Transporter Authorisation (ATA) requirement applies to commercial operators being paid to transport animals. If you drive your own dog from London to Edinburgh, no licence is needed. If you hire a courier to do it, that courier must hold a valid Type 1 ATA issued by APHA."
  - question: "What is a Type 1 Animal Transporter Authorisation?"
    answer: "A Type 1 ATA is a DEFRA (APHA) licence for commercial operators transporting animals on journeys up to 8 hours. It confirms the transporter meets minimum welfare standards for vehicles, handling, and journey planning. Type 2 covers longer journeys and has additional requirements. Ask any domestic pet courier for their ATA number before booking."
  - question: "Can I fly my dog domestically within the UK?"
    answer: "Yes. Airlines including Loganair and some charter services carry pets as cargo on domestic UK routes. The most common use case is moving pets to or from Scotland, particularly the Scottish islands. Most UK domestic airlines do not accept pets in the passenger cabin; cargo is the standard option."
  - question: "How much does a domestic UK pet courier cost?"
    answer: "For a solo dog transport from London to Edinburgh, typical courier costs range from GBP 150 to GBP 400 depending on the size of the dog, the specific service level, and whether the journey is shared or private. Multi-leg journeys and island destinations cost more. Air cargo to the Scottish islands typically costs GBP 100 to GBP 250 per pet."
---

Moving a pet within the UK sounds like it should be simple. In many ways it is, especially compared to international transport. You do not need a titre test, a government health certificate, or an import permit. But there are still rules that apply once money changes hands for transporting animals, and owners often discover them when something goes wrong with a courier booking they thought was straightforward.
...
**Road courier, shared service (multiple pets, fixed route day):**
London to Edinburgh: GBP 120 to GBP 180
Birmingham to Bristol: GBP 60 to GBP 100
Manchester to Glasgow: GBP 100 to GBP 160

**Road courier, private dedicated (your pet only):**
Add approximately 50 to 100% to shared rates for a dedicated private service. For a large dog needing significant space, private is often necessary rather than optional.

**Air cargo, domestic (Loganair, Scottish routes):**
Glasgow to Kirkwall: approximately GBP 100 to GBP 200 per pet depending on crate weight
Edinburgh to Stornoway: approximately GBP 120 to GBP 230
