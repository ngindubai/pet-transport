...
seo:
  title: "Bringing a Pet to Romania: EU Rules | Pet Transport Global"
  description: "Guide to bringing your dog or cat to Romania in 2026: EU pet passport, titre test from outside EU, and ANSVSA border inspection requirements."
tags:
  - "Romania"
  - "pet import"
  - "EU"
faqs:
  - question: "What does my pet need to enter Romania?"
    answer: "Pets from EU countries need an EU pet passport, ISO microchip, and current rabies vaccination. Pets from outside the EU, including the UK, need these plus a rabies antibody titre test with at least 0.5 IU/ml and a three-month wait after the blood draw."
  - question: "Is there quarantine for pets entering Romania?"
    answer: "No quarantine for pets from EU or listed countries with complete documentation. Pets from unlisted countries without a valid titre test may be refused or quarantined."
  - question: "Does Romania have breed-specific legislation?"
    answer: "Romania previously had strict breed-specific legislation but this has been reformed. Confirm current rules with ANSVSA, particularly if travelling with a large or guard-type breed."
  - question: "What authority manages pet imports in Romania?"
    answer: "The National Sanitary Veterinary and Food Safety Authority (ANSVSA) oversees pet imports. Information is at ansvsa.ro."
---
