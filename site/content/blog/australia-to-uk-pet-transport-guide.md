...
seo:
  title: "Australia to UK Pet Transport | Pet Transport Global"
  description: "Moving from Australia to the UK with pets? Here is exactly what microchip, vaccination, titre test, and AHC rules apply when bringing dogs or cats from Australia to Great Britain."
tags:
  - "australia"
  - "uk"
  - "routes"
faqs:
  - question: "Does my Australian dog need a titre test to enter the UK?"
    answer: "Yes. Dogs entering the UK from Australia need a valid rabies titre test showing 0.5 IU/mL or above. The test must be taken from a blood sample drawn at least 30 days after the most recent rabies vaccination, and the UK travel must occur at least 3 months after the date of the satisfactory titre test result."
  - question: "How long does it take to prepare a dog for travel from Australia to the UK?"
    answer: "Allow at least 4-6 months from start to finish. The titre test must be taken at least 30 days post-vaccination, and UK entry must occur at least 3 months after the titre test. If vaccinations need to be set up from scratch, add another month."
  - question: "Does my cat need a titre test to enter the UK from Australia?"
    answer: "Yes. Cats entering the UK from non-EU countries (which includes Australia) require the same titre test process as dogs. The same 30-day post-vaccination wait and 3-month post-titre-test stand-down apply."
---
