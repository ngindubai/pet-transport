...
seo:
  title: "USA to UK Pet Transport: USDA APHIS | Pet Transport Global"
  description: "Moving dogs or cats from the United States to the United Kingdom. USDA APHIS health certificate process, UK APHA import requirements, and the full step-by-step guide."
tags:
  - "usa"
  - "uk"
...
faqs:
  - question: "Does my dog need a titre test to enter the UK from the USA?"
    answer: "No. The UK does not require a rabies antibody titre test for dogs or cats entering from the USA. The USA is classified as a listed third country by the UK, requiring microchip, current rabies vaccination, and a UK-format health certificate signed by a USDA-accredited vet and endorsed by USDA APHIS."
  - question: "How long does it take to prepare documentation for USA to UK pet travel?"
    answer: "Allow a minimum of 3-4 weeks: 1-2 weeks to book a USDA-accredited vet appointment, 1-3 business days for USDA APHIS endorsement (in-person), plus time for the 10-day health certificate window. Total minimum to departure: 2 weeks from APHIS endorsement. Build in more if possible."
  - question: "Which airlines fly dogs from the USA to the UK?"
    answer: "British Airways, Virgin Atlantic, and United Airlines operate USA to UK routes with cargo pet services. None allows pets in cabin on transatlantic routes. American Airlines accepts pets in-cabin on some US domestic routes but not transatlantic. Book cargo well in advance -- space is limited."
---

The USA-to-UK route is one of the world's most common pet relocation journeys. It is manageable with careful preparation and no titre test requirement -- but the USDA APHIS endorsement process is the step that catches most US owners off guard.
