...
seo:
  title: "Moving to Hong Kong with a Cat | Pet Transport Global"
  description: "Hong Kong has a structured cat import process managed by AFCD. Here is what cat owners moving to Hong Kong need: import licence, health certificate, and 4-day in-situ quarantine."
tags:
  - "Hong Kong"
  - "cat import"
  ...
  - "Asia pet travel"
faqs:
  - question: "Does Hong Kong require quarantine for imported cats?"
    answer: "Hong Kong requires an in-situ quarantine period of at least 4 days for cats from most countries (longer for cats from countries with specific disease concerns). The quarantine is conducted at the AFCD quarantine facility at Tsuen Wan or at an approved quarantine facility. The exact duration depends on your cat's country of origin and vaccination history."
  - question: "What is AFCD and what role does it play in cat imports to Hong Kong?"
    answer: "AFCD (Agriculture, Fisheries and Conservation Department) manages all live animal imports into Hong Kong, including pet cats. You must apply to AFCD for a pet import licence before your cat travels. AFCD inspectors check documentation and manage the quarantine process."
  - question: "What vaccinations does Hong Kong require for imported cats?"
    answer: "Hong Kong requires current core vaccinations for cats: rabies and FVRCP (feline viral rhinotracheitis, calicivirus, panleukopenia). The vaccination history must be documented in the health certificate. A microchip is required. Confirm the current AFCD requirements at afcd.gov.hk before travel."
---
