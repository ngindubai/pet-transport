...
seo:
  title: "Pet Transport Insurance | Pet Transport Global"
  description: "Does your pet need insurance for international travel? This guide explains what pet transport insurance covers, what it does not, and how to buy it."
tags:
  - "pet transport insurance"
  - "practical guide"
  - "costs"
faqs:
  - question: "Does my regular pet insurance cover international transport?"
    answer: "Most standard pet insurance policies do not cover international transit by air. They typically cover veterinary costs for illness and injury, but exclude events that occur during commercial air transport. Check your policy wording carefully under exclusions. If your regular policy does not cover transit, consider a standalone pet transport insurance policy for the journey."
  - question: "What is the declared value for pet transport insurance?"
    answer: "The declared value is the amount you would claim if your pet were lost or died during transit. For pedigree animals, use a realistic current market value. For non-pedigree pets, use a reasonable figure based on the cost of rehoming a similar animal. Be honest -- overclaiming can void a policy and constitute insurance fraud."
  - question: "Does my pet transport company provide insurance for my pet?"
    answer: "Some pet transport companies include basic transit insurance as part of their service. Ask directly whether insurance is included in your quote and what exactly it covers. Many companies offer it as an optional add-on at an additional cost. If it is not included, ask your company to recommend a specialist provider."
---
