...
seo:
  title: "Bringing a Pet to Qatar | Pet Transport Global"
  description: "Full guide to bringing your dog or cat to Qatar in 2026: MECC import permit, approved breeds, health certificate, and arrival process at Hamad International Airport."
tags:
  - "Qatar"
  - "pet import"
  - "Middle East"
faqs:
  - question: "Does Qatar allow dogs and cats as pets?"
    answer: "Yes, Qatar permits dogs and cats as pets. However, Qatar has a list of restricted and banned dog breeds that may not be imported. An import permit from the Ministry of Environment and Climate Change (MECC) is required before the animal travels."
  - question: "What documentation does my pet need to enter Qatar?"
    answer: "Pets entering Qatar need: an import permit from the MECC, a microchip (ISO 15digit), a valid rabies vaccination, a health certificate issued by an official vet in the origin country and endorsed by the government authority, and sometimes additional tests depending on the origin country."
  - question: "Which dog breeds are banned in Qatar?"
    answer: "Qatar maintains a list of restricted breeds that are either banned outright or require additional approval. The list includes fighting-type and large guard breeds. Check the current approved breed list with the MECC before applying for your import permit."
  - question: "Is there quarantine for pets entering Qatar?"
    answer: "There is no mandatory quarantine for pets with correct documentation entering Qatar. However, veterinary inspection at Hamad International Airport is thorough, and incomplete documentation can result in temporary holding."
---
