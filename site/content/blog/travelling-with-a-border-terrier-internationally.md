...
tags:
  ...
  - "dog"
faqs:
  - question: "Can a Border Terrier travel in the cabin on a plane?"
    answer: "Border Terriers can sometimes travel in the cabin on shorter routes, as they are small enough to meet the weight limits of some airlines (combined weight under 8-10 kg depending on the carrier). In-cabin acceptance varies by airline, route, and aircraft type. For long-haul international flights, hold travel as manifested cargo is the standard option. Always confirm with your airline before booking."
  - question: "Are Border Terriers banned in any country?"
    answer: "Border Terriers are not subject to breed-specific bans in most countries and do not appear on restricted breed lists in any country we are aware of. This makes them relatively straightforward to relocate internationally. Always confirm with your specific destination country's authorities before travel."
  - question: "What crate size does a Border Terrier need for hold travel?"
    answer: "Most Border Terriers need an IATA-compliant size 2 or size 3 crate for hold travel. The crate must be large enough for your dog to stand at full height, lie down naturally, and turn around. Measure your individual dog and choose the crate accordingly, rather than relying on breed average sizes."
---
