...
seo:
  title: "Bringing a Pet to Colombia | Pet Transport Global"
  description: "Guide to bringing your dog or cat to Colombia in 2026: ICA health certificate requirements, microchip rules, rabies vaccination, and arriving at Bogota El Dorado."
tags:
  - "Colombia"
  - "South America"
  ...
  - "ICA"
faqs:
  - question: "What government authority manages pet imports into Colombia?"
    answer: "The Instituto Colombiano Agropecuario (ICA) manages live animal imports into Colombia. All pets arriving in Colombia need an ICA-approved health certificate issued in the origin country."
  - question: "Does Colombia quarantine imported pets?"
    answer: "Colombia does not operate a mandatory quarantine for pets from most countries with complete documentation. ICA inspectors at El Dorado International Airport in Bogota check documentation and inspect the animal."
  - question: "Does Colombia require a rabies titre test?"
    answer: "Colombia does not currently require a rabies antibody titre test from most origin countries. A current rabies vaccination documented on the health certificate is sufficient. Confirm current requirements with ICA for your specific origin country."
  - question: "How many pets can I bring to Colombia as personal import?"
    answer: "Colombia generally allows up to 2 pets per traveller as personal imports without commercial classification. More than 2 pets requires a commercial import permit process."
---
