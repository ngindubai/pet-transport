...
seo:
  title: "EU Pet Passport Guide 2026: What It Is | Pet Transport Global"
  description: "A complete guide to the EU pet passport in 2026: what it records, which countries accept it, how UK pets are affected post-Brexit, and how to get one for your pet."
tags:
  - "EU pet passport"
  - "Europe"
  ...
  - "documentation guide"
faqs:
  - question: "What is an EU pet passport?"
    answer: "An EU pet passport is an official travel document for dogs, cats, and ferrets issued by an official veterinarian in an EU or EEA member state. It records the animal's microchip number, rabies vaccination history, and other relevant health information. It is accepted across the EU and EEA without additional documentation."
  - question: "Can UK pets still use EU pet passports after Brexit?"
    answer: "EU pet passports issued before January 1, 2021 to UK-resident pets are no longer accepted for travel from the UK into the EU. UK pets now need an Animal Health Certificate (AHC) for each trip into the EU. However, EU pet passports issued to UK-resident pets remain valid documents for travel within EU countries once the pet has entered the EU (e.g., if the passport was issued while you lived in an EU country and you have not relocated back to the UK)."
  - question: "How do I get an EU pet passport for my pet?"
    answer: "Only official veterinarians (OVs) authorised by EU member states can issue EU pet passports. If you live in an EU country, contact an OV vet in your country to have the passport issued. The vet records the microchip, issues the passport, and enters the first vaccination details."
  - question: "Does the EU pet passport expire?"
    answer: "The passport itself does not expire. However, the vaccinations recorded in it do. A pet passport with an expired rabies vaccination is not valid for travel into or within the EU. Keep vaccinations current and ensure they are recorded in the passport by an OV."
---
