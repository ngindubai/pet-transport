---
title: "How to Prepare Your Pet's Crate for International Air Travel"
...
seo:
  title: "How to Prepare Your Pet's Crate for | Pet Transport Global"
  description: "IATA crate requirements, sizing rules, labelling, and crate training tips for international pet transport. Get this right before the flight."
tags:
  - "planning"
  - "crates"
  - "tips"
...
faqs:
  - question: "What crate does my pet need for international air travel?"
    answer: "All pets travelling as cargo on international flights must use an IATA-compliant rigid plastic or wooden crate. Soft-sided carriers are not accepted. The crate must allow your pet to stand at full height, sit upright, lie down in a natural position, and turn around without touching the sides or top. Ventilation must cover at least one-third of the surface area, with openings on at least three sides."
  - question: "How do I know if my pet's crate is the right size?"
    answer: "Measure your pet: height from floor to top of head while standing, length from nose to base of tail, and width across the shoulders. Add roughly 10cm to height and length, and at least 5cm to width. The crate should be snug enough to feel safe but roomy enough for normal movement. If in doubt, size up. An oversized crate is safer than a crate your pet cannot move in properly."
  - question: "Do I need to label the crate with anything specific?"
    answer: "Yes. IATA and most airlines require live animal labels on at least two sides of the crate (top and one end). Labels must include: 'Live Animal' in English and the destination language, directional arrows showing which way is up, the owner's contact details (name, address, phone), and the name of the animal. Most airlines provide standard live animal label sets. Your IPATA agent can advise on the current label requirements for your route."
  - question: "Should I put bedding in my pet's crate?"
    answer: "A small amount of familiar bedding -- something that smells like home -- can help settle a nervous pet. Avoid thick layers that reduce airflow or could bunch up and trap a paw. Do not use loose items that could shift and restrict movement. A thin, washable liner or a worn T-shirt is enough. Some airlines restrict certain bedding materials, so check before adding anything unusual."
---
...
1. **"Live Animal"** -- in large letters, in English and the language of the destination country
2. **Directional arrows** -- pointing upward, on all four sides
3. **Your contact details** -- full name, home address, and phone number (including country code)
4. **Pet details** -- name, species, breed, age, and sex
5. **Feeding and watering instructions** -- even if the instruction is "do not feed"
