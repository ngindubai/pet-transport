...
seo:
  title: "Pet Travel Documentation Checklist | Pet Transport Global"
  description: "A complete checklist of pet travel documents for international moves. Print this out, tick each item off, and travel with confidence that nothing has been "
tags:
    - "pet travel checklist"
    - "pet documentation"
    - "international pet travel"
faqs:
    - question: "Which documents are required for all international pet moves?"
      answer: "The core documents for any international pet move are: microchip documentation, rabies vaccination certificate, and an official health certificate. Depending on destination, additional documents include a rabies titre test result, import permit, tapeworm treatment record, and CITES permit (for restricted species)."
    - question: "Should I carry originals or copies of pet travel documents?"
