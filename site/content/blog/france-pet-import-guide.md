...
tags:
  ...
  - "pet import"
faqs:
  - question: "Do I need a special permit to bring my dog to France?"
    answer: "No import permit is required for dogs and cats entering France from EU countries with a valid EU pet passport. Non-EU arrivals need an Animal Health Certificate (AHC) in the EU format, and the animal must enter through an approved border inspection post (BIP)."
  - question: "Does my pet need a rabies titre test to enter France?"
    answer: "Pets from EU countries do not need a titre test. Pets from non-listed third countries (outside the approved list in EU Regulation 577/2013) need a valid rabies antibody titre test result showing at least 0.5 IU/ml, carried out at least 30 days after rabies vaccination and at least 3 months before travel."
  - question: "Can I bring my dog to France from the UK post-Brexit?"
    answer: "Yes. UK pets travelling to France need an AHC issued by an authorised UK vet and endorsed by the APHA. Dogs must also have tapeworm treatment (praziquantel) administered 1-5 days before arrival. The AHC is valid for 10 days from the vet examination date."
  - question: "What microchip does France require?"
    answer: "France requires ISO 11784/11785 compliant microchips (15-digit). The microchip must be implanted before or on the same date as the rabies vaccination for the vaccination to be counted as valid."
---
