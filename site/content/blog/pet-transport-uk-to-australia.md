...
| Route option | Airline | Transit |
|---|---|---|
| London to Sydney/Melbourne | Qantas | Via Singapore (usually SQ partnership) |
| London to Sydney/Melbourne | Singapore Airlines | Via Singapore (SIN) |
| London to Sydney/Melbourne | Lufthansa + partner | Via Frankfurt then Singapore or Hong Kong |
| London to Sydney/Melbourne | Cathay Pacific | Via Hong Kong (HKG) |
| London to Sydney/Melbourne | Emirates | Via Dubai (DXB) |
...
| DAFF import permit | No fee, but BICON account required |
...
*Last verified: June 2026. Sources: Australian DAFF pet import conditions ([biosecurity.gov.au/bicon](https://www.biosecurity.gov.au/bicon)); DEFRA pet export from Great Britain ([gov.uk/export-live-animals](https://www.gov.uk/export-live-animals)); Mickleham Post-Entry Quarantine Facility ([aff.gov.au](https://www.aff.gov.au)). Requirements change; verify directly with DAFF before booking.*
