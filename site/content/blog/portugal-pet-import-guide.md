...
seo:
  title: "Portugal Pet Import Guide: EU Entry Rules | Pet Transport Global"
  description: "Portugal is an EU member state. Here is what pets from inside and outside the EU need to enter Portugal, including post-Brexit UK requirements."
tags:
  - "portugal"
  - "europe"
  - "eu-travel"
faqs:
  - question: "Can I bring my dog from the UK to Portugal without quarantine?"
    answer: "Yes. There is no quarantine for dogs entering Portugal from the UK. You need a microchip, a valid rabies vaccination (given at least 21 days before travel), and an Animal Health Certificate issued by an Official Veterinarian and endorsed by APHA within 10 days of travel."
  - question: "Can I bring my dog to the Azores or Madeira?"
    answer: "The Azores and Madeira are part of Portugal and are rabies-free territories with stricter pet import rules than mainland Portugal. Dogs and cats travelling to the Azores or Madeira from outside the EU typically need a rabies titre test with a satisfactory result taken at least 90 days before travel. Plan well in advance."
  - question: "How many pets can I bring to Portugal from the UK at once?"
    answer: "Up to 5 pets per trip is permitted for non-commercial movements. More than 5 pets counts as a commercial movement and requires additional documentation. If travelling with a large number of pets, contact APHA and DGAV (Portugal) in advance."
---
