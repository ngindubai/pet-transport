...
seo:
  title: "Greece Pet Import Guide: EU Entry Rules | Pet Transport Global"
  description: "Greece is an EU member state. Here is what dogs and cats need to enter from both EU and non-EU countries, including what UK pets need post-Brexit."
tags:
  - "greece"
  - "europe"
  - "eu-travel"
faqs:
  - question: "Can I bring my pet to Greek islands as well as the mainland?"
    answer: "Yes. The Greek islands are part of Greece and do not have separate pet import rules. Ferries between islands and the mainland accept pets -- rules vary by ferry company, with most requiring pets to be on a lead or in a carrier and some banning them from cabins."
  - question: "What does my UK dog need to enter Greece?"
    answer: "A microchip, a valid rabies vaccination (given at least 21 days before travel), and an Animal Health Certificate issued by an Official Veterinarian and endorsed by APHA within 10 days of travel. No quarantine, no titre test for mainland Greece."
  - question: "Are there breed-specific laws in Greece?"
    answer: "Greece has national BSL (breed-specific legislation) covering breeds including American Pit Bull Terriers, Rottweilers, and several others. These breeds must be muzzled and on a lead in public areas. Import is not banned but is subject to additional rules. Check with DAAOK (the Greek agricultural authority) before importing a restricted breed."
---
