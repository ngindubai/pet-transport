...
seo:
  title: "Pet Transport from Australia to New | Pet Transport Global"
  description: "Moving a dog or cat from Australia to New Zealand. MPI biosecurity requirements, the approved pathway, approved carriers and what the quarantine process looks like."
tags:
  - "Australia"
  - "New Zealand"
  ...
  - "cat"
faqs:
  - question: "Is there a quarantine period for pets moving from Australia to New Zealand?"
    answer: "Yes. All dogs and cats arriving in New Zealand, including those from Australia, must undergo a mandatory ten-day isolation period at an MPI-approved facility. The cost is borne by the owner and is typically NZD 1,500 to NZD 2,500. The isolation facility must be booked in advance before travel."
  - question: "Do Australian dogs and cats need a rabies vaccination for New Zealand?"
    answer: "Australia is a rabies-free country, so the rabies vaccination requirement for New Zealand applies differently than for pets from rabies-risk origins. The MPI Import Health Standard for dogs and cats from Australia outlines the specific requirements. Download the current version from mpi.govt.nz and work through it with your vet well in advance."
  - question: "Which airlines fly pets from Australia to New Zealand?"
    answer: "Air New Zealand and Qantas both serve the Trans-Tasman route extensively and have live animal cargo programmes. Air New Zealand Cargo and Qantas Freight are the primary booking contacts. Popular city pairs include Sydney-Auckland, Melbourne-Auckland, and Brisbane-Auckland. Book the cargo space well in advance as Trans-Tasman flights are often full."
---
