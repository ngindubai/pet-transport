---
title: "South Africa to UK Pet Transport: APHA Requirements, Approved Labs, and Airline Options"
...
seo:
  title: "South Africa to UK Pet Transport: APHA Rules | Pet Transport Global"
  description: "South Africa is classified as a non-listed country for UK pet imports. Here's the full titre test and documentation process for moving pets from SA to the UK."
tags:
  - "south-africa"
  - "uk"
  - "planning"
faqs:
  - question: "How long does the titre test take in South Africa?"
    answer: "Blood draw to result typically takes 7-14 days depending on which approved laboratory is used. If the sample is shipped internationally to a reference lab, allow 2-3 weeks for results. The 90-day waiting period starts from the date of a satisfactory result."
---
