...
seo:
  title: "New Zealand Pet Import Guide | Pet Transport Global"
  description: "New Zealand has some of the world's most rigorous pet import rules. Here is what dogs and cats need to enter NZ, including approved countries, quarantine, and MPI requirements."
tags:
  - "new-zealand"
  - "oceania"
  - "quarantine"
faqs:
  - question: "How long is quarantine for pets entering New Zealand?"
    answer: "Dogs and cats from most countries face 10 days' managed isolation at the MPI facility at Auckland Airport. Pets from Australia, Norfolk Island, and Hawaii that meet all requirements may qualify for 10-day home isolation instead. The managed isolation booking must be secured well in advance."
  - question: "What countries can send pets to New Zealand without quarantine?"
    answer: "Pets from Australia, Norfolk Island, and qualified Hawaii addresses may be eligible for home isolation rather than managed isolation facility quarantine, provided all documentation and treatment requirements are met. No country is fully exempt from inspection on arrival."
  - question: "Can I bring a brachycephalic dog to New Zealand by air?"
    answer: "Many airlines restrict brachycephalic (flat-faced) breeds from cargo hold travel. Air New Zealand has restrictions on breeds including Bulldogs, Pugs, and Boxers. Check with your chosen airline before booking."
---
