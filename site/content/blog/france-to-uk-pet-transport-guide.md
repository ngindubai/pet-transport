...
seo:
  title: "Pet Transport from France to UK | Pet Transport Global"
  description: "Complete guide to moving your dog or cat from France to the UK in 2026: APHA health certificate, tapeworm treatment, approved routes, and what post-Brexit rules mean for French-registered pets."
tags:
  - "France"
  - "UK"
  ...
  - "post-Brexit"
faqs:
  - question: "Can I bring my pet from France to the UK after Brexit?"
    answer: "Yes. Pets can travel from France to the UK after Brexit, but the rules changed in 2021. French pets (or pets registered in the EU) now need an official animal health certificate (AHC) issued by an Official Vet in France, microchip, current rabies vaccination, tapeworm treatment for dogs, and must use an approved route."
  - question: "Does my French-registered pet need a titre test to enter the UK?"
    answer: "No. France is a listed country for UK pet travel, which means a rabies titre test is not required. A valid rabies vaccination and the AHC are sufficient."
  - question: "Does my dog need tapeworm treatment to enter the UK from France?"
    answer: "Yes. Dogs entering the UK from France must be treated against Echinococcus tapeworm (tapeworm treatment using praziquantel). The treatment must be administered by a vet between 24 and 120 hours (1 to 5 days) before arrival. The vet must document it in the health certificate."
  - question: "Which routes can I use to bring a pet from France to the UK?"
    answer: "Approved routes include: ferry services (Eurostar in the car, Dover-Calais ferries operated by DFDS and P&O), and air cargo. Not all ferry routes are PETS-approved. Check the UK Government's list of approved routes at gov.uk/bring-pet-to-great-britain."
---
