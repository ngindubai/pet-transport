...
seo:
  title: "Pet Transport from UK to France: AHC | Pet Transport Global"
  description: "Step-by-step guide to moving your dog or cat from the UK to France in 2026: AHC documentation, tapeworm timing, approved entry points, and the Channel Tunnel option."
tags:
  - "UK to France"
  - "pet transport"
  ...
  - "route guide"
faqs:
  - question: "What does my dog need to travel from the UK to France?"
    answer: "Microchip, current rabies vaccination (21-day wait after first vaccination), an Animal Health Certificate (AHC) issued by a UK Official Veterinarian and endorsed by APHA, and tapeworm treatment (praziquantel) administered by a vet 1-5 days before arrival in France."
  - question: "Can I take my cat through the Channel Tunnel to France?"
    answer: "Yes. Cats can travel via Eurotunnel Le Shuttle with you in the car. Cats need microchip, current rabies vaccination, and an AHC. Cats do not need tapeworm treatment (this applies to dogs only)."
  - question: "How much does it cost to get an AHC for my pet?"
    answer: "AHC costs vary by vet practice. Expect to pay GBP 100-200 for the vet examination and certificate, plus a small APHA endorsement fee. The endorsement is processed online by the vet through APHA's system and is usually completed on the same day or next day."
  - question: "Can I use the same AHC to re-enter the UK after visiting France?"
    answer: "No. Each entry into an EU/EEA country requires a new AHC from a UK OV. The AHC is valid for 10 days from the vet examination date, for a single entry. For frequent travel, consider whether a pet travel pass or registered third-country animal status could simplify the process."
---
