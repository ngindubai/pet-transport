...
title_tag: "Pet Transport Japan to South Korea | AQS Export Certificate Guide 2026"
meta_description: "Japan to South Korea pet transport: AQS export health certificate, QIAS pre-registration, no titre test, no quarantine. Full guide for dogs and cats from Tokyo to Seoul."
route_data:
  origin: "Japan"
  origin_slug: "japan"
  destination: "South Korea"
  destination_slug: "south-korea"
  origin_authority: "MAFF / Animal Quarantine Service (AQS), Japan"
...
faqs:
  - q: "Does Japan to South Korea require a titre test?"
    a: "No. South Korea does not require a rabies titre test for pets from Japan. The requirements are a valid rabies vaccination, an AQS-issued export health certificate from Japan, and QIAS pre-registration. Animals are inspected at Incheon and released on arrival day with no quarantine."
  - q: "How does Japan issue pet export health certificates?"
    a: "AQS (Animal Quarantine Service) issues health certificates for live animal exports from Japan. Your Japanese vet prepares the clinical health documentation, and AQS endorses it at one of their airport offices. The certificate must be issued within 10 days of departure. AQS offices are at Narita, Haneda, Kansai and Chubu airports."
...
links:
  ...
  - label: "QIAS Pet Import Procedures (South Korea)"
    url: "https://www.qia.go.kr/english"
---

## Japan to South Korea: One of Asia's Easier Routes

For owners leaving Japan, the South Korea move is a welcome relief from the complexity of routes heading to Australia, New Zealand or back into Japan itself. **No titre test, no quarantine**, clear processes at both ends. Allow 3–6 weeks for preparation.
...
- **AQS export health certificate**: Issued within 10 days of departure
- **QIAS pre-registration**: At least 7 days before arrival
- **Entry point**: Incheon International (ICN)

---

## AQS Export Health Certificate

Japan's AQS issues export health certificates at airport offices. The process:

1. Have your vet prepare a clinical examination certificate
2. Take the animal to the AQS office at your departure airport (NRT, HND, KIX, NGO) on or near departure day
...
Register at the QIAS online portal (qia.go.kr) at least 7 days before arrival. Upload the AQS health certificate and vaccination records. On arrival at Incheon, the QIAS inspection counter is in the arrivals area. Inspection takes 1–2 hours. No quarantine if documents are complete.
...
**Asiana Airlines** has pet cargo options on the Tokyo–Seoul corridor.
