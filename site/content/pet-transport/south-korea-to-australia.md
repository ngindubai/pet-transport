...
quarantine_days: "10"
title_tag: "Pet Transport South Korea to Australia | DAFF Import Permit 2026"
meta_description: "South Korea to Australia pet transport: DAFF import permit, QIAS export cert, rabies titre test, 10-day Mickleham quarantine. Full guide for dogs and cats from Seoul."
route_data:
  origin: "South Korea"
  ...
  min_weeks: 20
  quarantine: true
  quarantine_duration: "10 days at ACDP (Australian Centre for Disease Preparedness), Mickleham VIC"
...
South Korea is a Group 3 country for Australian import purposes. Dogs and cats from Group 3 countries must:

1. Have a DAFF import permit
2. Be microchipped (ISO 15444)
3. Have a current rabies vaccination
4. Complete a FAVN titre test with result ≥0.5 IU/ml, collected at least 180 days before Australian arrival
5. Have a QIAS-endorsed export health certificate from Korea
6. Complete 10 days mandatory quarantine at ACDP Mickleham

---

## Step 1: DAFF Import Permit

Apply via DAFF's online system. You will need to provide:
- Species, breed, age, microchip number
...
## Step 2: Titre Test Timing (Critical)
...
## Step 4: Quarantine at ACDP Mickleham

All pets arriving in Australia go directly to the ACDP facility in Mickleham, Victoria (near Melbourne Airport). Quarantine is 10 nights. Owners cannot visit during quarantine but can call the facility for updates.

If your final destination is not Melbourne, you can book an ACDP-approved animal transport company to collect your pet after release and fly or drive to your destination. Costs for 10 nights at ACDP run approximately AUD 2,000–3,500 depending on species and accommodation type.
...
- DAFF import permit: AUD 460 (government fee)
- Titre test (lab + courier from Korea): approximately USD 200–300
- QIAS export health certificate endorsement: approximately USD 50–100
- Airline cargo from Seoul to Melbourne/Sydney: approximately USD 600–2,000 depending on size
- ACDP quarantine (10 nights): approximately AUD 2,000–3,500
- Agent fees (recommended): AUD 1,500–4,000

Total: approximately AUD 5,000–12,000 for most animals. Using a specialist agent significantly reduces documentation errors and associated costs.
