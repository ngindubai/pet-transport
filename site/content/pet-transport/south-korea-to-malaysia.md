...
title_tag: "Pet Transport South Korea to Malaysia | DVS Import Permit Guide 2026"
meta_description: "South Korea to Malaysia pet transport: DVS import permit, QIAS export cert, rabies vaccination. No quarantine. Full guide for dogs and cats from Seoul to Kuala Lumpur."
route_data:
  origin: "South Korea"
  ...
  destination_authority: "DVS (Department of Veterinary Services Malaysia)"
  complexity: "moderate"
  min_weeks: 6
  quarantine: false
  titre_test_required: false
  approved_entry_airports: ["KUL (Kuala Lumpur International)", "PEN (Penang International)"]
  airlines: ["Korean Air (KE)", "Malaysia Airlines (MH)", "Asiana Airlines", "AirAsia X"]
faqs:
  - q: "Do I need to apply for a permit before bringing my pet to Malaysia?"
    a: "Yes. Malaysia's Department of Veterinary Services requires an import permit to be obtained before the animal travels. Apply at least 6–8 weeks before your intended travel date. The permit specifies the entry port, species and health requirements. Entry without a valid permit can result in the animal being held or returned."
  - q: "Is there quarantine in Malaysia for pets from South Korea?"
    a: "No quarantine for dogs and cats from South Korea that arrive with a valid DVS import permit, government health certificate and current rabies vaccination. Animals are inspected by DVS at the airport of arrival and released to owners on the same day."
...
links:
  ...
  - label: "QIAS Animal Export Procedures"
...
## Step 1: Apply for the DVS Malaysia Import Permit

Contact the DVS import/export division early. Applications can be submitted online or in person at a DVS regional office. You will need to provide:

- Species, breed, age, sex and microchip number of the animal
- Country of origin and intended entry port (KUL or PEN)
...
## Step 2: QIAS Export Health Certificate in Korea

In South Korea, have your regular vet prepare a health certificate and arrange QIAS endorsement. The certificate must:

- State the microchip number (ISO 11784/11785)
- List all rabies vaccinations (date, product, batch, next due)
...
## Step 3: Travel Day and DVS Inspection at KUL

On arrival at Kuala Lumpur International Airport, go to the DVS inspection counter in the arrivals hall (signposted for live animals and agricultural products). Present:

- Original DVS import permit
- Original QIAS-endorsed health certificate
- Vaccination records
- Your passport

The DVS inspector will verify documents and physically inspect the animal. Clearance typically takes 1–2 hours. Once cleared, the animal can travel onward to your home address.

---

## Airlines on This Route

**Korean Air (KE)** and **Asiana Airlines** both operate ICN–KUL with established pet cargo programmes. Korean Air accepts pets as excess baggage (in-cabin up to 7kg combined with carrier, hold for larger animals) and as manifest cargo.
