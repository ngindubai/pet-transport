---
title: "Shipping Dogs & Cats from Lesotho to Nepal | PetTransportGlobal"
description: "Complete guide to pet transport from Lesotho to Nepal. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "lesotho-to-nepal"
origin_name: "Lesotho"
...
content:
  h1: "Pet Transport from Lesotho to Nepal"
  overview: |
    The Lesotho to Nepal route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "What to know about the Lesotho to Nepal route"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Lesotho to Nepal?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Lesotho. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Nepal's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/nepal-to-lesotho/"
      text: "Pet Transport Nepal to Lesotho"
  upward:
