---
title: "Moving Your Pet from Haiti to Japan | Complete Guide"
description: "How to ship your dog or cat from Haiti to Japan. Japan import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Haiti to Japan"
  overview: |
    Moving to Japan from Haiti with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "What to know about the Haiti to Japan route"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Haiti to Japan?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Haiti. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Japan's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/japan-to-haiti/"
      text: "Pet Transport Japan to Haiti"
  upward:
