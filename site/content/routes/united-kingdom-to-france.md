---
title: "Pet Transport UK to France: AHC, Driving vs Flying and Post-Brexit Rules Explained"
description: "Moving a dog or cat from the UK to France in 2026. GB pet passports no longer valid. Animal Health Certificate required, Eurotunnel vs flying comparison, and costs."
date: "2026-06-04"
type: "routes"
layout: "single"
template_variant: "NE"
...
route_data:
  origin:
    ...
    export_requirements:
      health_certificate: "Animal Health Certificate (AHC) issued by an APHA-authorised Official Veterinarian within 10 days of travel. The GB-issued AHC replaces the pre-Brexit pet passport for UK to EU travel."
      export_permit: "No export permit required from the UK. The AHC serves as the travel document."
  ...
  destination:
    ...
    import_requirements:
      ...
      rabies_vaccination: "Required. Primary vaccination followed by a 21-day wait before EU entry. Boosters must be within validity."
      titre_test: "Not required. France/EU accepts pets from the UK (a listed country) without a titre test."
      quarantine: "Not required for pets with correct documentation."
      import_permit: "No import permit required for companion animals (dogs, cats, ferrets) entering France."
      health_certificate: "AHC issued within 10 days of travel, valid for EU entry and then for 4 months of onward travel within the EU."

  airlines:
    - name: "British Airways / Air France"
      type: "cargo_only"
      policy_summary: "No pets in cabin on transatlantic-configured aircraft. Cargo service available for the air route. Air France allows small dogs and cats in-cabin on European flights from Paris."
    - name: "Eurotunnel Le Shuttle"
      type: "cargo_only"
      policy_summary: "Pets travel in the car throughout the 35-minute crossing. Most popular option for UK to France moves. Foot passengers cannot bring pets."
    - name: "DFDS / P&O Ferries"
      type: "cargo_only"
      policy_summary: "Dover to Calais or Dunkirk. Pets stay in the car during crossing or in designated pet kennels for longer sailings. Foot passengers check ferry-specific pet policies."

  timeline_steps:
    - step: 1
      action: "Confirm microchip is ISO-standard and pre-dates rabies vaccination"
      timing: "Verify now. This is the most common documentation error."
      responsible: "Vet to confirm"
    - step: 2
      action: "Confirm rabies vaccination is current and 21-day wait is complete"
      timing: "At least 21 days must have passed since the first vaccination in the primary course."
      responsible: "Vet to verify"
    - step: 3
      action: "Book Eurotunnel crossing, ferry crossing, or air cargo space"
      timing: "Book your transport method first, especially for popular dates."
      responsible: "Owner"
    - step: 4
      action: "Find and book appointment with APHA-authorised Official Veterinarian"
      timing: "Book 2-3 weeks ahead. OV appointment must be scheduled within 10 days of travel."
      responsible: "Owner"
    - step: 5
      action: "OV issues Animal Health Certificate"
      timing: "Within 10 days of travel date"
      responsible: "APHA-authorised OV"
    - step: 6
      action: "Travel to France via chosen route"
      timing: "On travel date. Present AHC at French border inspection post if required."
      responsible: "Owner"
...
content:
  h1: "Pet Transport UK to France: Post-Brexit Documentation in 2026"
  overview: "Since Brexit, UK pets entering France require an Animal Health Certificate rather than the old GB pet passport. The process takes 4-8 weeks from start to travel date and involves an appointment with an Official Veterinarian. The Eurotunnel is the most stress-free option for dogs, keeping the animal in the car throughout. Flying is also possible but adds cost and cargo complexity."

  sections:
    - heading: "Why the GB pet passport no longer works for France"
      body: |
    ...
    - heading: "Eurotunnel vs ferry vs flying: which is right for your pet?"
      body: |
...
faqs:
  - question: "Do I need a new Animal Health Certificate for the return journey?"
