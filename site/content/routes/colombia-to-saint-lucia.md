---
title: "Shipping Dogs & Cats from Colombia to Saint Lucia | PetTransportGlobal"
description: "How to ship your dog or cat from Colombia to Saint Lucia. Saint Lucia import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "colombia-to-saint-lucia"
...
content:
  h1: "Pet Transport from Colombia to Saint Lucia"
  overview: |
    Moving to Saint Lucia from Colombia with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "Why this route needs early planning"
      body: |
        Compared to some international pet transport routes, Colombia to Saint Lucia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Colombia to Saint Lucia?"
  ...
  - question: "Can I take my cat to Saint Lucia from Colombia?"
    answer: "Yes, cats can be transported from Colombia to Saint Lucia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/saint-lucia-to-colombia/"
      text: "Pet Transport Saint Lucia to Colombia"
  upward:
