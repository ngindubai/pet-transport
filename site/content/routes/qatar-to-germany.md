...
content:
  h1: "Pet Transport from Qatar to Germany"
  overview: |
    Getting your pet from Qatar to Germany is entirely achievable, but the preparation timeline is not flexible.
  ...
  sections:
    - heading: "What to know about the Qatar to Germany route"
      body: |
        Compared to some international pet transport routes, Qatar to Germany is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Qatar to Germany?"
  ...
  - question: "Can I take my cat to Germany from Qatar?"
    answer: "Yes, cats can be transported from Qatar to Germany. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/germany-to-qatar/"
      text: "Pet Transport Germany to Qatar"
  upward:
