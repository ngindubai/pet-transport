---
title: "Pet Relocation Ukraine to North Macedonia | Requirements & Guide"
description: "How to ship your dog or cat from Ukraine to North Macedonia. North Macedonia import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "ukraine-to-north-macedonia"
origin_name: "Ukraine"
...
content:
  h1: "Pet Transport from Ukraine to North Macedonia"
  overview: |
    Pet transport from Ukraine to North Macedonia follows a clear process once you know what North Macedonia requires.
  ...
  sections:
    - heading: "Understanding North Macedonia's pet import rules"
      body: |
        Compared to some international pet transport routes, Ukraine to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Ukraine to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Ukraine?"
    answer: "Yes, cats can be transported from Ukraine to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-ukraine/"
      text: "Pet Transport North Macedonia to Ukraine"
  upward:
