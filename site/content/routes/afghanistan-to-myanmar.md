---
title: "Pet Relocation Afghanistan to Myanmar | Requirements & Guide"
description: "How to ship your dog or cat from Afghanistan to Myanmar. Myanmar import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "afghanistan-to-myanmar"
...
content:
  h1: "Pet Transport from Afghanistan to Myanmar"
  overview: |
    Moving to Myanmar from Afghanistan with a dog or cat means starting the paperwork months before your flight.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Afghanistan to Myanmar?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Afghanistan. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Myanmar's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/myanmar-to-afghanistan/"
      text: "Pet Transport Myanmar to Afghanistan"
  upward:
