---
template_variant: "B"
title: "Shipping Dogs & Cats from Jordan to Zimbabwe | PetTransportGlobal"
description: "Pet relocation from Jordan to Zimbabwe: Zimbabwe import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "jordan-to-zimbabwe"
origin_name: "Jordan"
...
content:
  h1: "Pet Transport from Jordan to Zimbabwe"
  overview: |
    The Jordan to Zimbabwe route is one many expats and returning families use each year with their pets.
  ...
  sections:
    - heading: "What to know about the Jordan to Zimbabwe route"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Jordan to Zimbabwe?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Jordan. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Zimbabwe's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/zimbabwe-to-jordan/"
      text: "Pet Transport Zimbabwe to Jordan"
  upward:
