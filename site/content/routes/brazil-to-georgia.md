---
title: "Shipping Dogs & Cats from Brazil to Georgia | PetTransportGlobal"
description: "Pet relocation from Brazil to Georgia: Georgia import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "brazil-to-georgia"
origin_name: "Brazil"
...
content:
  h1: "Pet Transport from Brazil to Georgia"
  overview: |
    Moving a pet from Brazil to Georgia involves more paperwork than most owners expect.
  ...
  sections:
    - heading: "What to know about the Brazil to Georgia route"
      body: |
        Compared to some international pet transport routes, Brazil to Georgia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Brazil to Georgia?"
  ...
  - question: "Can I take my cat to Georgia from Brazil?"
    answer: "Yes, cats can be transported from Brazil to Georgia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/georgia-to-brazil/"
      text: "Pet Transport Georgia to Brazil"
  upward:
