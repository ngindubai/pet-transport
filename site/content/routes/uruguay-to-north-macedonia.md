---
title: "Shipping Dogs & Cats from Uruguay to North Macedonia | PetTransportGlobal"
description: "Pet relocation from Uruguay to North Macedonia: North Macedonia import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "uruguay-to-north-macedonia"
origin_name: "Uruguay"
...
content:
  h1: "Pet Transport from Uruguay to North Macedonia"
  overview: |
    If you're relocating from Uruguay to North Macedonia and taking your pet, the good news is thousands of families do this every year.
  ...
  sections:
    - heading: "Understanding North Macedonia's pet import rules"
      body: |
        Compared to some international pet transport routes, Uruguay to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Uruguay to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Uruguay?"
    answer: "Yes, cats can be transported from Uruguay to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-uruguay/"
      text: "Pet Transport North Macedonia to Uruguay"
  upward:
