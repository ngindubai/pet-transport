---
title: "Shipping Dogs & Cats from Nauru to Ghana | PetTransportGlobal"
description: "Complete guide to pet transport from Nauru to Ghana. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Nauru to Ghana"
  overview: |
    International pet transport from Nauru to Ghana comes down to documentation timing more than anything else.
  ...
  sections:
    - heading: "What to know about the Nauru to Ghana route"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Nauru to Ghana?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Nauru. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Ghana's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/ghana-to-nauru/"
      text: "Pet Transport Ghana to Nauru"
  upward:
