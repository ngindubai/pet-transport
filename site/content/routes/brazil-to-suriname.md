---
title: "Shipping Dogs & Cats from Brazil to Suriname | PetTransportGlobal"
description: "Pet relocation from Brazil to Suriname: Suriname import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "brazil-to-suriname"
origin_name: "Brazil"
...
content:
  h1: "Pet Transport from Brazil to Suriname"
  overview: |
    International pet transport from Brazil to Suriname comes down to documentation timing more than anything else.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Suriname"
      body: |
        Compared to some international pet transport routes, Brazil to Suriname is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Brazil to Suriname?"
  ...
  - question: "Can I take my cat to Suriname from Brazil?"
    answer: "Yes, cats can be transported from Brazil to Suriname. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/suriname-to-brazil/"
      text: "Pet Transport Suriname to Brazil"
  upward:
