---
title: "Shipping Dogs & Cats from Andorra to New Zealand | PetTransportGlobal"
description: "Pet relocation from Andorra to New Zealand: New Zealand import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "andorra-to-new-zealand"
origin_name: "Andorra"
...
content:
  h1: "Pet Transport from Andorra to New Zealand"
  overview: |
    International pet transport from Andorra to New Zealand comes down to documentation timing more than anything else.
  ...
  sections:
    - heading: "What to know about the Andorra to New Zealand route"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Andorra to New Zealand?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Andorra. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check New Zealand's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/new-zealand-to-andorra/"
      text: "Pet Transport New Zealand to Andorra"
  upward:
