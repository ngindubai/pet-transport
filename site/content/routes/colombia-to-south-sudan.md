---
title: "Shipping Dogs & Cats from Colombia to South Sudan | PetTransportGlobal"
description: "Pet relocation from Colombia to South Sudan: South Sudan import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "colombia-to-south-sudan"
...
content:
  h1: "Pet Transport from Colombia to South Sudan"
  overview: |
    Getting your pet from Colombia to South Sudan is entirely achievable, but the preparation timeline is not flexible.
  ...
  sections:
    - heading: "Key requirements for moving your pet to South Sudan"
      body: |
        Compared to some international pet transport routes, Colombia to South Sudan is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Colombia to South Sudan?"
  ...
  - question: "Can I take my cat to South Sudan from Colombia?"
    answer: "Yes, cats can be transported from Colombia to South Sudan. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/south-sudan-to-colombia/"
      text: "Pet Transport South Sudan to Colombia"
  upward:
