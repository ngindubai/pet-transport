---
title: "Pet Transport from Latvia to North Macedonia | PetTransportGlobal"
description: "Pet relocation from Latvia to North Macedonia: North Macedonia import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "latvia-to-north-macedonia"
origin_name: "Latvia"
...
content:
  h1: "Pet Transport from Latvia to North Macedonia"
  overview: |
    Moving to North Macedonia from Latvia with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "Key requirements for moving your pet to North Macedonia"
      body: |
        Compared to some international pet transport routes, Latvia to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Latvia to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Latvia?"
    answer: "Yes, cats can be transported from Latvia to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-latvia/"
      text: "Pet Transport North Macedonia to Latvia"
  upward:
