---
title: "Shipping Dogs & Cats from Canada to Haiti | PetTransportGlobal"
description: "Complete guide to pet transport from Canada to Haiti. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Canada to Haiti"
  overview: |
    Getting your pet from Canada to Haiti is entirely achievable, but the preparation timeline is not flexible.
  ...
  sections:
    - heading: "Understanding Haiti's pet import rules"
      body: |
        Compared to some international pet transport routes, Canada to Haiti is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Haiti?"
  ...
  - question: "Can I take my cat to Haiti from Canada?"
    answer: "Yes, cats can be transported from Canada to Haiti. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/haiti-to-canada/"
      text: "Pet Transport Haiti to Canada"
  upward:
