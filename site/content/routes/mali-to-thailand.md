---
title: "Pet Relocation Mali to Thailand | Requirements & Guide"
description: "How to ship your dog or cat from Mali to Thailand. Thailand import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "mali-to-thailand"
origin_name: "Mali"
...
content:
  h1: "Pet Transport from Mali to Thailand"
  overview: |
    Moving a pet from Mali to Thailand involves more paperwork than most owners expect.
  ...
  sections:
    - heading: "What to know about the Mali to Thailand route"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Mali to Thailand?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Mali. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check Thailand's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/thailand-to-mali/"
      text: "Pet Transport Thailand to Mali"
  upward:
