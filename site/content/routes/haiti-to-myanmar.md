---
title: "Pet Relocation Haiti to Myanmar | Requirements & Guide"
description: "How to ship your dog or cat from Haiti to Myanmar. Myanmar import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "haiti-to-myanmar"
origin_name: "Haiti"
...
content:
  h1: "Pet Transport from Haiti to Myanmar"
  overview: |
    Moving a pet from Haiti to Myanmar involves more paperwork than most owners expect.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Haiti to Myanmar?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Haiti. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Myanmar's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/myanmar-to-haiti/"
      text: "Pet Transport Myanmar to Haiti"
  upward:
