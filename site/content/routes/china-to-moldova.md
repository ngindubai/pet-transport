---
title: "Shipping Dogs & Cats from China to Moldova | PetTransportGlobal"
description: "Complete guide to pet transport from China to Moldova. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "china-to-moldova"
origin_name: "China"
...
content:
  h1: "Pet Transport from China to Moldova"
  overview: |
    The China to Moldova route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "Why this route needs early planning"
      body: |
        Compared to some international pet transport routes, China to Moldova is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from China to Moldova?"
  ...
  - question: "Can I take my cat to Moldova from China?"
    answer: "Yes, cats can be transported from China to Moldova. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/moldova-to-china/"
      text: "Pet Transport Moldova to China"
  upward:
