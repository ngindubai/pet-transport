---
title: "Pet Transport from Burkina Faso to New Zealand | PetTransportGlobal"
description: "How to ship your dog or cat from Burkina Faso to New Zealand. New Zealand import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "burkina-faso-to-new-zealand"
...
content:
  h1: "Pet Transport from Burkina Faso to New Zealand"
  overview: |
    Pet transport from Burkina Faso to New Zealand follows a clear process once you know what New Zealand requires.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Burkina Faso to New Zealand?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Burkina Faso. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check New Zealand's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/new-zealand-to-burkina-faso/"
      text: "Pet Transport New Zealand to Burkina Faso"
  upward:
