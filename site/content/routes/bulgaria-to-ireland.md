---
template_variant: "E"
title: "Pet Relocation Bulgaria to Ireland | Requirements & Guide"
description: "How to ship your dog or cat from Bulgaria to Ireland. Ireland import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Bulgaria to Ireland"
  overview: |
    International pet transport from Bulgaria to Ireland comes down to documentation timing more than anything else.
  ...
  sections:
    - heading: "What to know about the Bulgaria to Ireland route"
      body: |
        Compared to some international pet transport routes, Bulgaria to Ireland is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Bulgaria to Ireland?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Bulgaria. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Ireland's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/ireland-to-bulgaria/"
      text: "Pet Transport Ireland to Bulgaria"
  upward:
