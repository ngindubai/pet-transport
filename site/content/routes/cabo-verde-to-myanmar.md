---
title: "Pet Relocation Cabo Verde to Myanmar | Requirements & Guide"
description: "How to ship your dog or cat from Cabo Verde to Myanmar. Myanmar import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "cabo-verde-to-myanmar"
...
content:
  h1: "Pet Transport from Cabo Verde to Myanmar"
  overview: |
    International pet transport from Cabo Verde to Myanmar comes down to documentation timing more than anything else.
  ...
  sections:
    ...
    - heading: "From experience: Cabo Verde to Myanmar pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Cabo Verde to Myanmar?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Cabo Verde. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Myanmar's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/myanmar-to-cabo-verde/"
      text: "Pet Transport Myanmar to Cabo Verde"
  upward:
