---
title: "Shipping Dogs & Cats from Colombia to Lithuania | PetTransportGlobal"
description: "Complete guide to pet transport from Colombia to Lithuania. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "colombia-to-lithuania"
...
content:
  h1: "Pet Transport from Colombia to Lithuania"
  overview: |
    Moving a pet from Colombia to Lithuania involves more paperwork than most owners expect.
  ...
  sections:
    - heading: "Understanding Lithuania's pet import rules"
      body: |
        Compared to some international pet transport routes, Colombia to Lithuania is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Colombia to Lithuania?"
  ...
  - question: "Can I take my cat to Lithuania from Colombia?"
    answer: "Yes, cats can be transported from Colombia to Lithuania. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/lithuania-to-colombia/"
      text: "Pet Transport Lithuania to Colombia"
  upward:
