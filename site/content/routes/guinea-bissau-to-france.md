---
title: "Shipping Dogs & Cats from Guinea-Bissau to France | PetTransportGlobal"
description: "How to ship your dog or cat from Guinea-Bissau to France. France import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Guinea-Bissau to France"
  overview: |
    If you're relocating from Guinea-Bissau to France and taking your pet, the good news is thousands of families do this every year.
  ...
  sections:
    - heading: "What to know about the Guinea-Bissau to France route"
      body: |
        Compared to some international pet transport routes, Guinea-Bissau to France is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Guinea-Bissau to France?"
  ...
  - question: "Can I take my cat to France from Guinea-Bissau?"
    answer: "Yes, cats can be transported from Guinea-Bissau to France. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/france-to-guinea-bissau/"
      text: "Pet Transport France to Guinea-Bissau"
  upward:
