---
title: "Moving Your Pet from Canada to Moldova | Complete Guide"
description: "Complete guide to pet transport from Canada to Moldova. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
...
content:
  ...
  overview: |
    Shipping your pet from Canada to Moldova is a process that rewards early planning.
  ...
  sections:
    - heading: "Why this route needs early planning"
      body: |
        Compared to some international pet transport routes, Canada to Moldova is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Moldova?"
  ...
  - question: "Can I take my cat to Moldova from Canada?"
    answer: "Yes, cats can be transported from Canada to Moldova. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/moldova-to-canada/"
      text: "Pet Transport Moldova to Canada"
  upward:
