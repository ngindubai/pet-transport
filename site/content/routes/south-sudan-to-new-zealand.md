---
title: "Pet Transport from South Sudan to New Zealand | PetTransportGlobal"
description: "How to ship your dog or cat from South Sudan to New Zealand. New Zealand import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "south-sudan-to-new-zealand"
...
content:
  h1: "Pet Transport from South Sudan to New Zealand"
  overview: |
    Moving a pet from South Sudan to New Zealand involves more paperwork than most owners expect.
  ...
  sections:
    - heading: "What to know about the South Sudan to New Zealand route"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from South Sudan to New Zealand?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in South Sudan. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check New Zealand's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/new-zealand-to-south-sudan/"
      text: "Pet Transport New Zealand to South Sudan"
  upward:
