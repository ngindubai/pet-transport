---
title: "Pet Relocation Canada to Vanuatu | Requirements & Guide"
description: "Pet relocation from Canada to Vanuatu: Vanuatu import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Canada to Vanuatu"
  overview: |
    Moving a pet from Canada to Vanuatu involves more paperwork than most owners expect.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Vanuatu"
      body: |
        Compared to some international pet transport routes, Canada to Vanuatu is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Vanuatu?"
  ...
  - question: "Can I take my cat to Vanuatu from Canada?"
    answer: "Yes, cats can be transported from Canada to Vanuatu. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/vanuatu-to-canada/"
      text: "Pet Transport Vanuatu to Canada"
  upward:
