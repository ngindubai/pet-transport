---
title: "Shipping Dogs & Cats from Brazil to Burundi | PetTransportGlobal"
description: "How to ship your dog or cat from Brazil to Burundi. Burundi import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "brazil-to-burundi"
origin_name: "Brazil"
...
content:
  h1: "Pet Transport from Brazil to Burundi"
  overview: |
    The Brazil to Burundi route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "Why this route needs early planning"
      body: |
        Compared to some international pet transport routes, Brazil to Burundi is manageable. That said, every country's rules are different and the timing requirements are strict.
    - heading: "From experience: Brazil to Burundi pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Brazil to Burundi?"
  ...
  - question: "Can I take my cat to Burundi from Brazil?"
    answer: "Yes, cats can be transported from Brazil to Burundi. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/burundi-to-brazil/"
      text: "Pet Transport Burundi to Brazil"
  upward:
