---
title: "Pet Relocation Iran to North Macedonia | Requirements & Guide"
description: "Pet relocation from Iran to North Macedonia: North Macedonia import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "iran-to-north-macedonia"
origin_name: "Iran"
...
content:
  h1: "Pet Transport from Iran to North Macedonia"
  overview: |
    If you're relocating from Iran to North Macedonia and taking your pet, the good news is thousands of families do this every year.
  ...
  sections:
    - heading: "Key requirements for moving your pet to North Macedonia"
      body: |
        Compared to some international pet transport routes, Iran to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
    - heading: "From experience: Iran to North Macedonia pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Iran to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Iran?"
    answer: "Yes, cats can be transported from Iran to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-iran/"
      text: "Pet Transport North Macedonia to Iran"
  upward:
