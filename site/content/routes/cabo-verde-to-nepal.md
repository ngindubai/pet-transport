---
title: "Moving Your Pet from Cabo Verde to Nepal | Complete Guide"
description: "Complete guide to pet transport from Cabo Verde to Nepal. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "cabo-verde-to-nepal"
...
content:
  h1: "Pet Transport from Cabo Verde to Nepal"
  overview: |
    International pet transport from Cabo Verde to Nepal comes down to documentation timing more than anything else.
  ...
  sections:
    - heading: "What to know about the Cabo Verde to Nepal route"
      body: |
    ...
    - heading: "From experience: Cabo Verde to Nepal pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Cabo Verde to Nepal?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Cabo Verde. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Nepal's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/nepal-to-cabo-verde/"
      text: "Pet Transport Nepal to Cabo Verde"
  upward:
