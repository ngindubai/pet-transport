---
title: "Shipping Dogs & Cats from Cyprus to North Macedonia | PetTransportGlobal"
description: "Pet relocation from Cyprus to North Macedonia: North Macedonia import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "cyprus-to-north-macedonia"
origin_name: "Cyprus"
...
content:
  h1: "Pet Transport from Cyprus to North Macedonia"
  overview: |
    Moving to North Macedonia from Cyprus with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "Key requirements for moving your pet to North Macedonia"
      body: |
        Compared to some international pet transport routes, Cyprus to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Cyprus to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Cyprus?"
    answer: "Yes, cats can be transported from Cyprus to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-cyprus/"
      text: "Pet Transport North Macedonia to Cyprus"
  upward:
