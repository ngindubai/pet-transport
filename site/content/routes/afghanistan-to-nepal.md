---
title: "Pet Transport from Afghanistan to Nepal | PetTransportGlobal"
description: "Pet relocation from Afghanistan to Nepal: Nepal import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "afghanistan-to-nepal"
...
content:
  h1: "Pet Transport from Afghanistan to Nepal"
  overview: |
    Getting your dog from Afghanistan to Nepal is entirely achievable, but the preparation timeline is not flexible.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Afghanistan to Nepal?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Afghanistan. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Nepal's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/nepal-to-afghanistan/"
      text: "Pet Transport Nepal to Afghanistan"
  upward:
