...
description: "Complete guide to pet transport from Canada to Angola. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
...
content:
  ...
  overview: |
    If you're relocating from Canada to Angola and taking your pet, the good news is thousands of families do this every year.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Angola"
      body: |
        Compared to some international pet transport routes, Canada to Angola is manageable. That said, every country's rules are different and the timing requirements are strict.
    - heading: "From experience: Canada to Angola pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Angola?"
  ...
  - question: "Can I take my cat to Angola from Canada?"
    answer: "Yes, cats can be transported from Canada to Angola. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
