---
title: "Pet Transport Thailand to South Korea: 2026 QIAS Requirements"
description: "Taking your dog or cat from Thailand to South Korea? FAVN titre test, QIAS quarantine at Incheon, and DLD health certificate required. 2026 guide."
date: "2026-06-06"
type: "routes"
layout: "single"
template_variant: "D"
...
route_data:
  origin:
    ...
    country: "Thailand"
    export_requirements:
      health_certificate: "DLD (Department of Livestock Development) health certificate issued by DLD-registered vet"
      export_permit: "DLD export permit required alongside health certificate"
  destination:
    code: "KR"
    country: "South Korea"
    import_requirements:
      ...
      titre_test: "FAVN titre test required (Thailand is not rabies-free); 0.5 IU/ml minimum at approved laboratory"
      quarantine: "QIAS inspection and quarantine at Incheon: 5-10 days for pets from rabies-endemic countries including Thailand"
      import_permit: "Advance QIAS notification required before arrival"
      health_certificate: "Korean QIAS-format health certificate, DLD-endorsed"
      breed_restrictions: "South Korea restricts certain aggressive breeds; check current QIAS lists"

  airlines:
    - name: "Korean Air Cargo"
      type: "cargo_only"
      policy_summary: "BKK to ICN direct; Korean Air Cargo is the most direct and experienced option for this route"
    - name: "Thai Airways"
      type: "cargo_only"
      policy_summary: "BKK to ICN via Thai Cargo; Thai Airways is experienced with DLD documentation for Korea-bound pets"
    - name: "Asiana Cargo"
      type: "cargo_only"
      policy_summary: "BKK to ICN via Asiana connections; Incheon-based with QIAS process familiarity"
  ...
  timeline_steps:
    ...
    - step: 3
      ...
      timing: "At least 30 days after vaccination, at approved laboratory"
      responsible: "Thai vet, approved laboratory"
    - step: 4
      action: "Advance QIAS notification submitted"
      timing: "Before confirming final travel date"
      responsible: "Pet transport agent"
    - step: 5
      action: "DLD health certificate in Korean QIAS format"
  ...
  cost_factors:
    ...
    - "QIAS quarantine facility fee at Incheon: approximately KRW 150,000-400,000"
...
content:
  h1: "Pet Transport Thailand to South Korea: 2026 Guide"
  overview: "Thailand to South Korea is one of the more common short-haul international pet transport routes in Southeast Asia, with daily flights between Bangkok and Seoul. However, Thailand's rabies status means pets arriving from Thailand face a mandatory QIAS quarantine of 5 to 10 days at Incheon. An FAVN titre test and a DLD-endorsed health certificate in Korean format are required. Preparation takes 12 to 16 weeks."

  sections:
    - heading: "What does QIAS require from a pet travelling from Thailand, and what is the quarantine like?"
      body: |
    ...
    - heading: "How does FAVN titre testing work in Thailand, and what does it cost?"
      body: |
    ...
    - heading: "Airline options and cargo costs from Bangkok to Seoul"
      body: |
...
faqs:
  - question: "Is the 5-10 day quarantine at Incheon the same for cats as for dogs from Thailand?"
    answer: "Yes. Both dogs and cats from Thailand are subject to the same 5-10 day QIAS quarantine at Incheon. The process and facility are the same for both species, with dogs in the kennel areas and cats in separate cat quarters."
  - question: "Why is the FAVN titre test more expensive in Thailand than in some other countries?"
    answer: "FAVN testing requires specialist rabies virology equipment and expertise. In countries where this test is routinely performed for a large volume of international pet relocations (such as Australia), the cost per test is lower due to volume. Thailand has fewer specialist labs performing this test, which affects the price. Costs have been improving as the number of labs has increased, but USD 150-300 remains the current range."
  - question: "Can I get the titre test done in South Korea after arrival to save money?"
    answer: "No. The FAVN titre test is a pre-travel requirement, not an on-arrival test. It must be completed and a satisfactory result obtained before your pet leaves Thailand. QIAS will not accept a titre test done after arrival as meeting the pre-travel requirement."
  - question: "How far in advance do I need to notify QIAS about my pet's arrival from Thailand?"
    answer: "The advance QIAS notification should be submitted before you confirm the final travel date and book cargo space. There is no specific minimum days requirement stated for Thailand-origin pets in the same way Japan AQS has a 40-day rule, but submitting the notification as early as possible (at least 2-3 weeks before travel) gives QIAS time to process and reduces the risk of administrative delays at Incheon."
  - question: "My dog has been living in Thailand for five years and is up to date on all vaccinations. Do I still need a titre test?"
    answer: "Yes. The FAVN titre test is required regardless of how long your dog has been vaccinated or how well maintained the vaccination record is. The test is a condition of QIAS entry for pets from rabies-endemic countries including Thailand, and it cannot be substituted by vaccination history alone."
...
links:
  sideways:
    ...
    - url: "/pet-transport/italy-to-south-korea/"
      text: "Pet transport Italy to South Korea"
  upward:
    ...
    - url: "/pet-transport/countries/thailand/"
      text: "Exporting pets from Thailand: country guide"
---
