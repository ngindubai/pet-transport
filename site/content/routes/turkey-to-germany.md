---
title: "Pet Transport Turkey to Germany: Titre Test Required, Turkish Airlines, 5-Month Timeline"
description: "Moving a pet from Turkey to Germany in 2026. Turkey is non-listed for EU: FAVN titre test and 3-month wait required. Turkish Airlines IST-FRA. Real costs and timeline."
date: "2026-06-08"
type: "routes"
layout: "single"
template_variant: "D"
...
route_data:
  origin:
    ...
    country: "Turkey"
    export_requirements:
      health_certificate: "International Veterinary Certificate issued by a Turkish official vet and endorsed by the Turkish Ministry of Agriculture and Forestry (Tarım ve Orman Bakanlığı). Must be in EU-format for Germany entry. Issued within 10 days of travel."
      export_permit: "No formal export permit for companion animals. Ministry endorsement of the health certificate is the authorising document. Departure primarily from Istanbul Airport (IST)."
  ...
  destination:
    ...
    import_requirements:
      ...
      rabies_vaccination: "Valid rabies vaccination required. 21-day wait after primary vaccination. Microchip must predate the vaccination."
      titre_test: "Required. Turkey is not EU-listed. FAVN or ELISA rabies antibody titre test required. Blood must be drawn after the microchip is implanted and after the rabies vaccination is valid. A 3-month wait from the blood sampling date is required before EU entry. Source: food.ec.europa.eu, 2026."
      ...
      breed_restrictions: "Federal bans: Pit Bull Terrier, Tosa Inu. Bundesland-level restrictions vary significantly. Bavaria restricts Dogo Argentino, Fila Brasileiro, American Bulldog, Rottweiler, Cane Corso, and others. Check your specific destination Bundesland."

  airlines:
    - name: "Turkish Airlines Cargo"
      type: "cargo_only"
      policy_summary: "Turkish Airlines operates direct from Istanbul (IST) to Frankfurt (FRA). Turkish Airlines Cargo accepts live animals in the temperature-controlled hold. Frankfurt is the main German hub for Turkey pet cargo."
    - name: "Lufthansa Cargo"
      type: "cargo_only"
      policy_summary: "Lufthansa operates between IST and FRA direct. Lufthansa Cargo handles live animals and has Frankfurt as its home hub with strong live animal processing on arrival."
    - name: "Turkish Airlines to other German cities"
      type: "cargo_only"
      policy_summary: "Turkish Airlines also operates from IST to Munich (MUC), Dusseldorf (DUS), Berlin (BER), and Stuttgart (STR). Cargo acceptance for live animals varies by route; confirm when booking."

  timeline_steps:
    - step: 1
      action: "Confirm ISO microchip is implanted. This must predate the rabies vaccination."
      timing: "5+ months before travel"
      responsible: "Vet in Turkey"
    - step: 2
      action: "Administer or verify rabies vaccination. Wait 21 days for immunity if primary vaccination."
      timing: "5+ months before travel"
      responsible: "Vet in Turkey"
    - step: 3
      action: "Blood drawn for FAVN titre test at an EU-approved laboratory. This must be after microchip and after valid vaccination."
    ...
    - step: 5
      action: "Book cargo from Istanbul to Frankfurt on Turkish Airlines or Lufthansa."
    ...
    - step: 7
      action: "Depart IST. German customs (Zoll) inspects at Frankfurt or destination airport."
      timing: "Travel day"
  ...
  cost_factors:
    ...
    - "Cargo IST to FRA (Turkish Airlines or Lufthansa direct): EUR 500-1,400 depending on crate size"
...
content:
  h1: "Pet Transport Turkey to Germany: 2026 Guide"
  overview: "Turkey is not on the EU's list of approved pet-travel countries, which means pets moving from Istanbul to Germany need the FAVN rabies titre test and a 3-month wait from the blood sampling date. The total preparation is approximately five months. Turkish Airlines and Lufthansa both fly direct from Istanbul to Frankfurt. Germany's Bundesland breed restriction system adds another layer of planning for owners of certain breeds."

  sections:
    - heading: "Why Turkey requires the titre test and 3-month wait"
      body: |
    ...
    - heading: "Germany's breed restrictions: checking the Bundesland rules from Istanbul"
      body: |
    ...
    - heading: "Turkish Airlines from Istanbul to Frankfurt: the practical cargo route"
      body: |
...
faqs:
  ...
  - question: "Can Turkish Airlines fly my pet as cargo from Istanbul to Frankfurt?"
    answer: "Yes. Turkish Airlines Cargo operates direct from Istanbul Airport (IST) to Frankfurt (FRA) and accepts live animals in the temperature-controlled hold. Lufthansa Cargo is another direct option on the same route. Book four to six weeks ahead and confirm live animal cargo acceptance on your specific flight number."
  - question: "Is the Kangal dog breed restricted in Germany?"
    answer: "Kangal is not on Germany's federal restricted breed list (which covers only Pit Bull Terrier and Tosa Inu) and is not widely listed in Bundesland restrictions as of 2026. However, breed rules vary by Bundesland and can change. Check with the Veterinaramt of your specific destination district to confirm current rules before booking."
  - question: "What does the Turkey to Germany pet move cost?"
    answer: "Turkish Airlines or Lufthansa direct cargo from IST to FRA typically costs EUR 500 to EUR 1,400 depending on crate size. Add EUR 85-170 for the FAVN titre test, EUR 100-250 for the Ministry-endorsed health certificate, and EUR 80-250 for an IATA crate if needed. Total all-in is typically EUR 1,000 to EUR 2,600, with five months preparation needed."

links:
  sideways:
    - url: "/pet-transport/germany-to-turkey/"
      text: "Pet Transport Germany to Turkey"
