---
title: "Shipping Dogs & Cats from Mexico to Russia | PetTransportGlobal"
description: "Pet relocation from Mexico to Russia: Russia import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "mexico-to-russia"
origin_name: "Mexico"
...
content:
  h1: "Pet Transport from Mexico to Russia"
  overview: |
    Shipping your dog from Mexico to Russia is a process that rewards early planning.
  ...
  sections:
    - heading: "Understanding Russia's pet import rules"
      body: |
        Compared to some international pet transport routes, Mexico to Russia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Mexico to Russia?"
  ...
  - question: "Can I take my cat to Russia from Mexico?"
    answer: "Yes, cats can be transported from Mexico to Russia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/russia-to-mexico/"
      text: "Pet Transport Russia to Mexico"
  upward:
