---
title: "Moving Your Pet from Canada to Burkina Faso | Complete Guide"
description: "Pet relocation from Canada to Burkina Faso: Burkina Faso import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Canada to Burkina Faso"
  overview: |
    If you're relocating from Canada to Burkina Faso and taking your pet, the good news is thousands of families do this every year.
  ...
  sections:
    - heading: "What to know about the Canada to Burkina Faso route"
      body: |
        Compared to some international pet transport routes, Canada to Burkina Faso is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Burkina Faso?"
  ...
  - question: "Can I take my cat to Burkina Faso from Canada?"
    answer: "Yes, cats can be transported from Canada to Burkina Faso. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/burkina-faso-to-canada/"
      text: "Pet Transport Burkina Faso to Canada"
  upward:
