---
title: "Pet Relocation Colombia to Iran | Requirements & Guide"
description: "Complete guide to pet transport from Colombia to Iran. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "colombia-to-iran"
...
content:
  h1: "Pet Transport from Colombia to Iran"
  overview: |
    Getting your dog from Colombia to Iran is entirely achievable, but the preparation timeline is not flexible.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Iran"
      body: |
        Compared to some international pet transport routes, Colombia to Iran is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Colombia to Iran?"
  ...
  - question: "Can I take my cat to Iran from Colombia?"
    answer: "Yes, cats can be transported from Colombia to Iran. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/iran-to-colombia/"
      text: "Pet Transport Iran to Colombia"
  upward:
