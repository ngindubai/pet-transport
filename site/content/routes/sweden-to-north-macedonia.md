---
title: "Pet Relocation Sweden to North Macedonia | Requirements & Guide"
description: "How to ship your dog or cat from Sweden to North Macedonia. North Macedonia import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Sweden to North Macedonia"
  overview: |
    The Sweden to North Macedonia route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "Why this route needs early planning"
      body: |
        Compared to some international pet transport routes, Sweden to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Sweden to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Sweden?"
    answer: "Yes, cats can be transported from Sweden to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-sweden/"
      text: "Pet Transport North Macedonia to Sweden"
  upward:
