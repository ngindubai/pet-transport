---
title: "Shipping Dogs & Cats from Colombia to Senegal | PetTransportGlobal"
description: "Pet relocation from Colombia to Senegal: Senegal import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "colombia-to-senegal"
...
content:
  h1: "Pet Transport from Colombia to Senegal"
  overview: |
    Getting your pet from Colombia to Senegal is entirely achievable, but the preparation timeline is not flexible.
  ...
  sections:
    - heading: "What to know about the Colombia to Senegal route"
      body: |
        Compared to some international pet transport routes, Colombia to Senegal is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Colombia to Senegal?"
  ...
  - question: "Can I take my cat to Senegal from Colombia?"
    answer: "Yes, cats can be transported from Colombia to Senegal. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/senegal-to-colombia/"
      text: "Pet Transport Senegal to Colombia"
  upward:
