---
title: "Pet Transport from Switzerland to North Macedonia | PetTransportGlobal"
description: "Pet relocation from Switzerland to North Macedonia: North Macedonia import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "switzerland-to-north-macedonia"
...
content:
  h1: "Pet Transport from Switzerland to North Macedonia"
  overview: |
    Getting your dog or cat from Switzerland to North Macedonia is entirely achievable, but the preparation timeline is not flexible.
  ...
  sections:
    - heading: "What to know about the Switzerland to North Macedonia route"
      body: |
        Compared to some international pet transport routes, Switzerland to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Switzerland to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Switzerland?"
    answer: "Yes, cats can be transported from Switzerland to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-switzerland/"
      text: "Pet Transport North Macedonia to Switzerland"
  upward:
