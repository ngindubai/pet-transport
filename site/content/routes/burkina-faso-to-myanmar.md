---
title: "Shipping Dogs & Cats from Burkina Faso to Myanmar | PetTransportGlobal"
description: "How to ship your dog or cat from Burkina Faso to Myanmar. Myanmar import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "burkina-faso-to-myanmar"
...
content:
  h1: "Pet Transport from Burkina Faso to Myanmar"
  overview: |
    Pet transport from Burkina Faso to Myanmar follows a clear process once you know what Myanmar requires.
  ...
  sections:
    ...
    - heading: "From experience: Burkina Faso to Myanmar pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Burkina Faso to Myanmar?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Burkina Faso. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Myanmar's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/myanmar-to-burkina-faso/"
      text: "Pet Transport Myanmar to Burkina Faso"
  upward:
