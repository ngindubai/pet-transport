---
title: "Pet Transport Israel to United Kingdom: Titre Test Route and Heathrow Arrival"
description: "Bringing your pet from Israel to the UK in 2026? Israel is non-listed, so an FAVN titre test and 90-day wait apply. Full guide: steps, labs, El Al cargo, and costs."
date: "2026-06-06"
type: "routes"
layout: "single"
template_variant: "B"
...
route_data:
  origin:
    ...
    country: "Israel"
    export_requirements:
      health_certificate: "Official veterinary health certificate issued by the Israeli Ministry of Agriculture and Rural Development (MOARD). Must accompany the pet to the UK."
  ...
  destination:
    ...
    import_requirements:
      ...
      rabies_titre_test: "Required. FAVN test at an APHA-approved laboratory, minimum 0.5 IU/ml. 90-day wait from date of successful result before travel to UK."
      quarantine: "No quarantine if all conditions are met. Non-compliant arrivals face refusal or detention at Heathrow."
      import_permit: "No import permit required. Pre-notification to the approved port facility (Heathrow ARC) required before travel."
      health_certificate: "Official Israeli MOARD veterinary health certificate. Presented at Heathrow Animal Reception Centre on arrival."
  ...
  airlines:
    - name: "El Al"
      type: "cargo_only"
      policy_summary: "El Al operates direct flights from Tel Aviv Ben Gurion (TLV) to London Heathrow (LHR). Live animals are accepted as cargo via IAG Cargo / El Al cargo division. Book at least 4-6 weeks in advance and confirm live animal acceptance for the specific flight."
    - name: "British Airways"
      type: "cargo_only"
      policy_summary: "British Airways operates direct TLV-LHR flights. Live animals travel as cargo via IAG Cargo. No cabin pets on this route. Confirm live animal acceptance and IATA kennel requirements well in advance."

  timeline_steps:
    - step: 1
      action: "Confirm ISO microchip is implanted (before or at first vaccination)."
      timing: "As early as possible; minimum 5-6 months before desired travel"
      responsible: "Israeli veterinary clinic"
    - step: 2
      action: "Ensure rabies vaccination is current and recorded."
    ...
    - step: 5
      action: "Book cargo space on El Al or BA to Heathrow. Pre-notify Heathrow Animal Reception Centre."
      timing: "During 90-day wait"
      responsible: "Owner or relocation agent"
    - step: 6
      action: "Obtain MOARD health certificate from official vet in Israel."
...
content:
  h1: "Pet Transport Israel to United Kingdom: 2026 Guide"
  overview: "Israel is not on the UK's listed countries register, so the route requires a FAVN titre test and a 90-day wait from a passing result. The direct flight from Tel Aviv to Heathrow is short, but the preparation process takes four to six months. All arrivals go through the Heathrow Animal Reception Centre."

  sections:
    - heading: "Why the 90-Day Wait Applies to Israel"
      body: |
    ...
    - heading: "The El Al and British Airways Cargo Route"
      body: |
    ...
    - heading: "Heathrow Animal Reception Centre: What to Expect"
      body: |
...
faqs:
  - question: "Which APHA-approved labs can process the titre test for an Israel-origin pet?"
    answer: "The Kimron Veterinary Institute in Israel is itself an APHA-approved laboratory and is a practical option for owners in Israel. Blood samples drawn in Israel can also be couriered to approved European labs. Your vet in Israel can advise on the most reliable routing. Confirm the lab's APHA-approved status before the blood draw."
  - question: "Can my pet transit through Cyprus or another EU country on the way to the UK?"
    answer: "Transit does not change the UK import requirements. Your pet still enters the UK as an Israel-origin animal and must go through the non-listed country pathway at Heathrow. The 90-day wait and FAVN test requirements remain regardless of transit points."
  - question: "Does the MOARD health certificate need to be in English?"
    answer: "For UK import, the health certificate should be in English or accompanied by a certified English translation. Certificates issued by Israeli Ministry of Agriculture vets for UK-bound pets are typically available in English or bilingually. Confirm with your vet when ordering the certificate."
  - question: "My pet had a titre test done in Israel a year ago. Does that count?"
    answer: "It may. The result must be from an APHA-approved laboratory, the level must be 0.5 IU/ml or above, and the rabies vaccination must have been continuously valid since the test date. If all those conditions are met, the 90-day wait runs from that original result date, which may already have passed. Have your vet verify the original documentation before relying on it."
  - question: "Is there a weight or size limit for pets travelling as cargo on El Al?"
    answer: "El Al cargo does not publish a fixed weight ceiling for live animal shipments, but very large kennels (those typically used for large dog breeds such as Great Danes or St Bernards) may require specific aircraft configurations. Contact El Al cargo directly with the kennel dimensions and combined weight when making the booking."
