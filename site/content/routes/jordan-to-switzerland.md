---
template_variant: "E"
title: "Shipping Dogs & Cats from Jordan to Switzerland | PetTransportGlobal"
description: "Pet relocation from Jordan to Switzerland: Switzerland import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Marcus Webb, Senior Pet Relocation Consultant, PetTransportGlobal"
slug: "jordan-to-switzerland"
origin_name: "Jordan"
...
content:
  h1: "Pet Transport from Jordan to Switzerland"
  overview: |
    Moving to Switzerland from Jordan with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "What to know about the Jordan to Switzerland route"
      body: |
        Compared to some international pet transport routes, Jordan to Switzerland is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Jordan to Switzerland?"
  ...
  - question: "Is a rabies titre test required for pets entering Switzerland?"
    answer: "No, Switzerland does not require a rabies titre test for most pets arriving from Jordan. Your pet still needs a valid rabies vaccination and microchip. Check the current requirements with the destination authority before travel."
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Jordan. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Switzerland's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/switzerland-to-jordan/"
      text: "Pet Transport Switzerland to Jordan"
  upward:
