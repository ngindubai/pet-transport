---
title: "Shipping Dogs & Cats from Moldova to Myanmar | PetTransportGlobal"
description: "How to ship your dog or cat from Moldova to Myanmar. Myanmar import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "moldova-to-myanmar"
origin_name: "Moldova"
...
content:
  h1: "Pet Transport from Moldova to Myanmar"
  overview: |
    Getting your dog or cat from Moldova to Myanmar is entirely achievable, but the preparation timeline is not flexible.
  ...
  sections:
    - heading: "What to know about the Moldova to Myanmar route"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Moldova to Myanmar?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Moldova. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Myanmar's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/myanmar-to-moldova/"
      text: "Pet Transport Myanmar to Moldova"
  upward:
