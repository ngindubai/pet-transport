---
title: "Pet Relocation Haiti to North Macedonia | Requirements & Guide"
description: "How to ship your dog or cat from Haiti to North Macedonia. North Macedonia import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "haiti-to-north-macedonia"
origin_name: "Haiti"
...
content:
  h1: "Pet Transport from Haiti to North Macedonia"
  overview: |
    Moving a pet from Haiti to North Macedonia involves more paperwork than most owners expect.
  ...
  sections:
    - heading: "Key requirements for moving your pet to North Macedonia"
      body: |
        Compared to some international pet transport routes, Haiti to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Haiti to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Haiti?"
    answer: "Yes, cats can be transported from Haiti to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-haiti/"
      text: "Pet Transport North Macedonia to Haiti"
  upward:
