---
title: "Pet Relocation Antigua and Barbuda to Canada | Requirements & Guide"
description: "How to ship your dog or cat from Antigua and Barbuda to Canada. Canada import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "antigua-and-barbuda-to-canada"
...
content:
  h1: "Pet Transport from Antigua and Barbuda to Canada"
  overview: |
    If you're relocating from Antigua and Barbuda to Canada and taking your pet, the good news is thousands of families do this every year.
  ...
  sections:
    - heading: "What to know about the Antigua and Barbuda to Canada route"
      body: |
        Compared to some international pet transport routes, Antigua and Barbuda to Canada is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Antigua and Barbuda to Canada?"
  ...
  - question: "Is a rabies titre test required for pets entering Canada?"
    answer: "No, Canada does not require a rabies titre test for most pets arriving from Antigua and Barbuda. Your pet still needs a valid rabies vaccination and microchip. Check the current requirements with the destination authority before travel."
  - question: "Can I take my cat to Canada from Antigua and Barbuda?"
    answer: "Yes, cats can be transported from Antigua and Barbuda to Canada. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/canada-to-antigua-and-barbuda/"
      text: "Pet Transport Canada to Antigua and Barbuda"
  upward:
