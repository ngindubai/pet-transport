---
title: "Pet Relocation Colombia to Guyana | Requirements & Guide"
description: "Complete guide to pet transport from Colombia to Guyana. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "colombia-to-guyana"
...
content:
  h1: "Pet Transport from Colombia to Guyana"
  overview: |
    The Colombia to Guyana route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "What to know about the Colombia to Guyana route"
      body: |
        Compared to some international pet transport routes, Colombia to Guyana is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Colombia to Guyana?"
  ...
  - question: "Can I take my cat to Guyana from Colombia?"
    answer: "Yes, cats can be transported from Colombia to Guyana. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/guyana-to-colombia/"
      text: "Pet Transport Guyana to Colombia"
  upward:
