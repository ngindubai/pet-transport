---
title: "Shipping Dogs & Cats from Latvia to Myanmar | PetTransportGlobal"
description: "Complete guide to pet transport from Latvia to Myanmar. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "latvia-to-myanmar"
origin_name: "Latvia"
...
content:
  h1: "Pet Transport from Latvia to Myanmar"
  overview: |
    Getting your dog from Latvia to Myanmar is entirely achievable, but the preparation timeline is not flexible.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Latvia to Myanmar?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Latvia. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Myanmar's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/myanmar-to-latvia/"
      text: "Pet Transport Myanmar to Latvia"
  upward:
