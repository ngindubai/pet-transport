---
title: "Pet Relocation North Macedonia to Portugal | Requirements & Guide"
description: "How to ship your dog or cat from North Macedonia to Portugal. Portugal import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "north-macedonia-to-portugal"
...
content:
  h1: "Pet Transport from North Macedonia to Portugal"
  overview: |
    International pet transport from North Macedonia to Portugal comes down to documentation timing more than anything else.
  ...
  sections:
    - heading: "What to know about the North Macedonia to Portugal route"
      body: |
        Compared to some international pet transport routes, North Macedonia to Portugal is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from North Macedonia to Portugal?"
  ...
  - question: "Is a rabies titre test required for pets entering Portugal?"
    answer: "No, Portugal does not require a rabies titre test for most pets arriving from North Macedonia. Your pet still needs a valid rabies vaccination and microchip. Check the current requirements with the destination authority before travel."
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in North Macedonia. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Portugal's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/portugal-to-north-macedonia/"
      text: "Pet Transport Portugal to North Macedonia"
  upward:
