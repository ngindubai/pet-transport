---
template_variant: "C"
title: "Shipping Dogs & Cats from Peru to Ireland | PetTransportGlobal"
description: "How to ship your dog or cat from Peru to Ireland. Ireland import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Peru to Ireland"
  overview: |
    The Peru to Ireland route is one many expats and returning families use each year with their pets.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Ireland"
      body: |
        Compared to some international pet transport routes, Peru to Ireland is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Peru to Ireland?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Peru. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Ireland's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/ireland-to-peru/"
      text: "Pet Transport Ireland to Peru"
  upward:
