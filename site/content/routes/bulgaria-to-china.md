---
template_variant: "A"
title: "Shipping Dogs & Cats from Bulgaria to China | PetTransportGlobal"
description: "Complete guide to pet transport from Bulgaria to China. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Pet Transport Global Editorial Team"
slug: "bulgaria-to-china"
...
content:
  h1: "Pet Transport from Bulgaria to China"
  overview: |
    International pet transport from Bulgaria to China comes down to documentation timing more than anything else.
  ...
  sections:
    - heading: "What to know about the Bulgaria to China route"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Bulgaria to China?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Bulgaria. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check China's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/china-to-bulgaria/"
      text: "Pet Transport China to Bulgaria"
  upward:
