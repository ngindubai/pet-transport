---
title: "Moving Your Pet from France to North Macedonia | Complete Guide"
description: "Pet relocation from France to North Macedonia: North Macedonia import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from France to North Macedonia"
  overview: |
    Moving to North Macedonia from France with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "What to know about the France to North Macedonia route"
      body: |
        Compared to some international pet transport routes, France to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from France to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from France?"
    answer: "Yes, cats can be transported from France to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-france/"
      text: "Pet Transport North Macedonia to France"
  upward:
