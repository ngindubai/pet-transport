---
template_variant: "B"
title: "Pet Relocation Ireland to Spain | Requirements & Guide"
description: "How to ship your dog or cat from Ireland to Spain. Spain import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Pet Transport Global Editorial Team"
slug: "ireland-to-spain"
origin_name: "Ireland"
...
content:
  h1: "Pet Transport from Ireland to Spain"
  overview: |
    The Ireland to Spain route is one many expats and returning families use each year with their pets.
  ...
  sections:
    - heading: "What to know about the Ireland to Spain route"
      body: |
        Compared to some international pet transport routes, Ireland to Spain is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Ireland to Spain?"
  ...
  - question: "Can I take my cat to Spain from Ireland?"
    answer: "Yes, cats can be transported from Ireland to Spain. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/spain-to-ireland/"
      text: "Pet Transport Spain to Ireland"
  upward:
