---
title: "Pet Transport Spain to New Zealand | FAVN Titre Test, 180-Day Wait, MPI Guide 2026"
description: "Moving your dog or cat from Spain to New Zealand in 2026. FAVN titre test mandatory, 180-day wait from blood draw, 10-day quarantine on arrival. Full MPI and MAPA health certificate process."
date: "2026-06-10"
type: "routes"
layout: "single"
template_variant: "D"
author: "Pet Transport Global Editorial Team"
slug: "spain-to-new-zealand"
origin_name: "Spain"
...
route_data:
  origin:
    ...
    country: "Spain"
    export_requirements:
      health_certificate: "Official export health certificate issued by a veterinario oficial in Spain, endorsed by MAPA (Ministerio de Agricultura, Pesca y Alimentación) or the competent regional veterinary authority, in the MPI-approved format for Spanish-origin pets. Certificate issued within 10 days of travel. Confirm the current MPI-required Spanish template with your official vet. Source: MAPA, mapa.gob.es; MPI, mpi.govt.nz."
  ...
  destination:
    ...
    import_requirements:
      ...
      health_certificate: "Official health certificate from Spanish competent authority in MPI-approved format. Issued within 10 days of travel. New IHS requirements apply from 1 July 2026 (transition period until 1 April 2027). Confirm the current template with your official vet."

  airlines:
    - name: "Iberia"
      type: "cargo_only"
      policy_summary: "Madrid Barajas (MAD) to Auckland (AKL) via connections, typically Los Angeles or other Pacific hubs. Pets travel as manifest cargo. Iberia is the primary Spanish carrier for this route."
    - name: "Singapore Airlines"
      type: "cargo_only"
      policy_summary: "Via Singapore Changi to Auckland. Most commonly used Europe-to-New Zealand routing. Connections from Madrid MAD or Barcelona BCN."
    - name: "Air New Zealand"
      type: "cargo_only"
      policy_summary: "Air New Zealand Cargo from Spain to Auckland via connections. Strong MPI quarantine familiarity at Auckland. Book well in advance."
    - name: "Emirates"
      type: "cargo_only"
      policy_summary: "Via Dubai to Auckland from Madrid or Barcelona. Summer Gulf heat embargoes apply."
  ...
  timeline_steps:
    ...
    - step: 8
      ...
      responsible: "Owner or agent"
    - step: 9
      action: "Obtain official health certificate from Spanish competent authority vet"
  ...
  cost_factors:
    ...
    - "Airline cargo from Spain to Auckland: approximately EUR 1,000-2,500 depending on crate size and routing"
...
content:
  h1: "Pet Transport from Spain to New Zealand"
  overview: |
    Moving a dog or cat from Spain to New Zealand is a demanding process that cannot be rushed. New Zealand requires a mandatory FAVN titre test from pets arriving from all countries, including Spain, with a 180-day wait from the blood draw date before travel is permitted. Two separate inactivated-virus rabies vaccinations, given at least 28 days apart, are required before the titre test can take place. The minimum preparation time from starting the process to departure is around nine to ten months.

    New Zealand's Ministry for Primary Industries (MPI) runs the NZSTAP permit system for all pet imports. You need an approved permit before you travel. Ten days of mandatory quarantine at an MPI-approved facility follows on arrival. The sequence is fixed: every step must happen in order, and nothing can be skipped.

    Despite the complexity, this is a well-documented route that experienced pet transport agents handle regularly. Most Spanish pet owners moving to New Zealand begin the process at least ten to twelve months before their departure date.

  sections:
    - heading: "Why does New Zealand require a titre test from Spain, and why is there a 180-day wait?"
      body: |
    ...
    - heading: "Why are two vaccinations required, and which vaccine type does Spain need to use?"
      body: |
    ...
    - heading: "What is the NZSTAP permit and when should I apply from Spain?"
      body: |
...
faqs:
  - question: "How long does the Spain-to-New Zealand pet transport process take in total?"
  ...
  - question: "Does my pet need one or two rabies vaccinations for New Zealand from Spain?"
  ...
  - question: "How long is quarantine for pets from Spain?"
  ...
  - question: "What does it cost to move a pet from Spain to New Zealand?"
    answer: "Costs vary but expect EUR 3,000-6,000+ for the full process: airline cargo from Madrid or Barcelona (EUR 1,000-2,500), MPI quarantine fees (NZD 1,500-2,500+), FAVN titre test (EUR 100-250), official vet and health certificate fees, IATA crate, and pet transport agent."
