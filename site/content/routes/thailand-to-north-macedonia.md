---
title: "Pet Relocation Thailand to North Macedonia | Requirements & Guide"
description: "Pet relocation from Thailand to North Macedonia: North Macedonia import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "thailand-to-north-macedonia"
...
content:
  h1: "Pet Transport from Thailand to North Macedonia"
  overview: |
    If you're relocating from Thailand to North Macedonia and taking your pet, the good news is thousands of families do this every year.
  ...
  sections:
    - heading: "Understanding North Macedonia's pet import rules"
      body: |
        Compared to some international pet transport routes, Thailand to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Thailand to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Thailand?"
    answer: "Yes, cats can be transported from Thailand to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-thailand/"
      text: "Pet Transport North Macedonia to Thailand"
  upward:
