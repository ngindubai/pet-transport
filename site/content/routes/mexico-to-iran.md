---
title: "Pet Relocation Mexico to Iran | Requirements & Guide"
description: "How to ship your dog or cat from Mexico to Iran. Iran import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Mexico to Iran"
  overview: |
    Moving a pet from Mexico to Iran involves more paperwork than most owners expect.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Iran"
      body: |
        Compared to some international pet transport routes, Mexico to Iran is manageable. That said, every country's rules are different and the timing requirements are strict.
    - heading: "From experience: Mexico to Iran pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Mexico to Iran?"
  ...
  - question: "Can I take my cat to Iran from Mexico?"
    answer: "Yes, cats can be transported from Mexico to Iran. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/iran-to-mexico/"
      text: "Pet Transport Iran to Mexico"
  upward:
