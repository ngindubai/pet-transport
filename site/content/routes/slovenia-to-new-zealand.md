---
title: "Pet Relocation Slovenia to New Zealand | Requirements & Guide"
description: "How to ship your dog or cat from Slovenia to New Zealand. New Zealand import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "slovenia-to-new-zealand"
...
content:
  h1: "Pet Transport from Slovenia to New Zealand"
  overview: |
    The Slovenia to New Zealand route is one many expats and returning families navigate each year with their pets.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Slovenia to New Zealand?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Slovenia. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check New Zealand's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/new-zealand-to-slovenia/"
      text: "Pet Transport New Zealand to Slovenia"
  upward:
