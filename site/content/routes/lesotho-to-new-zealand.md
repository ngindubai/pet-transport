---
title: "Moving Your Pet from Lesotho to New Zealand | Complete Guide"
description: "Complete guide to pet transport from Lesotho to New Zealand. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "lesotho-to-new-zealand"
origin_name: "Lesotho"
...
content:
  h1: "Pet Transport from Lesotho to New Zealand"
  overview: |
    International pet transport from Lesotho to New Zealand comes down to documentation timing more than anything else.
  ...
  sections:
    - heading: "What to know about the Lesotho to New Zealand route"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Lesotho to New Zealand?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Lesotho. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check New Zealand's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/new-zealand-to-lesotho/"
      text: "Pet Transport New Zealand to Lesotho"
  upward:
