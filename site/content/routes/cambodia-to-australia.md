---
template_variant: "D"
title: "Shipping Dogs & Cats from Cambodia to Australia | PetTransportGlobal"
description: "Complete guide to pet transport from Cambodia to Australia. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Cambodia to Australia"
  overview: |
    Getting your dog or cat from Cambodia to Australia is entirely achievable, but the preparation timeline is not flexible.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Cambodia to Australia?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Cambodia. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Australia's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/australia-to-cambodia/"
      text: "Pet Transport Australia to Cambodia"
  upward:
