---
template_variant: "B"
title: "Shipping Dogs & Cats from Sri Lanka to Philippines | PetTransportGlobal"
description: "Complete guide to pet transport from Sri Lanka to Philippines. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Pet Transport Global Editorial Team"
slug: "sri-lanka-to-philippines"
...
content:
  h1: "Pet Transport from Sri Lanka to Philippines"
  overview: |
    The Sri Lanka to Philippines route is one many expats and returning families use each year with their pets.
  ...
  sections:
    ...
    - heading: "From experience: Sri Lanka to Philippines pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Sri Lanka to Philippines?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Sri Lanka. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check Philippines's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/philippines-to-sri-lanka/"
      text: "Pet Transport Philippines to Sri Lanka"
  upward:
