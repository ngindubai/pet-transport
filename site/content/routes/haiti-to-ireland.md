---
title: "Moving Your Pet from Haiti to Ireland | Complete Guide"
description: "Pet relocation from Haiti to Ireland: Ireland import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Haiti to Ireland"
  overview: |
    Moving a pet from Haiti to Ireland involves more paperwork than most owners expect.
  ...
  sections:
    - heading: "What to know about the Haiti to Ireland route"
      body: |
        Compared to some international pet transport routes, Haiti to Ireland is manageable. That said, every country's rules are different and the timing requirements are strict.
    ...
    - heading: "From experience: Haiti to Ireland pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Haiti to Ireland?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Haiti. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Ireland's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/ireland-to-haiti/"
      text: "Pet Transport Ireland to Haiti"
  upward:
