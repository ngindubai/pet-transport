---
template_variant: "C"
title: "Shipping Dogs & Cats from Canada to Turkey | PetTransportGlobal"
description: "How to ship your dog or cat from Canada to Turkey. Turkey import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Canada to Turkey"
  overview: |
    International pet transport from Canada to Turkey comes down to documentation timing more than anything else.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Turkey?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Canada. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Turkey's authority for the exact format required."
...
links:
  sideways:
    - url: "/pet-transport/turkey-to-canada/"
      text: "Pet Transport Turkey to Canada"
  upward:
