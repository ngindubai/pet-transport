---
title: "Shipping Dogs & Cats from Kosovo to North Macedonia | PetTransportGlobal"
description: "How to ship your dog or cat from Kosovo to North Macedonia. North Macedonia import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "kosovo-to-north-macedonia"
origin_name: "Kosovo"
...
content:
  h1: "Pet Transport from Kosovo to North Macedonia"
  overview: |
    International pet transport from Kosovo to North Macedonia comes down to documentation timing more than anything else.
  ...
  sections:
    - heading: "What to know about the Kosovo to North Macedonia route"
      body: |
        Compared to some international pet transport routes, Kosovo to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Kosovo to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Kosovo?"
    answer: "Yes, cats can be transported from Kosovo to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-kosovo/"
      text: "Pet Transport North Macedonia to Kosovo"
  upward:
