---
title: "Shipping Dogs & Cats from Timor-Leste to Thailand | PetTransportGlobal"
description: "Complete guide to pet transport from Timor-Leste to Thailand. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "timor-leste-to-thailand"
...
content:
  h1: "Pet Transport from Timor-Leste to Thailand"
  overview: |
    The Timor-Leste to Thailand route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    ...
    - heading: "From experience: Timor-Leste to Thailand pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Timor-Leste to Thailand?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Timor-Leste. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check Thailand's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/thailand-to-timor-leste/"
      text: "Pet Transport Thailand to Timor-Leste"
  upward:
