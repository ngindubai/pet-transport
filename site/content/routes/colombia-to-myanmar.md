---
template_variant: "C"
title: "Moving Your Pet from Colombia to Myanmar | Complete Guide"
description: "Complete guide to pet transport from Colombia to Myanmar. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Pet Transport Global Editorial Team"
slug: "colombia-to-myanmar"
...
content:
  h1: "Pet Transport from Colombia to Myanmar"
  overview: |
    Pet transport from Colombia to Myanmar follows a clear process once you know what Myanmar requires.
  ...
  sections:
    ...
    - heading: "From experience: Colombia to Myanmar pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Colombia to Myanmar?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Colombia. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Myanmar's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/myanmar-to-colombia/"
      text: "Pet Transport Myanmar to Colombia"
  upward:
