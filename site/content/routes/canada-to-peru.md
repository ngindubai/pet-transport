---
template_variant: "E"
title: "Moving Your Pet from Canada to Peru | Complete Guide"
description: "Complete guide to pet transport from Canada to Peru. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Canada to Peru"
  overview: |
    Getting your pet from Canada to Peru is entirely achievable, but the preparation timeline is not flexible.
  ...
  sections:
    - heading: "What to know about the Canada to Peru route"
      body: |
        Compared to some international pet transport routes, Canada to Peru is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Peru?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Canada. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Peru's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/peru-to-canada/"
      text: "Pet Transport Peru to Canada"
  upward:
