---
title: "Shipping Dogs & Cats from Haiti to Norway | PetTransportGlobal"
description: "Pet relocation from Haiti to Norway: Norway import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "haiti-to-norway"
origin_name: "Haiti"
...
content:
  h1: "Pet Transport from Haiti to Norway"
  overview: |
    The Haiti to Norway route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "What to know about the Haiti to Norway route"
      body: |
        Compared to some international pet transport routes, Haiti to Norway is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Haiti to Norway?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Haiti. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Norway's authority for the exact format required."
...
links:
  sideways:
    - url: "/pet-transport/norway-to-haiti/"
      text: "Pet Transport Norway to Haiti"
  upward:
