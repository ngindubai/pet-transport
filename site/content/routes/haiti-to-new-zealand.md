---
title: "Pet Transport from Haiti to New Zealand | PetTransportGlobal"
description: "How to ship your dog or cat from Haiti to New Zealand. New Zealand import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "haiti-to-new-zealand"
origin_name: "Haiti"
...
content:
  h1: "Pet Transport from Haiti to New Zealand"
  overview: |
    International pet transport from Haiti to New Zealand comes down to documentation timing more than anything else.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Haiti to New Zealand?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Haiti. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check New Zealand's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/new-zealand-to-haiti/"
      text: "Pet Transport New Zealand to Haiti"
  upward:
