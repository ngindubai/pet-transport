---
title: "Pet Transport from Haiti to Pakistan | PetTransportGlobal"
description: "How to ship your dog or cat from Haiti to Pakistan. Pakistan import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "haiti-to-pakistan"
origin_name: "Haiti"
...
content:
  h1: "Pet Transport from Haiti to Pakistan"
  overview: |
    Getting your dog or cat from Haiti to Pakistan is entirely achievable, but the preparation timeline is not flexible.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Haiti to Pakistan?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Haiti. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Pakistan's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/pakistan-to-haiti/"
      text: "Pet Transport Pakistan to Haiti"
  upward:
