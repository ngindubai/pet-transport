---
title: "Moving Your Pet from Italy to North Macedonia | Complete Guide"
description: "Pet relocation from Italy to North Macedonia: North Macedonia import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Italy to North Macedonia"
  overview: |
    Moving to North Macedonia from Italy with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "Understanding North Macedonia's pet import rules"
      body: |
        Compared to some international pet transport routes, Italy to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
    - heading: "From experience: Italy to North Macedonia pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Italy to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Italy?"
    answer: "Yes, cats can be transported from Italy to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-italy/"
      text: "Pet Transport North Macedonia to Italy"
  upward:
