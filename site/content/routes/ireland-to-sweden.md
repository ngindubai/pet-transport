---
template_variant: "D"
title: "Shipping Dogs & Cats from Ireland to Sweden | PetTransportGlobal"
description: "How to ship your dog or cat from Ireland to Sweden. Sweden import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "ireland-to-sweden"
origin_name: "Ireland"
...
content:
  h1: "Pet Transport from Ireland to Sweden"
  overview: |
    Moving a pet from Ireland to Sweden involves more paperwork than most owners expect.
  ...
  sections:
    - heading: "What to know about the Ireland to Sweden route"
      body: |
        Compared to some international pet transport routes, Ireland to Sweden is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Ireland to Sweden?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Ireland. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Sweden's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/sweden-to-ireland/"
      text: "Pet Transport Sweden to Ireland"
  upward:
