---
title: "Pet Relocation Haiti to France | Requirements & Guide"
description: "Pet relocation from Haiti to France: France import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Haiti to France"
  overview: |
    The Haiti to France route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "What to know about the Haiti to France route"
      body: |
        Compared to some international pet transport routes, Haiti to France is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Haiti to France?"
  ...
  - question: "Can I take my cat to France from Haiti?"
    answer: "Yes, cats can be transported from Haiti to France. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/france-to-haiti/"
      text: "Pet Transport France to Haiti"
  upward:
