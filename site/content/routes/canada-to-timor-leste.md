---
title: "Moving Your Pet from Canada to Timor-Leste | Complete Guide"
description: "Pet relocation from Canada to Timor-Leste: Timor-Leste import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Canada to Timor-Leste"
  overview: |
    If you're relocating from Canada to Timor-Leste and taking your pet, the good news is thousands of families do this every year.
  ...
  sections:
    - heading: "Understanding Timor-Leste's pet import rules"
      body: |
        Compared to some international pet transport routes, Canada to Timor-Leste is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Timor-Leste?"
  ...
  - question: "Can I take my cat to Timor-Leste from Canada?"
    answer: "Yes, cats can be transported from Canada to Timor-Leste. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/timor-leste-to-canada/"
      text: "Pet Transport Timor-Leste to Canada"
  upward:
