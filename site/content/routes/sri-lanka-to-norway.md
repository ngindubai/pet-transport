---
template_variant: "C"
title: "Moving Your Pet from Sri Lanka to Norway | Complete Guide"
description: "How to ship your dog or cat from Sri Lanka to Norway. Norway import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "sri-lanka-to-norway"
...
content:
  h1: "Pet Transport from Sri Lanka to Norway"
  overview: |
    Shipping your dog from Sri Lanka to Norway is a process that rewards early planning.
  ...
  sections:
    - heading: "What to know about the Sri Lanka to Norway route"
      body: |
        Compared to some international pet transport routes, Sri Lanka to Norway is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Sri Lanka to Norway?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Sri Lanka. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Norway's authority for the exact format required."
...
links:
  sideways:
    - url: "/pet-transport/norway-to-sri-lanka/"
      text: "Pet Transport Norway to Sri Lanka"
  upward:
