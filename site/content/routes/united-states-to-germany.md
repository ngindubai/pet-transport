---
title: "Pet Transport USA to Germany: USDA Endorsement, EU AHC, PCS Moves and Lufthansa Cabin"
description: "Moving a dog or cat from the USA to Germany in 2026. USDA APHIS endorsement plus EU health certificate, military PCS moves, Lufthansa cabin travel and Kampfhunde laws."
date: "2026-06-04"
type: "routes"
layout: "single"
template_variant: "E"
...
route_data:
  origin:
    ...
    export_requirements:
      export_permit: "No formal US export permit. USDA-endorsed EU health certificate serves as export and entry documentation."
      health_certificate: "USDA APHIS-endorsed EU health certificate from a USDA-accredited veterinarian. Examination within 10 days of travel. Endorsement takes 2-10 business days; VEHCS is fastest."
  ...
  destination:
    ...
    import_requirements:
      ...
      import_permit: "No import permit required for companion animals entering Germany."
      health_certificate: "USDA-endorsed EU health certificate, valid for EU entry and 4 months of onward EU travel. Must be issued within 10 days of travel."

  airlines:
    - name: "Lufthansa"
      type: "mixed"
      policy_summary: "Allows small dogs and cats in the cabin (up to 8kg including carrier) and larger pets in cargo. Frankfurt and Munich hubs. Pet-friendly carrier."
    - name: "United Airlines"
      type: "cabin"
      policy_summary: "Cabin only for small pets. No cargo pet service. Suitable for small pets only on this route."
    - name: "Delta Air Lines"
      type: "cargo_only"
      policy_summary: "US hubs to German cities. Cargo pet service on applicable routes."
    - name: "American Airlines"
      type: "cargo_only"
      policy_summary: "US hubs to Germany via European connections. Cargo service. Seasonal embargoes apply."
  ...
  timeline_steps:
    - step: 1
      ...
      responsible: "Vet"
    - step: 2
      action: "Choose route: Lufthansa (cabin for small pets), Delta/AA cargo, or United cabin"
    ...
    - step: 4
      action: "USDA-accredited vet completes EU health certificate"
      timing: "Within 10 days of travel"
      responsible: "USDA-accredited vet"
    - step: 5
      action: "USDA APHIS endorsement of EU health certificate"
    ...
    - step: 6
      ...
      timing: "On travel date. Present documents at EU point of entry."
...
content:
  h1: "Pet Transport USA to Germany: The 2026 Process"
  overview: "Moving a pet from the USA to Germany requires a USDA-endorsed EU health certificate. Germany has no import permit or quarantine for documented pets. This route is common for US military families on PCS orders, given the large US presence in Germany. Lufthansa's cabin allowance for small pets is a notable advantage, and Germany's state-by-state dangerous dog laws are worth checking. Allow 6-10 weeks."

  sections:
    - heading: "The USDA endorsement plus EU certificate"
      body: |
    ...
    - heading: "Military PCS moves to Germany"
      body: |
    ...
    - heading: "Lufthansa cabin and German breed laws"
      body: |
