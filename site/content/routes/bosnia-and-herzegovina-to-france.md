---
title: "Moving Your Pet from Bosnia and Herzegovina to France | Complete Guide"
description: "Complete guide to pet transport from Bosnia and Herzegovina to France. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "bosnia-and-herzegovina-to-france"
...
content:
  h1: "Pet Transport from Bosnia and Herzegovina to France"
  overview: |
    The Bosnia and Herzegovina to France route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "Key requirements for moving your pet to France"
      body: |
        Compared to some international pet transport routes, Bosnia and Herzegovina to France is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Bosnia and Herzegovina to France?"
  ...
  - question: "Can I take my cat to France from Bosnia and Herzegovina?"
    answer: "Yes, cats can be transported from Bosnia and Herzegovina to France. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/france-to-bosnia-and-herzegovina/"
      text: "Pet Transport France to Bosnia and Herzegovina"
  upward:
