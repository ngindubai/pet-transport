---
title: "Shipping Dogs & Cats from Canada to Iran | PetTransportGlobal"
description: "Pet relocation from Canada to Iran: Iran import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Canada to Iran"
  overview: |
    Getting your dog or cat from Canada to Iran is entirely achievable, but the preparation timeline is not flexible.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Iran"
      body: |
        Compared to some international pet transport routes, Canada to Iran is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Iran?"
  ...
  - question: "Can I take my cat to Iran from Canada?"
    answer: "Yes, cats can be transported from Canada to Iran. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/iran-to-canada/"
      text: "Pet Transport Iran to Canada"
  upward:
