---
title: "Pet Transport UK to Germany: AHC, Lufthansa Cabin Travel and the Kampfhunde Breed Laws"
description: "Moving a dog or cat from the UK to Germany in 2026. Post-Brexit AHC required, Lufthansa allows cabin travel, German dangerous dog (Kampfhunde) laws and route options."
date: "2026-06-04"
type: "routes"
layout: "single"
template_variant: "E"
...
route_data:
  origin:
    ...
    export_requirements:
      ...
      health_certificate: "Animal Health Certificate (AHC) issued by an APHA-authorised Official Veterinarian within 10 days of travel. GB pet passports are not valid for EU entry post-Brexit."
  ...
  destination:
    ...
    import_requirements:
      ...
      rabies_vaccination: "Required. At least 21 days must have passed since the primary vaccination course before EU entry."
      quarantine: "Not required for pets with correct documentation."
      import_permit: "No import permit required for companion dogs, cats and ferrets entering Germany."
      health_certificate: "AHC issued within 10 days of travel, valid for EU entry and then 4 months of onward EU travel."

  airlines:
    - name: "Lufthansa"
      type: "mixed"
      policy_summary: "Allows small dogs and cats in the cabin (up to 8kg including carrier) and larger pets in cargo. One of the most pet-friendly carriers. Frankfurt and Munich hubs."
    - name: "British Airways"
      type: "cargo_only"
      policy_summary: "Heathrow to German cities. Pets via IAG Cargo. No cabin pets on BA."
    - name: "Eurowings"
      type: "cargo_only"
      policy_summary: "UK to German cities. Check current cabin and cargo pet policy at booking."
    - name: "Eurotunnel Le Shuttle"
      type: "cargo_only"
      policy_summary: "Drive option via France. Pet stays in the car through the tunnel, then drive on to Germany. Popular for those relocating with a vehicle."
  ...
  timeline_steps:
    - step: 1
      ...
      responsible: "Vet"
    - step: 2
      action: "Choose route: Lufthansa (cabin possible for small pets), BA cargo, or drive via Eurotunnel"
      timing: "Before booking. Lufthansa cabin is a real advantage for small pets."
      responsible: "Owner"
    - step: 3
      action: "Book flight or Eurotunnel crossing"
      timing: "4-6 weeks ahead for flights; book Eurotunnel for your travel date."
      responsible: "Owner or agent"
    - step: 4
      action: "Official Veterinarian issues Animal Health Certificate"
      timing: "Within 10 days of travel"
      responsible: "APHA-authorised OV"
    - step: 5
      action: "Travel to Germany"
      timing: "On travel date. Present AHC at EU border point of entry if required."
...
content:
  h1: "Pet Transport UK to Germany: Post-Brexit Rules and the Lufthansa Cabin Option"
  overview: "Moving a pet from the UK to Germany requires an Animal Health Certificate, since GB pet passports are no longer valid for EU entry post-Brexit. Germany itself has no import permit or quarantine for documented pets. Two things make this route notable: Lufthansa allows small pets in the cabin (rare among carriers), and Germany has dangerous dog laws that vary by state. Allow 4-8 weeks."

  sections:
    - heading: "The post-Brexit AHC requirement"
      body: |
    ...
    - heading: "Lufthansa cabin travel: a real advantage"
      body: |
    ...
    - heading: "Germany's Kampfhunde breed laws"
      body: |
