---
template_variant: "D"
title: "Shipping Dogs & Cats from Ireland to Nepal | PetTransportGlobal"
description: "How to ship your dog or cat from Ireland to Nepal. Nepal import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Pet Transport Global Editorial Team"
slug: "ireland-to-nepal"
origin_name: "Ireland"
...
content:
  h1: "Pet Transport from Ireland to Nepal"
  overview: |
    International pet transport from Ireland to Nepal comes down to documentation timing more than anything else.
  ...
  sections:
    - heading: "What to know about the Ireland to Nepal route"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Ireland to Nepal?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Ireland. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Nepal's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/nepal-to-ireland/"
      text: "Pet Transport Nepal to Ireland"
  upward:
