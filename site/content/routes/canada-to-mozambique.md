---
title: "Pet Relocation Canada to Mozambique | Requirements & Guide"
description: "Complete guide to pet transport from Canada to Mozambique. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
...
content:
  ...
  overview: |
    Getting your dog from Canada to Mozambique is entirely achievable, but the preparation timeline is not flexible.
  ...
  sections:
    - heading: "Why this route needs early planning"
      body: |
        Compared to some international pet transport routes, Canada to Mozambique is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Mozambique?"
  ...
  - question: "Can I take my cat to Mozambique from Canada?"
    answer: "Yes, cats can be transported from Canada to Mozambique. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/mozambique-to-canada/"
      text: "Pet Transport Mozambique to Canada"
  upward:
