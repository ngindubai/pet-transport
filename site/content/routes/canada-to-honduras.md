---
title: "Shipping Dogs & Cats from Canada to Honduras | PetTransportGlobal"
description: "How to ship your dog or cat from Canada to Honduras. Honduras import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  ...
  overview: |
    International pet transport from Canada to Honduras comes down to documentation timing more than anything else.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Honduras"
      body: |
        Compared to some international pet transport routes, Canada to Honduras is manageable. That said, every country's rules are different and the timing requirements are strict.
    - heading: "From experience: Canada to Honduras pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Honduras?"
  ...
  - question: "Can I take my cat to Honduras from Canada?"
    answer: "Yes, cats can be transported from Canada to Honduras. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
