---
title: "Pet Transport from Colombia to Cuba | PetTransportGlobal"
description: "How to ship your dog or cat from Colombia to Cuba. Cuba import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "colombia-to-cuba"
...
content:
  h1: "Pet Transport from Colombia to Cuba"
  overview: |
    The Colombia to Cuba route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "Understanding Cuba's pet import rules"
      body: |
        Compared to some international pet transport routes, Colombia to Cuba is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Colombia to Cuba?"
  ...
  - question: "Can I take my cat to Cuba from Colombia?"
    answer: "Yes, cats can be transported from Colombia to Cuba. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/cuba-to-colombia/"
      text: "Pet Transport Cuba to Colombia"
  upward:
