---
title: "Pet Relocation Latvia to New Zealand | Requirements & Guide"
description: "How to ship your dog or cat from Latvia to New Zealand. New Zealand import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "latvia-to-new-zealand"
origin_name: "Latvia"
...
content:
  h1: "Pet Transport from Latvia to New Zealand"
  overview: |
    Getting your dog or cat from Latvia to New Zealand is entirely achievable, but the preparation timeline is not flexible.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Latvia to New Zealand?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Latvia. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check New Zealand's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/new-zealand-to-latvia/"
      text: "Pet Transport New Zealand to Latvia"
  upward:
