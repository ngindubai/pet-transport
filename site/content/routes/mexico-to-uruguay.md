---
title: "Shipping Dogs & Cats from Mexico to Uruguay | PetTransportGlobal"
description: "Complete guide to pet transport from Mexico to Uruguay. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "mexico-to-uruguay"
origin_name: "Mexico"
...
content:
  h1: "Pet Transport from Mexico to Uruguay"
  overview: |
    International pet transport from Mexico to Uruguay comes down to documentation timing more than anything else.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Uruguay"
      body: |
        Compared to some international pet transport routes, Mexico to Uruguay is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Mexico to Uruguay?"
  ...
  - question: "Can I take my cat to Uruguay from Mexico?"
    answer: "Yes, cats can be transported from Mexico to Uruguay. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/uruguay-to-mexico/"
      text: "Pet Transport Uruguay to Mexico"
  upward:
