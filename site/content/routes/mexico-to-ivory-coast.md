---
title: "Pet Relocation Mexico to Ivory Coast | Requirements & Guide"
description: "How to ship your dog or cat from Mexico to Ivory Coast. Ivory Coast import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "mexico-to-ivory-coast"
origin_name: "Mexico"
...
content:
  h1: "Pet Transport from Mexico to Ivory Coast"
  overview: |
    The Mexico to Ivory Coast route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "What to know about the Mexico to Ivory Coast route"
      body: |
        Compared to some international pet transport routes, Mexico to Ivory Coast is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Mexico to Ivory Coast?"
  ...
  - question: "Can I take my cat to Ivory Coast from Mexico?"
    answer: "Yes, cats can be transported from Mexico to Ivory Coast. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/ivory-coast-to-mexico/"
      text: "Pet Transport Ivory Coast to Mexico"
  upward:
