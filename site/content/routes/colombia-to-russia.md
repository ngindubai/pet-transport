---
title: "Shipping Dogs & Cats from Colombia to Russia | PetTransportGlobal"
description: "How to ship your dog or cat from Colombia to Russia. Russia import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "colombia-to-russia"
...
content:
  h1: "Pet Transport from Colombia to Russia"
  overview: |
    Shipping your pet from Colombia to Russia is a process that rewards early planning.
  ...
  sections:
    - heading: "What to know about the Colombia to Russia route"
      body: |
        Compared to some international pet transport routes, Colombia to Russia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Colombia to Russia?"
  ...
  - question: "Can I take my cat to Russia from Colombia?"
    answer: "Yes, cats can be transported from Colombia to Russia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/russia-to-colombia/"
      text: "Pet Transport Russia to Colombia"
  upward:
