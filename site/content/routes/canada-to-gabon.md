---
title: "Shipping Dogs & Cats from Canada to Gabon | PetTransportGlobal"
description: "How to ship your dog or cat from Canada to Gabon. Gabon import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Canada to Gabon"
  overview: |
    Moving a pet from Canada to Gabon involves more paperwork than most owners expect.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Gabon"
      body: |
        Compared to some international pet transport routes, Canada to Gabon is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Gabon?"
  ...
  - question: "Can I take my cat to Gabon from Canada?"
    answer: "Yes, cats can be transported from Canada to Gabon. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/gabon-to-canada/"
      text: "Pet Transport Gabon to Canada"
  upward:
