---
title: "Shipping Dogs & Cats from Colombia to Sudan | PetTransportGlobal"
description: "Complete guide to pet transport from Colombia to Sudan. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "colombia-to-sudan"
...
content:
  h1: "Pet Transport from Colombia to Sudan"
  overview: |
    Moving a pet from Colombia to Sudan involves more paperwork than most owners expect.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Sudan"
      body: |
        Compared to some international pet transport routes, Colombia to Sudan is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Colombia to Sudan?"
  ...
  - question: "Can I take my cat to Sudan from Colombia?"
    answer: "Yes, cats can be transported from Colombia to Sudan. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/sudan-to-colombia/"
      text: "Pet Transport Sudan to Colombia"
  upward:
