---
title: "Pet Relocation Saint Lucia to Nepal | Requirements & Guide"
description: "How to ship your dog or cat from Saint Lucia to Nepal. Nepal import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "saint-lucia-to-nepal"
...
content:
  h1: "Pet Transport from Saint Lucia to Nepal"
  overview: |
    Moving a pet from Saint Lucia to Nepal involves more paperwork than most owners expect.
  ...
  sections:
    ...
    - heading: "From experience: Saint Lucia to Nepal pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Saint Lucia to Nepal?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Saint Lucia. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Nepal's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/nepal-to-saint-lucia/"
      text: "Pet Transport Nepal to Saint Lucia"
  upward:
