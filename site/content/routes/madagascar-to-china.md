---
title: "Pet Relocation Madagascar to China | Requirements & Guide"
description: "How to ship your dog or cat from Madagascar to China. China import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "madagascar-to-china"
...
content:
  h1: "Pet Transport from Madagascar to China"
  overview: |
    Pet transport from Madagascar to China follows a clear process once you know what China requires.
  ...
  sections:
    ...
    - heading: "From experience: Madagascar to China pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Madagascar to China?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Madagascar. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check China's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/china-to-madagascar/"
      text: "Pet Transport China to Madagascar"
  upward:
