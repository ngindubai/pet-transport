---
title: "Pet Relocation Mexico to Nauru | Requirements & Guide"
description: "Pet relocation from Mexico to Nauru: Nauru import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "mexico-to-nauru"
origin_name: "Mexico"
...
content:
  h1: "Pet Transport from Mexico to Nauru"
  overview: |
    The Mexico to Nauru route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "What to know about the Mexico to Nauru route"
      body: |
        Compared to some international pet transport routes, Mexico to Nauru is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Mexico to Nauru?"
  ...
  - question: "Can I take my cat to Nauru from Mexico?"
    answer: "Yes, cats can be transported from Mexico to Nauru. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/nauru-to-mexico/"
      text: "Pet Transport Nauru to Mexico"
  upward:
