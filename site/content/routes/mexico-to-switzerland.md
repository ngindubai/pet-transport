---
title: "Pet Transport Mexico to Switzerland: 2026 Import Requirements"
description: "Moving your pet from Mexico to Switzerland? EU-equivalent titre test, 90-day wait, and SENASICA certificate required. Cantonal breed rules apply. 2026 guide."
date: "2026-06-06"
type: "routes"
layout: "single"
template_variant: "D"
author: "Pet Transport Global Editorial Team"
slug: "mexico-to-switzerland"
origin_name: "Mexico"
...
route_data:
  origin:
    ...
    export_requirements:
      ...
      export_permit: "SENASICA export documentation"
  destination:
    code: "CH"
    country: "Switzerland"
    import_requirements:
      ...
      titre_test: "FAVN titre test (0.5 IU/ml minimum), blood 30+ days after vaccination, EU-recognised laboratory"
      ...
      health_certificate: "Swiss-format health certificate based on EU Annex IV for non-listed countries, within 10 days, SENASICA-endorsed"
      breed_restrictions: "Swiss cantonal breed restrictions vary widely; confirm for your destination canton before booking"

  airlines:
    - name: "Aeromexico"
      type: "cargo_only"
      policy_summary: "MEX to MAD or CDG with connecting Swiss WorldCargo to ZRH or GVA"
    - name: "Swiss WorldCargo"
      type: "cargo_only"
      policy_summary: "Zurich-based cargo handling; connections from European hubs to ZRH for Mexico-origin cargo"
    - name: "Lufthansa Cargo"
      type: "cargo_only"
      policy_summary: "MEX to FRA with Lufthansa, then connection to ZRH or GVA; reliable live animal handling throughout"
  ...
  timeline_steps:
    ...
    - step: 6
      action: "Cargo booking to ZRH or GVA"
...
content:
  h1: "Pet Transport Mexico to Switzerland: 2026 Guide"
  overview: "Switzerland aligns its pet import rules with EU standards, and for non-listed countries like Mexico, this means the FAVN titre test, 90-day wait, and SENASICA-endorsed health certificate are all mandatory. Switzerland also has 26 cantons with varying breed-specific legislation, which adds a local consideration that does not apply in most EU destinations. Plan for 20 to 24 weeks of preparation."

  sections:
    - heading: "Is Switzerland's pet import process really the same as the EU's?"
      body: |
    ...
    - heading: "Cantonal breed restrictions: what do I need to know before moving to Switzerland?"
      body: |
    ...
    - heading: "What are the cargo options from Mexico to Swiss airports?"
      body: |
...
faqs:
  - question: "Does Switzerland recognise Mexican SENASICA certificates without additional verification?"
    answer: "Yes, provided the certificate is in the correct EU Annex IV format for non-listed countries and carries the SENASICA endorsement. Swiss customs accept SENASICA-endorsed certificates in the same way EU customs do, as both apply equivalent standards. The key is that the certificate format is correct and the endorsement is genuine."
  - question: "Can I bring a Mexican street dog (mestizo) to Switzerland?"
    answer: "A mixed breed or mestizo from Mexico can be brought to Switzerland, but the breed assessment at the Swiss border and in your destination canton may apply. If the dog visually resembles a restricted breed, cantonal authorities may classify it accordingly. Consider obtaining a formal written breed assessment from a recognised source before travel if there is any uncertainty."
  - question: "What if the blood draw happens in Mexico but I want to do the 90-day wait partly in another country before Switzerland?"
    answer: "The 90-day wait starts from the blood draw date. You can be anywhere in the world during those 90 days; what matters is that your pet does not enter Switzerland (or the EU) until the 90 days are complete. If you are living in the US or elsewhere during the wait, that is fine as long as travel to Switzerland happens after the 90-day countdown is complete."
  - question: "How does SENASICA endorsement work for pets leaving from cities other than Mexico City?"
    answer: "SENASICA has regional offices across Mexico. The endorsement can be processed at the regional SENASICA office nearest to you, but processing times vary. Regional offices may take longer than Mexico City offices. If you are based in a city with a slow regional office, consider whether a vet in Mexico City with SENASICA connections is more practical for the health certificate appointment."
  - question: "Does Swiss customs require a pet passport?"
    answer: "Switzerland does not require the EU-style pet passport for animals from non-EU/non-EEA third countries. The SENASICA-endorsed health certificate serves as the primary import document. Swiss customs may also want to see the vaccination record booklet and titre test result documentation, but not an EU pet passport."
