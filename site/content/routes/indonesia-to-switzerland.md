---
title: "Pet Transport Indonesia to Switzerland: 2026 Import Requirements"
description: "Moving your pet from Indonesia to Switzerland? EU-equivalent titre test and 90-day wait apply. BARANTAN export permit and cantonal breed rules explained."
date: "2026-06-06"
type: "routes"
layout: "single"
template_variant: "D"
...
route_data:
  ...
  destination:
    ...
    import_requirements:
      ...
      titre_test: "FAVN titre test (0.5 IU/ml minimum), blood drawn 30+ days after vaccination, recognised laboratory"
      quarantine: "No quarantine if documentation correct and 90-day wait from blood draw is complete"
      import_permit: "Not required for non-commercial pet imports"
      health_certificate: "Swiss-format health certificate (EU Annex IV equivalent for non-listed countries), within 10 days of travel, BARANTAN-endorsed"
      breed_restrictions: "Cantonal breed restrictions vary; some cantons ban or restrict specific breeds"

  airlines:
    - name: "Swiss WorldCargo"
      type: "cargo_only"
      policy_summary: "Connections to ZRH from major European hubs; experienced Zurich airport handling for live animals"
    - name: "KLM Cargo"
      type: "cargo_only"
      policy_summary: "CGK to AMS direct, with connecting cargo to ZRH or GVA; Amsterdam is a strong hub for Swiss connections"
    - name: "Qatar Airways Cargo"
      type: "cargo_only"
      policy_summary: "CGK to DOH to ZRH or GVA; good live animal handling throughout the Qatar network"
  ...
  timeline_steps:
    ...
    - step: 3
      ...
      timing: "30+ days after vaccination, recognised laboratory"
...
content:
  h1: "Pet Transport Indonesia to Switzerland: 2026 Guide"
  overview: "Switzerland's pet import rules closely mirror EU standards, which means dogs and cats from Indonesia face the same titre test and 90-day wait process as for EU destinations. The BARANTAN export certificate and export permit are both required from Indonesia. Cantonal breed restrictions add a layer of complexity specific to Switzerland. Plan for 20 to 24 weeks of preparation."

  sections:
    - heading: "Does Switzerland treat Indonesian pets differently from EU countries?"
      body: |
    ...
    - heading: "How do I find an EU-recognised lab for the titre test from Indonesia?"
      body: |
    ...
    - heading: "Routing from Jakarta to Zurich or Geneva: what are the options?"
      body: |
...
faqs:
  - question: "Can I bring a dog from Bali to Switzerland?"
    answer: "Yes, but the same requirements apply as for any pet from Indonesia. Bali is part of Indonesia, which is a non-listed third country for Swiss import purposes. The titre test, 90-day wait, and BARANTAN endorsement are all required. There is no special Bali exemption."
  - question: "What cantons have the strictest breed restrictions in Switzerland?"
  ...
  - question: "How does the 90-day wait interact with my relocation timeline?"
    answer: "The 90-day wait from blood draw must be complete before your pet crosses into Switzerland. This means that even if you have moved to Switzerland yourself, your pet cannot follow until the 90 days are up. Many families coordinate the process so the pet arrives 1-2 weeks after the owner, with the wait period finishing just before travel. Planning this carefully avoids the common problem of having to push back travel dates."
  - question: "Is BARANTAN endorsement the same as a standard veterinary signature?"
    answer: "No. BARANTAN endorsement is a formal government-authority counter-signature on the health certificate, confirming that the issuing vet is registered with BARANTAN and that the certificate meets Indonesian export standards. This is a requirement of the Swiss (and EU) import rules for non-listed countries. A standard vet signature alone is not sufficient."
  - question: "What is the transit like for my pet travelling via Amsterdam or Doha?"
    answer: "At Amsterdam Schiphol, KLM has a dedicated live animal facility. Connections at Schiphol are efficient and the animal is kept in climate-controlled areas during transit. At Doha, Qatar Airways Cargo has a live animal centre. Transit times at connecting hubs should ideally be kept below 4 hours for your pet's comfort. Your transport agent can advise on optimal routings."
