---
title: "Shipping Dogs & Cats from Brazil to Syria | PetTransportGlobal"
description: "Complete guide to pet transport from Brazil to Syria. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "brazil-to-syria"
origin_name: "Brazil"
...
content:
  h1: "Pet Transport from Brazil to Syria"
  overview: |
    Moving to Syria from Brazil with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "What to know about the Brazil to Syria route"
      body: |
        Compared to some international pet transport routes, Brazil to Syria is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Brazil to Syria?"
  ...
  - question: "Can I take my cat to Syria from Brazil?"
    answer: "Yes, cats can be transported from Brazil to Syria. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/syria-to-brazil/"
      text: "Pet Transport Syria to Brazil"
  upward:
