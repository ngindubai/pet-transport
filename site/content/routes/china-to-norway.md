---
template_variant: "A"
title: "Shipping Dogs & Cats from China to Norway | PetTransportGlobal"
description: "How to ship your dog or cat from China to Norway. Norway import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from China to Norway"
  overview: |
    The China to Norway route is one many expats and returning families use each year with their pets.
  ...
  sections:
    - heading: "What to know about the China to Norway route"
      body: |
        Compared to some international pet transport routes, China to Norway is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from China to Norway?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in China. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Norway's authority for the exact format required."
...
links:
  sideways:
    - url: "/pet-transport/norway-to-china/"
      text: "Pet Transport Norway to China"
  upward:
