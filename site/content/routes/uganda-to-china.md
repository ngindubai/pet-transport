---
title: "Shipping Dogs & Cats from Uganda to China | PetTransportGlobal"
description: "How to ship your dog or cat from Uganda to China. China import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "uganda-to-china"
origin_name: "Uganda"
...
content:
  h1: "Pet Transport from Uganda to China"
  overview: |
    Moving to China from Uganda with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    ...
    - heading: "From experience: Uganda to China pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Uganda to China?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Uganda. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check China's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/china-to-uganda/"
      text: "Pet Transport China to Uganda"
  upward:
