---
title: "Shipping Dogs & Cats from Canada to Ivory Coast | PetTransportGlobal"
description: "How to ship your dog or cat from Canada to Ivory Coast. Ivory Coast import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  ...
  overview: |
    Shipping your pet from Canada to Ivory Coast is a process that rewards early planning.
  ...
  sections:
    - heading: "What to know about the Canada to Ivory Coast route"
      body: |
        Compared to some international pet transport routes, Canada to Ivory Coast is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Ivory Coast?"
  ...
  - question: "Can I take my cat to Ivory Coast from Canada?"
    answer: "Yes, cats can be transported from Canada to Ivory Coast. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
