---
title: "Moving Your Pet from Haiti to Ghana | Complete Guide"
description: "Pet relocation from Haiti to Ghana: Ghana import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Haiti to Ghana"
  overview: |
    Pet transport from Haiti to Ghana follows a clear process once you know what Ghana requires.
  ...
  sections:
    - heading: "What to know about the Haiti to Ghana route"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Haiti to Ghana?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Haiti. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Ghana's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/ghana-to-haiti/"
      text: "Pet Transport Ghana to Haiti"
  upward:
