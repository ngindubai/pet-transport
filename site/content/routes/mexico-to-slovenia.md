---
title: "Moving Your Pet from Mexico to Slovenia | Complete Guide"
description: "How to ship your dog or cat from Mexico to Slovenia. Slovenia import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Mexico to Slovenia"
  overview: |
    The Mexico to Slovenia route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Slovenia"
      body: |
        Compared to some international pet transport routes, Mexico to Slovenia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Mexico to Slovenia?"
  ...
  - question: "Can I take my cat to Slovenia from Mexico?"
    answer: "Yes, cats can be transported from Mexico to Slovenia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
