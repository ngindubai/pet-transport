---
title: "Shipping Dogs & Cats from Burundi to North Macedonia | PetTransportGlobal"
description: "How to ship your dog or cat from Burundi to North Macedonia. North Macedonia import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "burundi-to-north-macedonia"
origin_name: "Burundi"
...
content:
  h1: "Pet Transport from Burundi to North Macedonia"
  overview: |
    Moving to North Macedonia from Burundi with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "Understanding North Macedonia's pet import rules"
      body: |
        Compared to some international pet transport routes, Burundi to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Burundi to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Burundi?"
    answer: "Yes, cats can be transported from Burundi to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-burundi/"
      text: "Pet Transport North Macedonia to Burundi"
  upward:
