---
title: "Pet Transport Australia to UAE: Import Permit, Health Certificate and Emirates Flights 2026"
description: "Moving your dog or cat from Australia to Dubai or Abu Dhabi? No titre test required from Australia. MOCCAE import permit rules, Emirates direct flights, and a 6-8 week timeline."
date: "2026-06-05"
type: "routes"
layout: "single"
template_variant: "C"
...
route_data:
  origin:
    ...
    export_requirements:
      ...
      export_permit: "No export permit required from Australia for personal pet exports to the UAE. Official health certificate from an accredited Australian vet is the required departure documentation."
  ...
  destination:
    ...
    import_requirements:
      ...
      rabies_vaccination: "Current rabies vaccination required. Must be administered after microchip implant. First vaccination carries a 21-day pre-travel wait; boosters within validity have no additional wait. Must be valid at time of entry into UAE."
      quarantine: "No routine quarantine for compliant pets arriving from Australia. Penalty quarantine applies if documentation is incomplete or non-compliant on arrival."
      import_permit: "Required from the receiving emirate's municipality before travel. Dubai: Dubai Municipality (dm.gov.ae). Abu Dhabi: ADAFSA (adafsa.gov.ae). Allow 1-2 weeks for processing. Permit must travel with your pet."
      health_certificate: "Official health certificate from an accredited Australian vet in UAE-required format, endorsed by DAFF if required by the receiving emirate. Certificate must confirm microchip number, current rabies vaccination, freedom from clinical signs of infectious disease, and fitness to travel. Source: MOCCAE, moccae.gov.ae."
    breed_restrictions:
  ...
  airlines:
    - name: "Emirates"
      type: "cargo_only"
      policy_summary: "Direct service from Sydney (SYD) and Melbourne (MEL) to Dubai (DXB). Most popular and most direct option for this route. All pets travel as manifested cargo via Emirates SkyCargo; no cabin option. Brachycephalic breeds accepted with additional requirements and seasonal restrictions. Temperature embargoes apply during Gulf summer months (June to September)."
    - name: "Etihad Airways"
      type: "cargo_only"
      policy_summary: "Direct service from Sydney (SYD) and Melbourne (MEL) to Abu Dhabi (AUH). Pets travel as manifested cargo. Brachycephalic breeds subject to seasonal restrictions. Temperature embargoes during Abu Dhabi summer months."
    - name: "Qantas"
      type: "cargo_only"
      policy_summary: "Operates some Australia-Dubai services, including codeshare arrangements with Emirates. Pets as manifested cargo via Qantas Freight. Brachycephalic breeds restricted year-round. Confirm current routing and booking process with Qantas Freight."
    - name: "Singapore Airlines Cargo"
      type: "cargo_only"
      policy_summary: "Indirect routing via Singapore (SIN) to Dubai (DXB) or Abu Dhabi (AUH). Longer total transit time but an option when direct capacity is unavailable. Seasonal restrictions at SIN. Advance documentation review required."

  timeline_steps:
    - step: 1
      action: "Implant ISO 11784/11785 microchip (if not already done)"
      timing: "First action, before any vaccinations."
    ...
    - step: 3
      ...
      timing: "4-6 weeks before travel. Dubai: via Dubai Municipality. Abu Dhabi: via ADAFSA. Allow 1-2 weeks for processing."
      responsible: "Owner or specialist pet transport agent"
    - step: 4
      action: "Book cargo space with Emirates or chosen airline"
      timing: "4-6 weeks before travel. Confirm breed eligibility and Gulf summer temperature embargo status."
      responsible: "Owner or agent"
    - step: 5
      action: "Accredited Australian vet issues UAE-format health certificate; DAFF endorsement if required by receiving emirate"
      timing: "Within 10 days of departure from Australia"
    ...
    - step: 6
      ...
      timing: "3-4 hours before scheduled departure for cargo"
      responsible: "Owner"
    - step: 7
      action: "UAE border inspection on arrival; microchip scan and documentation review"
      timing: "On arrival at DXB or AUH"
...
content:
  h1: "Pet Transport from Australia to the UAE: Import Permits, Emirates Flights and What to Expect"
  overview: |
    Australia to the UAE is a manageable international pet relocation for owners who prepare correctly. Australia is on the UAE's list of approved origin countries, meaning no rabies titre test is required, and no routine quarantine awaits your pet on arrival in Dubai or Abu Dhabi. The core requirements are an ISO microchip, a current rabies vaccination, an import permit from the receiving emirate's municipality, and an official health certificate in UAE-prescribed format. With good organisation, the whole process takes six to eight weeks.

    This is a common route for Australian professionals relocating on UAE work contracts, and for Australian families joining partners already based in Dubai or Abu Dhabi. Emirates operates direct flights from Sydney and Melbourne to Dubai, making the logistics relatively clean. Etihad covers the Abu Dhabi route direct. The most common problems on this route are obtaining the import permit from the wrong authority, presenting a health certificate that is not in the UAE-required format, and booking cargo travel in June, July, or August when Gulf heat triggers temperature embargoes.

    The UAE splits pet import administration between MOCCAE (the federal Ministry of Climate Change and Environment) and individual emirate municipalities. The import permit must come from the municipality for the emirate where your pet will reside. For Dubai, that is Dubai Municipality; for Abu Dhabi, it is ADAFSA. Apply to the correct authority and allow one to two weeks for processing.

  sections:
    - heading: "UAE Import Requirements for Pets from Australia"
      body: |
    ...
    - heading: "Getting the Paperwork Right for Australia to UAE"
      body: |
...
faqs:
  - question: "Do I need a titre test to take my pet from Australia to the UAE?"
    answer: "No. Australia is an approved origin country for UAE pet imports, so no rabies titre test is required. You need a current rabies vaccination, a microchip implanted before that vaccination, an import permit from the relevant emirate, and an official health certificate in UAE-required format. The process is typically completed in six to eight weeks."

  - question: "How do I get an import permit for the UAE?"
...
links:
  ...
  upward:
    ...
    - url: "/pet-transport/airlines/etihad/"
      text: "Etihad pet cargo policy"
---
