---
template_variant: "A"
title: "Pet Relocation Jordan to Ireland | Requirements & Guide"
description: "Complete guide to pet transport from Jordan to Ireland. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Jordan to Ireland"
  overview: |
    Shipping your pet from Jordan to Ireland is a process that rewards early planning.
  ...
  sections:
    - heading: "What to know about the Jordan to Ireland route"
      body: |
        Compared to some international pet transport routes, Jordan to Ireland is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Jordan to Ireland?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Jordan. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Ireland's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/ireland-to-jordan/"
      text: "Pet Transport Ireland to Jordan"
  upward:
