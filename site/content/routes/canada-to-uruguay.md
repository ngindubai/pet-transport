---
title: "Shipping Dogs & Cats from Canada to Uruguay | PetTransportGlobal"
description: "How to ship your dog or cat from Canada to Uruguay. Uruguay import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Canada to Uruguay"
  overview: |
    Pet transport from Canada to Uruguay follows a clear process once you know what Uruguay requires.
  ...
  sections:
    - heading: "What to know about the Canada to Uruguay route"
      body: |
        Compared to some international pet transport routes, Canada to Uruguay is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Uruguay?"
  ...
  - question: "Can I take my cat to Uruguay from Canada?"
    answer: "Yes, cats can be transported from Canada to Uruguay. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/uruguay-to-canada/"
      text: "Pet Transport Uruguay to Canada"
  upward:
