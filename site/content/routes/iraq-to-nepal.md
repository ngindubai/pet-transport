---
title: "Moving Your Pet from Iraq to Nepal | Complete Guide"
description: "Pet relocation from Iraq to Nepal: Nepal import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Iraq to Nepal"
  overview: |
    Moving a pet from Iraq to Nepal involves more paperwork than most owners expect.
  ...
  sections:
    ...
    - heading: "From experience: Iraq to Nepal pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Iraq to Nepal?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Iraq. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Nepal's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/nepal-to-iraq/"
      text: "Pet Transport Nepal to Iraq"
  upward:
