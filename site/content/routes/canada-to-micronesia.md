---
title: "Shipping Dogs & Cats from Canada to Micronesia | PetTransportGlobal"
description: "Complete guide to pet transport from Canada to Micronesia. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Canada to Micronesia"
  overview: |
    The Canada to Micronesia route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "Understanding Micronesia's pet import rules"
      body: |
        Compared to some international pet transport routes, Canada to Micronesia is manageable. That said, every country's rules are different and the timing requirements are strict.
    - heading: "From experience: Canada to Micronesia pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Micronesia?"
  ...
  - question: "Can I take my cat to Micronesia from Canada?"
    answer: "Yes, cats can be transported from Canada to Micronesia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/micronesia-to-canada/"
      text: "Pet Transport Micronesia to Canada"
  upward:
