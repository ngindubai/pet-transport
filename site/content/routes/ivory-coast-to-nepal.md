---
title: "Shipping Dogs & Cats from Ivory Coast to Nepal | PetTransportGlobal"
description: "Complete guide to pet transport from Ivory Coast to Nepal. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "ivory-coast-to-nepal"
...
content:
  h1: "Pet Transport from Ivory Coast to Nepal"
  overview: |
    Shipping your pet from Ivory Coast to Nepal is a process that rewards early planning.
  ...
  sections:
    ...
    - heading: "From experience: Ivory Coast to Nepal pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Ivory Coast to Nepal?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Ivory Coast. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Nepal's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/nepal-to-ivory-coast/"
      text: "Pet Transport Nepal to Ivory Coast"
  upward:
