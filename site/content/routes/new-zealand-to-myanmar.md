---
template_variant: "A"
title: "Pet Relocation New Zealand to Myanmar | Requirements & Guide"
description: "Pet relocation from New Zealand to Myanmar: Myanmar import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Marcus Webb, Senior Pet Relocation Consultant, PetTransportGlobal"
slug: "new-zealand-to-myanmar"
...
content:
  h1: "Pet Transport from New Zealand to Myanmar"
  overview: |
    Moving a pet from New Zealand to Myanmar involves more paperwork than most owners expect.
  ...
  sections:
    ...
    - heading: "From experience: New Zealand to Myanmar pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from New Zealand to Myanmar?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in New Zealand. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Myanmar's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/myanmar-to-new-zealand/"
      text: "Pet Transport Myanmar to New Zealand"
  upward:
