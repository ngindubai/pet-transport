---
title: "Pet Transport from Syria to North Macedonia | PetTransportGlobal"
description: "Complete guide to pet transport from Syria to North Macedonia. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "syria-to-north-macedonia"
origin_name: "Syria"
...
content:
  h1: "Pet Transport from Syria to North Macedonia"
  overview: |
    Shipping your pet from Syria to North Macedonia is a process that rewards early planning.
  ...
  sections:
    - heading: "Key requirements for moving your pet to North Macedonia"
      body: |
        Compared to some international pet transport routes, Syria to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Syria to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Syria?"
    answer: "Yes, cats can be transported from Syria to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-syria/"
      text: "Pet Transport North Macedonia to Syria"
  upward:
