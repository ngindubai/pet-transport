---
title: "Shipping Dogs & Cats from Japan to Moldova | PetTransportGlobal"
description: "Pet relocation from Japan to Moldova: Moldova import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "japan-to-moldova"
origin_name: "Japan"
...
content:
  h1: "Pet Transport from Japan to Moldova"
  overview: |
    The Japan to Moldova route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Moldova"
      body: |
        Compared to some international pet transport routes, Japan to Moldova is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Japan to Moldova?"
  ...
  - question: "Can I take my cat to Moldova from Japan?"
    answer: "Yes, cats can be transported from Japan to Moldova. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/moldova-to-japan/"
      text: "Pet Transport Moldova to Japan"
  upward:
