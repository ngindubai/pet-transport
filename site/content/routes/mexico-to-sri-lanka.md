---
template_variant: "A"
title: "Shipping Dogs & Cats from Mexico to Sri Lanka | PetTransportGlobal"
description: "Pet relocation from Mexico to Sri Lanka: Sri Lanka import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Pet Transport Global Editorial Team"
slug: "mexico-to-sri-lanka"
origin_name: "Mexico"
...
content:
  h1: "Pet Transport from Mexico to Sri Lanka"
  overview: |
    Pet transport from Mexico to Sri Lanka follows a clear process once you know what Sri Lanka requires.
  ...
  sections:
    ...
    - heading: "From experience: Mexico to Sri Lanka pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Mexico to Sri Lanka?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Mexico. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check Sri Lanka's authority for the exact format required."
...
links:
  sideways:
    - url: "/pet-transport/sri-lanka-to-mexico/"
      text: "Pet Transport Sri Lanka to Mexico"
  upward:
