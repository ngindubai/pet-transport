---
template_variant: "E"
title: "Moving Your Pet from Peru to France | Complete Guide"
description: "Pet relocation from Peru to France: France import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Peru to France"
  overview: |
    If you're relocating from Peru to France and taking your pet, the good news is thousands of families do this every year.
  ...
  sections:
    - heading: "Key requirements for moving your pet to France"
      body: |
        Compared to some international pet transport routes, Peru to France is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Peru to France?"
  ...
  - question: "Can I take my cat to France from Peru?"
    answer: "Yes, cats can be transported from Peru to France. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
