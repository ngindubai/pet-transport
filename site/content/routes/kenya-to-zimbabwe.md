---
template_variant: "D"
title: "Shipping Dogs & Cats from Kenya to Zimbabwe | PetTransportGlobal"
description: "Pet relocation from Kenya to Zimbabwe: Zimbabwe import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Marcus Webb, Senior Pet Relocation Consultant, PetTransportGlobal"
slug: "kenya-to-zimbabwe"
origin_name: "Kenya"
...
content:
  h1: "Pet Transport from Kenya to Zimbabwe"
  overview: |
    The Kenya to Zimbabwe route is one many expats and returning families use each year with their pets.
  ...
  sections:
    - heading: "What to know about the Kenya to Zimbabwe route"
      body: |
    ...
    - heading: "From experience: Kenya to Zimbabwe pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Kenya to Zimbabwe?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Kenya. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Zimbabwe's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/zimbabwe-to-kenya/"
      text: "Pet Transport Zimbabwe to Kenya"
  upward:
