---
title: "Pet Relocation Canada to North Macedonia | Requirements & Guide"
description: "Pet relocation from Canada to North Macedonia: North Macedonia import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
...
content:
  ...
  overview: |
    The Canada to North Macedonia route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "Understanding North Macedonia's pet import rules"
      body: |
        Compared to some international pet transport routes, Canada to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Canada?"
    answer: "Yes, cats can be transported from Canada to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-canada/"
      text: "Pet Transport North Macedonia to Canada"
  upward:
