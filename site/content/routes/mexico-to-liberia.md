---
title: "Shipping Dogs & Cats from Mexico to Liberia | PetTransportGlobal"
description: "How to ship your dog or cat from Mexico to Liberia. Liberia import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "mexico-to-liberia"
origin_name: "Mexico"
...
content:
  h1: "Pet Transport from Mexico to Liberia"
  overview: |
    Getting your dog from Mexico to Liberia is entirely achievable, but the preparation timeline is not flexible.
  ...
  sections:
    - heading: "What to know about the Mexico to Liberia route"
      body: |
        Compared to some international pet transport routes, Mexico to Liberia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Mexico to Liberia?"
  ...
  - question: "Can I take my cat to Liberia from Mexico?"
    answer: "Yes, cats can be transported from Mexico to Liberia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/liberia-to-mexico/"
      text: "Pet Transport Liberia to Mexico"
  upward:
