---
title: "Shipping Dogs & Cats from Burundi to Nepal | PetTransportGlobal"
description: "How to ship your dog or cat from Burundi to Nepal. Nepal import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "burundi-to-nepal"
origin_name: "Burundi"
...
content:
  h1: "Pet Transport from Burundi to Nepal"
  overview: |
    International pet transport from Burundi to Nepal comes down to documentation timing more than anything else.
  ...
  sections:
    ...
    - heading: "From experience: Burundi to Nepal pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Burundi to Nepal?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Burundi. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Nepal's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/nepal-to-burundi/"
      text: "Pet Transport Nepal to Burundi"
  upward:
