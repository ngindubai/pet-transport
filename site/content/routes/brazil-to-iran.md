---
title: "Shipping Dogs & Cats from Brazil to Iran | PetTransportGlobal"
description: "Pet relocation from Brazil to Iran: Iran import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Brazil to Iran"
  overview: |
    Moving to Iran from Brazil with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "Understanding Iran's pet import rules"
      body: |
        Compared to some international pet transport routes, Brazil to Iran is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Brazil to Iran?"
  ...
  - question: "Can I take my cat to Iran from Brazil?"
    answer: "Yes, cats can be transported from Brazil to Iran. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/iran-to-brazil/"
      text: "Pet Transport Iran to Brazil"
  upward:
