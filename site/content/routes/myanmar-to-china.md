---
template_variant: "B"
title: "Pet Transport from Myanmar to China | PetTransportGlobal"
description: "How to ship your dog or cat from Myanmar to China. China import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Pet Transport Global Editorial Team"
slug: "myanmar-to-china"
origin_name: "Myanmar"
...
content:
  h1: "Pet Transport from Myanmar to China"
  overview: |
    Moving to China from Myanmar with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    ...
    - heading: "From experience: Myanmar to China pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Myanmar to China?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Myanmar. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check China's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/china-to-myanmar/"
      text: "Pet Transport China to Myanmar"
  upward:
