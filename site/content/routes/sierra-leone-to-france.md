---
title: "Moving Your Pet from Sierra Leone to France | Complete Guide"
description: "How to ship your dog or cat from Sierra Leone to France. France import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "sierra-leone-to-france"
...
content:
  h1: "Pet Transport from Sierra Leone to France"
  overview: |
    Moving to France from Sierra Leone with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "Key requirements for moving your pet to France"
      body: |
        Compared to some international pet transport routes, Sierra Leone to France is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Sierra Leone to France?"
  ...
  - question: "Can I take my cat to France from Sierra Leone?"
    answer: "Yes, cats can be transported from Sierra Leone to France. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/france-to-sierra-leone/"
      text: "Pet Transport France to Sierra Leone"
  upward:
