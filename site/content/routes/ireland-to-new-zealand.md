---
template_variant: "A"
title: "Shipping Dogs & Cats from Ireland to New Zealand | PetTransportGlobal"
description: "How to ship your dog or cat from Ireland to New Zealand. New Zealand import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Ireland to New Zealand"
  overview: |
  ...
  sections:
    ...
    - heading: "From experience: Ireland to New Zealand pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Ireland to New Zealand?"
  ...
  - question: "Can I take my cat to New Zealand from Ireland?"
    answer: "Yes, cats can be transported from Ireland to New Zealand. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/new-zealand-to-ireland/"
      text: "Pet Transport New Zealand to Ireland"
  upward:
