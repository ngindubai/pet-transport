---
title: "Pet Transport China to Canada: Dogs and Cats, Full CFIA Import Guide 2026"
description: "Moving your pet from China to Canada? GACC export permit, CFIA rabies rules, and approved airline options explained. No quarantine with correct paperwork."
date: "2026-06-05"
type: "routes"
layout: "single"
template_variant: "C"
...
route_data:
  origin:
    ...
    country: "China"
    export_requirements:
      health_certificate: "Official health certificate in CFIA-required format, issued by a GACC-authorised vet within 10 days of departure. Must be countersigned by GACC official before leaving China."
      export_permit: "GACC export permit required. Apply through local GACC office with health certificate, microchip record, and vaccination history. Allow 3-4 weeks."

  destination:
    code: "CA"
    country: "Canada"
    import_requirements:
      microchip: "ISO 11784/11785 compliant 15-digit microchip strongly recommended. Must be implanted before or on the same day as the first rabies vaccination for the vaccination record to be valid."
      rabies_vaccination: "Current rabies vaccination required. Vaccine must have been administered by a licensed vet and be valid at the time of entry. Booster required if more than 3 years have elapsed since last vaccination. Source: CFIA, inspection.gc.ca."
      titre_test: "Not required for personal pet imports to Canada from China."
      quarantine: "No quarantine for dogs or cats with correct documentation. Animals must appear healthy on arrival. CBSA officers can detain animals that appear unwell."
      import_permit: "No CFIA import permit required for personal pet imports of 1-2 animals. Imports of more than 2 dogs, or any dog for commercial purposes, require a CFIA permit."
      health_certificate: "Official veterinary health certificate required. Must be issued by a government-authorised vet in China and signed within 10 days of arrival. CFIA officers may inspect on arrival at a Canadian port of entry."

  airlines:
    - name: "Air China"
      type: "cargo_only"
      policy_summary: "International pet shipments via Air China Cargo. Pets travel as manifested cargo; no cabin option on China-Canada routes. Advance booking required; documentation review before acceptance at cargo desk."
    - name: "Air Canada"
      type: "cabin_and_cargo"
      policy_summary: "Small pets (up to 10kg including carrier) allowed in cabin on some routes. Larger pets as cargo via Air Canada Cargo in pressurised, temperature-controlled hold. Brachycephalic breeds restricted from cargo year-round."
    - name: "Cathay Pacific"
      type: "cargo_only"
      policy_summary: "Cargo only via Hong Kong (HKG). AFCD rules apply during Hong Kong transit. Seasonal temperature restrictions; confirm breed and timing eligibility before booking."
    - name: "Air France/KLM"
      type: "cabin_and_cargo"
      policy_summary: "Small pets in cabin (up to 8kg with carrier) on some connections via Paris CDG or Amsterdam AMS. Larger pets as cargo. Brachycephalic breeds subject to restrictions."

  timeline_steps:
    - step: 1
      action: "Implant ISO microchip and give first rabies vaccination on the same vet visit"
      timing: "At least 8-10 weeks before travel date"
      responsible: "vet/owner"
    - step: 2
      action: "Confirm vaccination is current and valid at time of planned arrival in Canada"
      timing: "At least 6 weeks before travel"
      responsible: "vet/owner"
    - step: 3
      action: "Apply for GACC export permit with local GACC office"
      timing: "4-6 weeks before travel"
      responsible: "owner/agent"
    - step: 4
      action: "Book cargo space with chosen airline and confirm documentation requirements"
      timing: "4-6 weeks before travel"
      responsible: "owner/agent"
    - step: 5
      action: "Official vet issues health certificate in CFIA-required format; GACC official countersigns"
      timing: "Within 10 days of departure"
      responsible: "vet/GACC"
    - step: 6
      action: "Deliver pet and all documents to cargo desk on day of departure"
      timing: "2-3 hours before scheduled departure"
      responsible: "owner"
    - step: 7
      action: "CBSA inspection on arrival at Canadian port of entry; microchip scan and health certificate review"
      timing: "On arrival"
...
content:
  h1: "Pet Transport from China to Canada: GACC Export and CFIA Import Rules"
  overview: |
    Moving a pet from China to Canada is one of the more manageable long-haul international relocations, particularly compared to China-to-UK or China-to-USA. Canada does not require a titre test for personal pet imports, and there is no mandatory quarantine for dogs or cats arriving with the correct paperwork. That said, both ends of this journey have specific requirements that must be met in the right order, and the GACC export process in China adds time to any timeline.

    The route is most often taken by Chinese nationals immigrating to Canada on permanent residency or study permits, and by international workers returning home after postings in China. Either way, the key regulatory authorities are GACC (General Administration of Customs of China) on the way out, and CFIA (Canadian Food Inspection Agency) on the way in. Both require official health certificates, and the GACC process in particular needs to be started well before your travel date.

    Allow at least 8-10 weeks from the start of preparations to travel day, and longer if your pet does not yet have an up-to-date microchip or rabies vaccination. The main airlines for this route are Air China Cargo and Air Canada, with connecting options via Cathay Pacific (Hong Kong) and Air France/KLM (Europe). No carrier on this route currently allows large pets in the cabin.

  sections:
    - heading: "Canadian Import Requirements: What CFIA Expects"
      body: |
    ...
    - heading: "Airlines and Cargo Options for China to Canada"
      body: |
