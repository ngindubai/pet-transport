---
title: "Pet Relocation Japan to Haiti | Requirements & Guide"
description: "How to ship your dog or cat from Japan to Haiti. Haiti import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Japan to Haiti"
  overview: |
    International pet transport from Japan to Haiti comes down to documentation timing more than anything else.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Haiti"
      body: |
        Compared to some international pet transport routes, Japan to Haiti is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Japan to Haiti?"
  ...
  - question: "Can I take my cat to Haiti from Japan?"
    answer: "Yes, cats can be transported from Japan to Haiti. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/haiti-to-japan/"
      text: "Pet Transport Haiti to Japan"
  upward:
