---
title: "Moving Your Pet from Colombia to Syria | Complete Guide"
description: "Pet relocation from Colombia to Syria: Syria import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "colombia-to-syria"
...
content:
  h1: "Pet Transport from Colombia to Syria"
  overview: |
    Moving a pet from Colombia to Syria involves more paperwork than most owners expect.
  ...
  sections:
    - heading: "What to know about the Colombia to Syria route"
      body: |
        Compared to some international pet transport routes, Colombia to Syria is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Colombia to Syria?"
  ...
  - question: "Can I take my cat to Syria from Colombia?"
    answer: "Yes, cats can be transported from Colombia to Syria. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/syria-to-colombia/"
      text: "Pet Transport Syria to Colombia"
  upward:
