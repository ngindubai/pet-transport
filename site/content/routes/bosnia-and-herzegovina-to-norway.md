---
title: "Pet Relocation Bosnia and Herzegovina to Norway | Requirements & Guide"
description: "How to ship your dog or cat from Bosnia and Herzegovina to Norway. Norway import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "bosnia-and-herzegovina-to-norway"
...
content:
  h1: "Pet Transport from Bosnia and Herzegovina to Norway"
  overview: |
    If you're relocating from Bosnia and Herzegovina to Norway and taking your pet, the good news is thousands of families do this every year.
  ...
  sections:
    - heading: "What to know about the Bosnia and Herzegovina to Norway route"
      body: |
        Compared to some international pet transport routes, Bosnia and Herzegovina to Norway is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Bosnia and Herzegovina to Norway?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Bosnia and Herzegovina. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Norway's authority for the exact format required."
...
links:
  sideways:
    - url: "/pet-transport/norway-to-bosnia-and-herzegovina/"
      text: "Pet Transport Norway to Bosnia and Herzegovina"
  upward:
