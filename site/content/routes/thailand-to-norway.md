---
template_variant: "E"
title: "Shipping Dogs & Cats from Thailand to Norway | PetTransportGlobal"
description: "How to ship your dog or cat from Thailand to Norway. Norway import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Pet Transport Global Editorial Team"
slug: "thailand-to-norway"
...
content:
  h1: "Pet Transport from Thailand to Norway"
  overview: |
    Pet transport from Thailand to Norway follows a clear process once you know what Norway requires.
  ...
  sections:
    - heading: "Understanding Norway's pet import rules"
      body: |
        Compared to some international pet transport routes, Thailand to Norway is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Thailand to Norway?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Thailand. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Norway's authority for the exact format required."
...
links:
  sideways:
    - url: "/pet-transport/norway-to-thailand/"
      text: "Pet Transport Norway to Thailand"
  upward:
