---
title: "Moving Your Pet from Haiti to Nepal | Complete Guide"
description: "How to ship your dog or cat from Haiti to Nepal. Nepal import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Haiti to Nepal"
  overview: |
    Moving to Nepal from Haiti with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "What to know about the Haiti to Nepal route"
      body: |
    ...
    - heading: "From experience: Haiti to Nepal pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Haiti to Nepal?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Haiti. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Nepal's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/nepal-to-haiti/"
      text: "Pet Transport Nepal to Haiti"
  upward:
