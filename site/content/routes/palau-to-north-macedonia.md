---
title: "Shipping Dogs & Cats from Palau to North Macedonia | PetTransportGlobal"
description: "How to ship your dog or cat from Palau to North Macedonia. North Macedonia import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "palau-to-north-macedonia"
origin_name: "Palau"
...
content:
  h1: "Pet Transport from Palau to North Macedonia"
  overview: |
    Shipping your dog from Palau to North Macedonia is a process that rewards early planning.
  ...
  sections:
    - heading: "What to know about the Palau to North Macedonia route"
      body: |
        Compared to some international pet transport routes, Palau to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Palau to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Palau?"
    answer: "Yes, cats can be transported from Palau to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-palau/"
      text: "Pet Transport North Macedonia to Palau"
  upward:
