---
title: "Moving Your Pet from Ireland to North Macedonia | Complete Guide"
description: "Pet relocation from Ireland to North Macedonia: North Macedonia import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "ireland-to-north-macedonia"
origin_name: "Ireland"
...
content:
  h1: "Pet Transport from Ireland to North Macedonia"
  overview: |
    The Ireland to North Macedonia route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "What to know about the Ireland to North Macedonia route"
      body: |
        Compared to some international pet transport routes, Ireland to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Ireland to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Ireland?"
    answer: "Yes, cats can be transported from Ireland to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-ireland/"
      text: "Pet Transport North Macedonia to Ireland"
  upward:
