---
template_variant: "A"
title: "Pet Relocation Cambodia to Nepal | Requirements & Guide"
...
content:
  h1: "Pet Transport from Cambodia to Nepal"
  overview: |
...
faqs:
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Cambodia. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Nepal's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/nepal-to-cambodia/"
      text: "Pet Transport Nepal to Cambodia"
  upward:
