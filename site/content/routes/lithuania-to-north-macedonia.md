---
title: "Pet Transport from Lithuania to North Macedonia | PetTransportGlobal"
description: "How to ship your dog or cat from Lithuania to North Macedonia. North Macedonia import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "lithuania-to-north-macedonia"
...
content:
  h1: "Pet Transport from Lithuania to North Macedonia"
  overview: |
    Moving to North Macedonia from Lithuania with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "Why this route needs early planning"
      body: |
        Compared to some international pet transport routes, Lithuania to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Lithuania to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Lithuania?"
    answer: "Yes, cats can be transported from Lithuania to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-lithuania/"
      text: "Pet Transport North Macedonia to Lithuania"
  upward:
