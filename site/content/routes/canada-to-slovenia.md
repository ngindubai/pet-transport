---
title: "Shipping Dogs & Cats from Canada to Slovenia | PetTransportGlobal"
description: "How to ship your dog or cat from Canada to Slovenia. Slovenia import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Canada to Slovenia"
  overview: |
    Shipping your dog or cat from Canada to Slovenia is a process that rewards early planning.
  ...
  sections:
    - heading: "What to know about the Canada to Slovenia route"
      body: |
        Compared to some international pet transport routes, Canada to Slovenia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Slovenia?"
  ...
  - question: "Can I take my cat to Slovenia from Canada?"
    answer: "Yes, cats can be transported from Canada to Slovenia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
