---
title: "Pet Relocation Colombia to Uruguay | Requirements & Guide"
description: "How to ship your dog or cat from Colombia to Uruguay. Uruguay import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "colombia-to-uruguay"
...
content:
  h1: "Pet Transport from Colombia to Uruguay"
  overview: |
    Moving to Uruguay from Colombia with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "Understanding Uruguay's pet import rules"
      body: |
        Compared to some international pet transport routes, Colombia to Uruguay is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Colombia to Uruguay?"
  ...
  - question: "Can I take my cat to Uruguay from Colombia?"
    answer: "Yes, cats can be transported from Colombia to Uruguay. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/uruguay-to-colombia/"
      text: "Pet Transport Uruguay to Colombia"
  upward:
