---
title: "Pet Relocation Colombia to Guatemala | Requirements & Guide"
description: "Complete guide to pet transport from Colombia to Guatemala. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "colombia-to-guatemala"
...
content:
  h1: "Pet Transport from Colombia to Guatemala"
  overview: |
    Moving to Guatemala from Colombia with a dog or cat means starting the paperwork months before your flight.
  ...
  sections:
    - heading: "Why this route needs early planning"
      body: |
        Compared to some international pet transport routes, Colombia to Guatemala is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Colombia to Guatemala?"
  ...
  - question: "Can I take my cat to Guatemala from Colombia?"
    answer: "Yes, cats can be transported from Colombia to Guatemala. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/guatemala-to-colombia/"
      text: "Pet Transport Guatemala to Colombia"
  upward:
