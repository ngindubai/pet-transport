---
title: "Moving Your Pet from Ukraine to Canada | Complete Guide"
description: "Complete guide to pet transport from Ukraine to Canada. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
...
content:
  ...
  overview: |
    Pet transport from Ukraine to Canada follows a clear process once you know what Canada requires.
  ...
  sections:
    - heading: "What to know about the Ukraine to Canada route"
      body: |
        Compared to some international pet transport routes, Ukraine to Canada is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Ukraine to Canada?"
  ...
  - question: "Is a rabies titre test required for pets entering Canada?"
    answer: "No, Canada does not require a rabies titre test for most pets arriving from Ukraine. Your pet still needs a valid rabies vaccination and microchip. Check the current requirements with the destination authority before travel."
  - question: "Can I take my cat to Canada from Ukraine?"
    answer: "Yes, cats can be transported from Ukraine to Canada. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/canada-to-ukraine/"
      text: "Pet Transport Canada to Ukraine"
  upward:
