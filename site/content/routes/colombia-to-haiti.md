---
title: "Pet Transport from Colombia to Haiti | PetTransportGlobal"
description: "How to ship your dog or cat from Colombia to Haiti. Haiti import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "colombia-to-haiti"
...
content:
  h1: "Pet Transport from Colombia to Haiti"
  overview: |
    If you're relocating from Colombia to Haiti and taking your pet, the good news is thousands of families do this every year.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Haiti"
      body: |
        Compared to some international pet transport routes, Colombia to Haiti is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Colombia to Haiti?"
  ...
  - question: "Can I take my cat to Haiti from Colombia?"
    answer: "Yes, cats can be transported from Colombia to Haiti. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/haiti-to-colombia/"
      text: "Pet Transport Haiti to Colombia"
  upward:
