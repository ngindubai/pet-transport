---
title: "Pet Transport from the United States to Azerbaijan: Complete Guide"
description: "Moving your dog or cat from the US to Azerbaijan? This guide covers the State Veterinary Service import permit, USDA health certificates, cargo routing via Istanbul, and full cost breakdown."
date: "2026-06-11"
type: "routes"
layout: "single"
template_variant: "B"
...
route_data:
  ...
  destination:
    ...
    country: "Azerbaijan"
    import_requirements:
      microchip: "ISO 11784/11785 compliant microchip required. Must be implanted before vaccinations to ensure correct chronological records."
      rabies_vaccination: "Current rabies vaccination required and must be valid at the time of arrival in Azerbaijan."
      import_permit: "Veterinary import permit required from the State Veterinary Service (Ministry of Agriculture of Azerbaijan) in advance of travel. Apply well before your intended travel date. Do not book cargo without a confirmed permit."
      quarantine: "No routine quarantine for compliant arrivals with correct documentation. A veterinary inspection is carried out at Heydar Aliyev International Airport on arrival."
      health_certificate: "Official health certificate issued by a USDA-accredited veterinarian and endorsed by USDA APHIS State Veterinarian. Must confirm microchip number, rabies vaccination status, and fitness to travel."
      authority: "State Veterinary Service, Ministry of Agriculture of Azerbaijan"

  airlines:
    - name: "Turkish Airlines Cargo"
      type: "cargo_only"
      policy_summary: "Primary routing from US gateways (Atlanta ATL, New York JFK, Chicago ORD, Los Angeles LAX) via Istanbul (IST) to Baku (GYD). Turkish Airlines operates IST-GYD directly and is the main carrier for live animal cargo on this corridor. Confirm acceptance on each leg individually before booking."
    - name: "Lufthansa Cargo"
      type: "cargo_only"
      policy_summary: "US gateways to Frankfurt (FRA), then cargo connections to Baku (GYD) via IST or direct cargo forwarding. Lufthansa Cargo operates a live animal programme at FRA. Confirm each onward leg to GYD for live animal acceptance."
    - name: "AZAL (Azerbaijan Airlines)"
      type: "cargo_only"
      policy_summary: "Azerbaijan Airlines operates FRA-GYD and connects some European hubs to Baku. May accept live animal cargo; confirm current policy directly with AZAL before booking. Using Azerbaijan's national carrier can simplify the final leg to GYD."

  timeline_steps:
    - step: 1
      action: "Apply for veterinary import permit from the State Veterinary Service, Ministry of Agriculture of Azerbaijan"
      timing: "8-10 weeks before travel. Contact the Ministry in advance; processing times vary."
    ...
    - step: 3
      ...
      responsible: "USDA-accredited veterinarian"
    - step: 4
      action: "Book cargo space with chosen airline once permit is confirmed"
    ...
    - step: 5
      ...
      timing: "Within 10 days of travel, accounting for 3-5 business day USDA endorsement time"
      responsible: "USDA-accredited veterinarian"
    - step: 6
    ...
    - step: 7
      action: "Arrive at Heydar Aliyev International Airport (GYD), Baku. State Veterinary Service inspection on arrival."
      timing: "Travel day"
...
content:
  h1: "Pet Transport from the United States to Azerbaijan"
  overview: "Cost is often the first question when someone starts planning a pet move from the US to Azerbaijan. The answer depends on your pet's size, the routing you choose, and whether you use a specialist agent. A small dog in a standard crate, routed via Istanbul on Turkish Airlines Cargo, will typically cost less than a large breed needing a bigger crate on a longer connection. This guide breaks down every cost component and the process that surrounds them."
  ...
  sections:
    ...
    - heading: "USDA APHIS Health Certificate Process"
      body: |
    ...
    - heading: "What Happens on Arrival in Baku"
      body: |
...
faqs:
  - question: "Is a veterinary import permit required to bring a pet to Azerbaijan from the US?"
    answer: "Yes. The State Veterinary Service under the Ministry of Agriculture of Azerbaijan requires a veterinary import permit before your pet can enter the country. Apply well in advance of travel. Do not book cargo or finalise travel dates without a confirmed permit."
  - question: "Is there quarantine for pets entering Azerbaijan from the United States?"
    answer: "No routine quarantine applies for compliant arrivals. A veterinary inspection is carried out at Heydar Aliyev International Airport (GYD) on arrival. Pets with complete, correct documentation and no signs of illness are cleared without quarantine."
  - question: "Which airline is best for pet cargo from the US to Baku?"
    answer: "Turkish Airlines Cargo via Istanbul (IST) is the primary option, offering a direct IST-GYD connection after the transatlantic leg. AZAL via Frankfurt is an alternative if you prefer fewer transit points. Always confirm live animal acceptance on every leg before booking."
  - question: "How much does it cost to ship a dog from the US to Azerbaijan?"
    answer: "A typical move costs USD 1,500-4,000 in total, covering cargo freight (USD 900-2,800 depending on pet size and routing), an IATA crate (USD 80-300), the USDA health certificate and endorsement (USD 150-350), the Azerbaijani import permit, and optionally an agent fee (USD 400-800). Get quotes from multiple cargo providers."

links:
  sideways:
    - url: "/pet-transport/azerbaijan-to-united-states/"
      text: "Pet transport from Azerbaijan to the United States"
    - url: "/pet-transport/united-states-to-georgia/"
      text: "Pet transport from the United States to Georgia"
  upward:
    - url: "/pet-transport/countries/azerbaijan/"
      text: "Importing pets to Azerbaijan: country guide"
