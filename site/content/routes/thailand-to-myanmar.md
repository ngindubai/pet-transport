---
template_variant: "E"
title: "Pet Transport from Thailand to Myanmar | PetTransportGlobal"
description: "How to ship your dog or cat from Thailand to Myanmar. Myanmar import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Thailand to Myanmar"
  overview: |
    International pet transport from Thailand to Myanmar comes down to documentation timing more than anything else.
  ...
  sections:
    ...
    - heading: "From experience: Thailand to Myanmar pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Thailand to Myanmar?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Thailand. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Myanmar's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/myanmar-to-thailand/"
      text: "Pet Transport Myanmar to Thailand"
  upward:
