---
title: "Pet Relocation Haiti to China | Requirements & Guide"
description: "Complete guide to pet transport from Haiti to China. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Haiti to China"
  overview: |
    International pet transport from Haiti to China comes down to documentation timing more than anything else.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Haiti to China?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Haiti. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check China's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/china-to-haiti/"
      text: "Pet Transport China to Haiti"
  upward:
