---
title: "Pet Transport Brazil to Switzerland: 2026 Import Rules"
description: "Moving your pet from Brazil to Switzerland? Switzerland follows EU-equivalent rules: titre test, 90-day wait, and MAPA endorsement required."
date: "2026-06-06"
type: "routes"
layout: "single"
template_variant: "D"
...
route_data:
  ...
  destination:
    ...
    import_requirements:
      ...
      rabies_vaccination: "Valid rabies vaccination, given after microchip"
      titre_test: "FAVN titre test required (0.5 IU/ml minimum), blood drawn at least 30 days after vaccination, at a recognised laboratory"
      quarantine: "No quarantine if all documents are correct and 90-day wait from blood draw is complete"
      import_permit: "Not required for non-commercial pet imports"
      health_certificate: "Swiss-format health certificate based on EU Annex IV template for non-listed third countries, issued within 10 days of travel, endorsed by MAPA"
      breed_restrictions: "Switzerland has cantonal breed restrictions; some cantons ban or restrict certain breeds. Check the specific canton of destination."

  airlines:
    - name: "LATAM Airlines"
      type: "cargo_only"
      policy_summary: "GRU to European hubs with connecting cargo to Zurich (ZRH) or Geneva (GVA)"
    - name: "Swiss WorldCargo"
      type: "cargo_only"
      policy_summary: "ZRH-based cargo operation with connections from major European hubs; experienced handling at Zurich airport"
    - name: "Lufthansa Cargo"
      type: "cargo_only"
      policy_summary: "GRU to FRA with connecting cargo to ZRH or GVA; Lufthansa Cargo handles live animals regularly on this corridor"

  timeline_steps:
    - step: 1
      action: "Microchip implanted (ISO 11784/11785)"
      timing: "At start of process"
...
content:
  h1: "Pet Transport Brazil to Switzerland: 2026 Guide"
  overview: "Switzerland is not an EU member state, but its pet import rules closely mirror those of the EU for animals arriving from third countries. Pets from Brazil need an FAVN titre test, a 90-day wait from the blood draw date, and a MAPA-endorsed health certificate. Switzerland also has its own cantonal breed restrictions, which vary by region. The preparation timeline is broadly the same as for EU destinations: around 20 to 24 weeks."

  sections:
    - heading: "How does Switzerland handle pets arriving from Brazil?"
      body: |
    ...
    - heading: "What does the preparation process look like from Brazil?"
      body: |
    ...
    - heading: "Are there any differences between shipping to Zurich versus Geneva?"
      body: |
...
faqs:
  - question: "Is Switzerland's pet import process the same as the EU's?"
  ...
  - question: "Which Brazilian labs are recognised for the titre test for Switzerland?"
    answer: "Switzerland accepts titre tests from EU-recognised OIE reference laboratories. Several labs in Brazil are on the EU-approved list, including laboratories at major federal universities. Your vet or transport agent can confirm which labs are currently on the approved list before drawing blood."
  - question: "Does Switzerland quarantine pets from Brazil on arrival?"
  ...
  - question: "My canton is in the list of restricted breed cantons. What does that mean practically?"
    answer: "Some Swiss cantons (including Bern, Basel-Stadt, Geneva, and others) have restrictions on specific breeds, typically certain bully-type and mastiff-type dogs. Restrictions range from mandatory muzzle and lead requirements to outright import bans. If your dog is an affected breed, you may need a permit from the cantonal veterinary office, or the import may not be permitted. Contact the cantonal veterinary authority early."
  - question: "Can I bring multiple pets from Brazil to Switzerland in one shipment?"
    answer: "Yes, multiple pets can travel together in the same cargo booking. Each animal must have its own individual documentation: microchip records, vaccination certificate, titre test, and health certificate. The shipping cost will reflect the combined weight and number of crates."
