---
title: "Pet Relocation Portugal to North Macedonia | Requirements & Guide"
description: "Pet relocation from Portugal to North Macedonia: North Macedonia import requirements, timeline, airlines, costs, and documentation checklist."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "portugal-to-north-macedonia"
...
content:
  h1: "Pet Transport from Portugal to North Macedonia"
  overview: |
    Moving a pet from Portugal to North Macedonia involves more paperwork than most owners expect.
  ...
  sections:
    - heading: "Key requirements for moving your pet to North Macedonia"
      body: |
        Compared to some international pet transport routes, Portugal to North Macedonia is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Portugal to North Macedonia?"
  ...
  - question: "Can I take my cat to North Macedonia from Portugal?"
    answer: "Yes, cats can be transported from Portugal to North Macedonia. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/north-macedonia-to-portugal/"
      text: "Pet Transport North Macedonia to Portugal"
  upward:
