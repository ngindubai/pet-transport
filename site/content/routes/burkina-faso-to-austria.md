---
title: "Pet Transport from Burkina Faso to Austria | PetTransportGlobal"
description: "How to ship your dog or cat from Burkina Faso to Austria. Austria import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "burkina-faso-to-austria"
...
content:
  h1: "Pet Transport from Burkina Faso to Austria"
  overview: |
    The Burkina Faso to Austria route is one many expats and returning families navigate each year with their pets.
  ...
  sections:
    - heading: "What to know about the Burkina Faso to Austria route"
      body: |
        Compared to some international pet transport routes, Burkina Faso to Austria is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Burkina Faso to Austria?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Burkina Faso. The certificate must be issued within 10 days of travel. Present the original (not a copy) at check-in. Check Austria's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/austria-to-burkina-faso/"
      text: "Pet Transport Austria to Burkina Faso"
  upward:
