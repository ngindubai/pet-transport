---
title: "Shipping Dogs & Cats from Chile to Uzbekistan | PetTransportGlobal"
description: "Complete guide to pet transport from Chile to Uzbekistan. Import requirements, quarantine rules, airline options, and step-by-step timeline."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "chile-to-uzbekistan"
origin_name: "Chile"
...
content:
  h1: "Pet Transport from Chile to Uzbekistan"
  overview: |
    International pet transport from Chile to Uzbekistan comes down to documentation timing more than anything else.
  ...
  sections:
    - heading: "Key requirements for moving your pet to Uzbekistan"
      body: |
        Compared to some international pet transport routes, Chile to Uzbekistan is manageable. That said, every country's rules are different and the timing requirements are strict.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Chile to Uzbekistan?"
  ...
  - question: "Can I take my cat to Uzbekistan from Chile?"
    answer: "Yes, cats can be transported from Chile to Uzbekistan. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/uzbekistan-to-chile/"
      text: "Pet Transport Uzbekistan to Chile"
  upward:
