---
title: "Pet Relocation Canada to Uzbekistan | Requirements & Guide"
description: "How to ship your dog or cat from Canada to Uzbekistan. Uzbekistan import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
...
content:
  h1: "Pet Transport from Canada to Uzbekistan"
  overview: |
    Moving a pet from Canada to Uzbekistan involves more paperwork than most owners expect.
  ...
  sections:
    - heading: "What to know about the Canada to Uzbekistan route"
      body: |
        Compared to some international pet transport routes, Canada to Uzbekistan is manageable. That said, every country's rules are different and the timing requirements are strict.
    - heading: "From experience: Canada to Uzbekistan pet transport"
      body: |
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Canada to Uzbekistan?"
  ...
  - question: "Can I take my cat to Uzbekistan from Canada?"
    answer: "Yes, cats can be transported from Canada to Uzbekistan. The same microchip, vaccination, and health certificate requirements apply as for dogs, though some rules (such as tapeworm treatment) apply to dogs only. Check the full requirements for cats with the destination authority."
links:
  sideways:
    - url: "/pet-transport/uzbekistan-to-canada/"
      text: "Pet Transport Uzbekistan to Canada"
  upward:
