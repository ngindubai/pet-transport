---
title: "Pet Transport from Uruguay to Thailand | PetTransportGlobal"
description: "How to ship your dog or cat from Uruguay to Thailand. Thailand import rules, vaccinations, permits, and airline options explained."
type: "routes"
layout: "single"
author: "Gareth - Founder, PetTransportGlobal"
slug: "uruguay-to-thailand"
origin_name: "Uruguay"
...
content:
  h1: "Pet Transport from Uruguay to Thailand"
  overview: |
    Moving to Thailand from Uruguay with a dog or cat means starting the paperwork months before your flight.
...
faqs:
  - question: "How long does it take to prepare a pet for transport from Uruguay to Thailand?"
  ...
  - question: "What health certificate does my pet need for this route?"
    answer: "Your pet needs a government-issued veterinary health certificate from an official vet in Uruguay. The certificate must be issued within 14 days of travel. Present the original (not a copy) at check-in. Check Thailand's authority for the exact format required."
links:
  sideways:
    - url: "/pet-transport/thailand-to-uruguay/"
      text: "Pet Transport Thailand to Uruguay"
  upward:
