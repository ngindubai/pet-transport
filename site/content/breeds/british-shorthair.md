---
title: "Flying with a British Shorthair | Airline Restrictions & Advice"
...
airline_restrictions:
  ...
  - airline_name: "United (cabin only, cargo suspended)"
    ...
    notes: "Fitness-to-fly certificate required from licensed vet"
content:
  h1: "British Shorthair Air Travel Guide"
  overview: |
    British Shorthair is a brachycephalic (flat-faced) breed. The short skull structure compresses the airway, which creates real risks during air transport: reduced oxygen tolerance, heat stress, and difficulty breathing under the physical stress of travel.
...
faqs:
  - question: "Can I fly my British Shorthair in the cabin?"
  ...
  - question: "Which airlines will accept a British Shorthair as cargo?"
  ...
  - question: "What is a fitness-to-fly certificate for a British Shorthair?"
  ...
  - question: "Are there countries that will not accept a British Shorthair?"
    answer: "British Shorthair is not subject to specific country breed bans as a brachycephalic breed. The restrictions you'll face are from airlines, not destination governments. However, always check the destination country's current import rules for any specific breed-related notes."
  - question: "What's the safest way to fly a British Shorthair internationally?"
    answer: "If the route allows it, a small British Shorthair travelling as a cabin pet in an under-seat carrier faces fewer risks than cargo. Avoid peak summer travel if possible. Choose a direct flight over connections. Use a vet who specialises in brachycephalic breeds to assess your dog's fitness before booking. Work with a pet transport agent who knows which airlines are currently accepting flat-faced breeds on your specific route."
---
