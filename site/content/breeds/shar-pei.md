---
title: "Flying with a Shar Pei | Airline Restrictions & Advice"
description: "Which airlines accept Shar Pei as cargo or cabin? Seasonal embargoes, breed bans, and what you need before booking your flat-faced dog."
type: "breeds"
layout: "single"
...
airline_restrictions:
  ...
  - airline_name: "United (cabin only, cargo suspended)"
    ...
    notes: "Fitness-to-fly certificate required from licensed vet"
content:
  h1: "Shar Pei Air Travel Guide"
  overview: |
    Shar Pei is a brachycephalic (flat-faced) breed. The short skull structure compresses the airway, which creates real risks during air transport: reduced oxygen tolerance, heat stress, and difficulty breathing under the physical stress of travel.
...
faqs:
  - question: "Can I fly my Shar Pei in the cabin?"
  ...
  - question: "Which airlines will accept a Shar Pei as cargo?"
  ...
  - question: "What is a fitness-to-fly certificate for a Shar Pei?"
  ...
  - question: "Are there countries that will not accept a Shar Pei?"
    answer: "Shar Pei is not subject to specific country breed bans as a brachycephalic breed. The restrictions you'll face are from airlines, not destination governments. However, always check the destination country's current import rules for any specific breed-related notes."
  - question: "What's the safest way to fly a Shar Pei internationally?"
    answer: "If the route allows it, a small Shar Pei travelling as a cabin pet in an under-seat carrier faces fewer risks than cargo. Avoid peak summer travel if possible. Choose a direct flight over connections. Use a vet who specialises in brachycephalic breeds to assess your dog's fitness before booking. Work with a pet transport agent who knows which airlines are currently accepting flat-faced breeds on your specific route."
---
