---
title: "Flying with a Dogue de Bordeaux | Airline Restrictions & Advice"
description: "Which airlines accept Dogue de Bordeaux as cargo or cabin? Seasonal embargoes, breed bans, and what you need before booking your flat-faced dog."
type: "breeds"
layout: "single"
...
airline_restrictions:
  ...
  - airline_name: "United (cabin only, cargo suspended)"
    ...
    notes: "Fitness-to-fly certificate required from licensed vet"
content:
  h1: "Dogue de Bordeaux Air Travel Guide"
  overview: |
    Dogue de Bordeaux is a brachycephalic (flat-faced) breed. The short skull structure compresses the airway, which creates real risks during air transport: reduced oxygen tolerance, heat stress, and difficulty breathing under the physical stress of travel.
...
faqs:
  - question: "Can I fly my Dogue de Bordeaux in the cabin?"
  ...
  - question: "Which airlines will accept a Dogue de Bordeaux as cargo?"
  ...
  - question: "What is a fitness-to-fly certificate for a Dogue de Bordeaux?"
  ...
  - question: "Are there countries that will not accept a Dogue de Bordeaux?"
    answer: "Dogue de Bordeaux is not subject to specific country breed bans as a brachycephalic breed. The restrictions you'll face are from airlines, not destination governments. However, always check the destination country's current import rules for any specific breed-related notes."
  - question: "What's the safest way to fly a Dogue de Bordeaux internationally?"
    answer: "If the route allows it, a small Dogue de Bordeaux travelling as a cabin pet in an under-seat carrier faces fewer risks than cargo. Avoid peak summer travel if possible. Choose a direct flight over connections. Use a vet who specialises in brachycephalic breeds to assess your dog's fitness before booking. Work with a pet transport agent who knows which airlines are currently accepting flat-faced breeds on your specific route."
---
