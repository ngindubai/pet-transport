...
**Where we are (reconciled from disk 2026-06-06):** 5,397 quality routes complete. ~32,433 routes remaining. Blog: 415 articles. Total .md source files: 6,185. Content plan: Day 7 is next. Chunk 32 (Template B, Visual Journey, Tier A) is next. Counts come from `python verify_build_state.py`, never hand-edited.
...
- Chunk 31 template: D (Conversational Q&A) - DONE 2026-06-06 (Brazil/Indonesia/Malaysia/Mexico to EU/Japan/Korea/Switzerland; Italy-KR; Thailand-KR; 25 routes)
- Chunk 32 template: B (Visual Journey) - NEXT
...
| 2026-06-06 | Chunk 31 | 25 routes, Template D (Conversational Q&A). Routes from Brazil, Indonesia, Malaysia, Mexico to Italy, Japan, Netherlands, Portugal, South Korea, Switzerland; plus Italy-to-South Korea and Thailand-to-South Korea. Key regulatory detail: MAPA/BARANTAN/DVS/SENASICA export cert requirements; EU non-listed country rules (FAVN titre test + 90-day wait for all EU/Swiss destinations); Japan AQS 180-day process (two vaccinations, AQS-designated lab only, 40-day advance notification); South Korea QIAS quarantine (5-10 days for rabies-endemic origins; 1-3 days for EU-origin Italy; titre test required for all non-EU origins). All 25 files written, zero em dashes, no banned vocabulary, all Marcus Webb. Routes 5,322 -> 5,397, blog 415 (unchanged this batch), pages 6,109 -> 6,185. | 6,185 | Live links posted. Chunk 32 (Template B, Tier A) is next. Blog Day 7 next. |
