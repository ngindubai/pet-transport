...
- Chunk 36 template: A (Field Manual, Tier B) - DONE 2026-06-07 (sri-lanka-to-uk, ethiopia-to-uk, finland-to-uk)
- Chunk 37 template: B (Visual Journey, Tier B) - DONE 2026-06-07 (25 country-to-US routes, CDC high-risk + non-high-risk)
- Chunk 38 template: C (Comparison Brief, Tier B) - DONE 2026-06-07 (25 cross-regional routes, brazil/denmark/greece/india/indonesia origins)
- Chunk 39 template: D (Conversational Q&A, Tier B) - NEXT
...
| 2026-06-07 | Chunks 36+37+38 + Blog Day 10 | Chunk 36 (Template A, Field Manual, Tier B): 3 routes - sri-lanka-to-uk (unlisted, FAVN titre, 90-day wait, tapeworm), ethiopia-to-uk (unlisted, same regime, ADD altitude note), finland-to-uk (EU Listed Part 1, no titre, no tapeworm). Chunk 37 (Template B, Visual Journey, Tier B): 25 country-to-US routes covering CDC high-risk origins (bangladesh, pakistan, colombia, peru, morocco, ghana, nepal, sri-lanka, ethiopia, cambodia, myanmar) requiring titre test or 28-day quarantine; and non-high-risk EU/other origins (chile, finland, austria, belgium, greece, bulgaria, croatia, cyprus, hungary, romania, slovakia, luxembourg, malta, mauritius). Chunk 38 (Template C, Comparison Brief, Tier B): 25 cross-regional routes - brazil-to-thailand, denmark-to-brazil/mexico, greece-to-brazil/india/indonesia/malaysia/mexico/south-korea, india-to-brazil/denmark/greece/indonesia/mexico, indonesia-to-brazil/greece/india/malaysia (18 new + 7 pre-existing from previous session). Blog Day 10: pet-transport-uae-to-pakistan.md (2,000 words, Marcus Webb). UAE-Pakistan: MOCCAE health cert, AQD NOC (director@aqd.gov.pk), anti-parasitic 14 days before, Emirates/Flydubai/Air Arabia/PIA to KHI/LHE/ISB, customs at all three gateways. Zero em dashes, no banned vocab, all Marcus Webb. Routes 5,431 -> 5,506, blog 416 -> 417, pages 6,220 -> 6,296. | 6,296 | Live links below. Chunk 39 (Template D, Tier B) is next. Blog Day 11 next. |
