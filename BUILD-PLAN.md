...
**Where we are (reconciled from disk 2026-06-06):** 5,347 quality routes complete. ~32,483 routes remaining. Blog: 414 articles. Total .md source files: 6,134. Content plan: Day 7 is next. 115 score-7+ Tier A pairs remain. Chunk 32 (Template C, Comparison Brief) is next. Counts come from `python verify_build_state.py`, never hand-edited.
...
- Chunk 31 template: B (Visual Journey) - DONE 2026-06-06 (US-EU, US-non-EU, UK-EU, UK-non-EU, VN-US; 25 routes)
- Chunk 32 template: C (Comparison Brief) - NEXT
- Tier: A (115 score-7+ pairs remain)
- Template rotation: ...D(21), E(22), A(23), B(24), C(25-27), D(28), E(29), A(30), B(31), C(32)...
...
| 2026-06-06 | Chunk 31 | 25 Tier A routes (Template B, Visual Journey). US outbound to EU (Austria, Belgium, Denmark, Finland, Greece, Hungary, Norway, Poland, Romania, Sweden); US outbound to non-EU (Argentina, Egypt, Kenya, Nigeria, Vietnam); UK outbound to EU (Austria, Finland, Greece, Hungary, Poland, Romania); UK outbound to non-EU (Argentina, Egypt, Kenya); plus Vietnam-to-USA. Key regulatory detail: Echinococcus tapeworm 24-120h for US-FI, US-NO, UK-FI (dogs only, Ruokavirasto/Mattilsynet source); SENASA + FCDO apostille + Spanish requirement for UK-AR; CDC high-risk for VN-US (titre test 30d+28d pathway or 28-day quarantine); Kenya cargo-only entry; MARD import permit for US-VN; Denmark/Norway breed bans; Hungary Wizz Air warning; Denmark/Sweden dog registries. Zero em dashes, all Marcus Webb, QA passed. Routes 5,322 -> 5,347, pages 6,109 -> 6,134. Tier A: 140 -> 115. | 6,134 | Live links below. Chunk 32 (Template C, Tier A) is next. Blog Day 7 next. |
